...
echo "== RoofLeadHQ First Roofer Lead-to-Inspection Ops Pack Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-lead-to-inspection-ops-pack-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated ops pack verifier
node backend/scripts/verify-first-roofer-lead-to-inspection-ops-pack-readonly.js
...
echo "PASS: First Roofer Lead-to-Inspection Ops Pack dry-run wrapper passed."
