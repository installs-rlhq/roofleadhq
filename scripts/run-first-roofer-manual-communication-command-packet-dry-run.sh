...
echo "== RoofLeadHQ First Roofer Manual Communication Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-manual-communication-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated manual communication command packet verifier
node backend/scripts/verify-first-roofer-manual-communication-command-packet-readonly.js
...
echo "PASS: First Roofer Manual Communication Command Packet dry-run wrapper passed."
