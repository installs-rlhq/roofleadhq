...
echo "== RoofLeadHQ Native Workflow Fixture E2E Acceptance Rehearsal Expansion Dry-Run =="
...
echo "PASS: Native Workflow Fixture E2E Acceptance Rehearsal Expansion dry-run wrapper passed."
