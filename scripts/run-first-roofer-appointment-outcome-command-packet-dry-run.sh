...
echo "== RoofLeadHQ First Roofer Appointment Outcome Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-appointment-outcome-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated appointment outcome command packet verifier
node backend/scripts/verify-first-roofer-appointment-outcome-command-packet-readonly.js
...
echo "PASS: First Roofer Appointment Outcome Command Packet dry-run wrapper passed."
