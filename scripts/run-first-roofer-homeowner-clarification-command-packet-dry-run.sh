...
echo "== RoofLeadHQ First Roofer Homeowner Clarification Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-homeowner-clarification-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated homeowner clarification command packet verifier
node backend/scripts/verify-first-roofer-homeowner-clarification-command-packet-readonly.js
...
echo "PASS: First Roofer Homeowner Clarification Command Packet dry-run wrapper passed."
