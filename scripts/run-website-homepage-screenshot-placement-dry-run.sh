...
echo "== RoofLeadHQ Website Homepage Screenshot Placement Dry-Run =="
...
# Run node --check on the new homepage screenshot placement verifier
...
# Run the dedicated website homepage screenshot placement verifier
node backend/scripts/verify-website-homepage-screenshot-placement-readonly.js

# Run prior website founder-led + demo verifiers for combined safety baseline (consistent with established pattern)
...
echo "PASS: Website Homepage Screenshot Placement dry-run wrapper passed."
