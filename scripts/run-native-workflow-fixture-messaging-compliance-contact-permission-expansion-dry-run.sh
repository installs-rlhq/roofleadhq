...
echo "== RoofLeadHQ Native Workflow Fixture Messaging Compliance / Contact Permission Expansion Dry-Run =="
...
node --check backend/scripts/verify-native-workflow-fixture-lead-source-roi-boundary-expansion-readonly.js
echo "PASS: lead source ROI boundary verifier syntax check (node --check) succeeded."

node --check backend/scripts/verify-native-workflow-fixture-messaging-compliance-contact-permission-expansion-readonly.js
echo "PASS: messaging compliance contact permission verifier syntax check (node --check) succeeded."
...
echo "PASS: Native Workflow Fixture Messaging Compliance / Contact Permission Expansion dry-run wrapper passed."
