...
echo "== RoofLeadHQ First Paid Roofer Trial Conversion / Payment Handoff Kit Dry-Run =="
...
# Run the dedicated first paid roofer trial conversion payment handoff kit verifier
...
echo "PASS: First Paid Roofer Trial Conversion / Payment Handoff Kit dry-run wrapper passed."
