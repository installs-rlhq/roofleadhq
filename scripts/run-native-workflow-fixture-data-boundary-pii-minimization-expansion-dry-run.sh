...
echo "== RoofLeadHQ Native Workflow Fixture Data Boundary / PII Minimization Expansion Dry-Run =="
...
node --check backend/scripts/verify-native-workflow-fixture-audit-event-timeline-expansion-readonly.js
echo "PASS: audit event timeline verifier syntax check (node --check) succeeded."
...
echo "PASS: Native Workflow Fixture Data Boundary / PII Minimization Expansion dry-run wrapper passed."
