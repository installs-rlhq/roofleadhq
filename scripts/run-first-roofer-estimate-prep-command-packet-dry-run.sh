...
echo "== RoofLeadHQ First Roofer Estimate Prep Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-estimate-prep-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated estimate prep command packet verifier
node backend/scripts/verify-first-roofer-estimate-prep-command-packet-readonly.js
...
echo "PASS: First Roofer Estimate Prep Command Packet dry-run wrapper passed."
