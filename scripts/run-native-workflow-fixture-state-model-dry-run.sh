...
echo "== RoofLeadHQ Native Workflow Fixture State Model Dry-Run =="
...
echo "PASS: runner syntax check (node --check) succeeded."
...
echo "PASS: dry-run runner executed (stdout JSON only)."
...
echo "PASS: Native Workflow Fixture State Model Dry-Run wrapper passed."
