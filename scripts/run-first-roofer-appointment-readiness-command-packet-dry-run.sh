...
echo "== RoofLeadHQ First Roofer Appointment Readiness Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-appointment-readiness-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated appointment readiness command packet verifier
node backend/scripts/verify-first-roofer-appointment-readiness-command-packet-readonly.js
...
echo "PASS: First Roofer Appointment Readiness Command Packet dry-run wrapper passed."
