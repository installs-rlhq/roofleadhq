...
echo "== RoofLeadHQ Native Workflow Fixture Test-Mode Channel Preflight Evidence Packet Expansion Dry-Run =="
...
node --check backend/scripts/verify-native-workflow-fixture-test-mode-channel-preflight-evidence-packet-expansion-readonly.js
echo "PASS: test-mode channel preflight evidence packet verifier syntax check (node --check) succeeded."
...
echo "PASS: Native Workflow Fixture Test-Mode Channel Preflight Evidence Packet Expansion dry-run wrapper passed."
