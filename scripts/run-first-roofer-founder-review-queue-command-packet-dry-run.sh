...
echo "== RoofLeadHQ First Roofer Founder Review Queue Command Packet Dry-Run =="
...
node --check backend/scripts/verify-first-roofer-founder-review-queue-command-packet-readonly.js
echo "PASS: verifier syntax check (node --check) succeeded."

# Run the dedicated founder review queue command packet verifier
node backend/scripts/verify-first-roofer-founder-review-queue-command-packet-readonly.js
...
echo "PASS: First Roofer Founder Review Queue Command Packet dry-run wrapper passed."
