...
echo "== RoofLeadHQ Native Workflow Fixture Manual-to-Native Handoff Rehearsal Expansion Dry-Run =="
...
node --check backend/scripts/verify-native-workflow-fixture-review-queue-aging-sla-boundary-expansion-readonly.js
echo "PASS: review queue aging SLA boundary verifier syntax check (node --check) succeeded."

node --check backend/scripts/verify-native-workflow-fixture-manual-to-native-handoff-rehearsal-expansion-readonly.js
echo "PASS: manual-to-native handoff rehearsal verifier syntax check (node --check) succeeded."
...
echo "PASS: Native Workflow Fixture Manual-to-Native Handoff Rehearsal Expansion dry-run wrapper passed."
