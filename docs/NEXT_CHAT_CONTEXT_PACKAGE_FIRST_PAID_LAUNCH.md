...
-  - 10. Homeowner communication draft-review checklist (approved public language context; concrete facts; no guarantees; labeled DRAFT ONLY for manual use outside system).
...
- Concrete, product-moving: 20 operational sections + 9 trackers usable by Jason for manual success proof capture (no guarantees), referral request readiness (no pressure), testimonial/case-study readiness (explicit roofer consent/approval required before any draft publication or external use), safe expansion/plan-fit review (non-pushy only when appropriate), risk guardrails, and clean handoff to ongoing monthly only on PASS. Feeds Launch System ongoing sections. No customer proof, testimonial, or case-study published without logged consent. No pressure referral language.
