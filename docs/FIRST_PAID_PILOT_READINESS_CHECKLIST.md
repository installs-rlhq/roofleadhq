...
Operator handoff note verifier: `node backend/scripts/verify-first-paid-launch-operator-handoff-readonly.js`
...
Dashboard link: `website/dashboard/index.html` -> `First Paid Pilot Status`
