...
const postBuild116BlockedEvidenceDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_116_RUNNER_COMMAND_BLOCKED_EVIDENCE.md';
const freshPreRunGuardAfterPathCorrectionDocPath =
...
const pathCorrectionPacketDocPath =
...
const upstreamPathCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = 'ae23997';
...
const PRIOR_RUNNER_EXECUTION_PATH_CORRECTION_COMMIT = '750d5a5';
const CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE_COMMIT = '847592a';
const RUNNER_SCAFFOLDING_BUILD_COMMIT = '145bf15';

const INCOMING_FUTURE_COMMAND_STATUS =
  'blocked_until_runner_execution_path_after_guard_wiring_correction_and_fresh_decision';
const CORRECTED_FUTURE_COMMAND_STATUS =
  'blocked_until_after_guard_wiring_correction_fresh_decision_and_fresh_guard';
const STALE_FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_runner_execution_path_correction';
const STALE_READY_FUTURE_COMMAND_STATUS =
  'ready_for_exact_approved_runner_execution_command_after_path_correction_guard_review_only';
const STALE_BUILD_112_NO_GO_MESSAGE =
  'Build 112 consumed the fresh one-time attempt';
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_fresh_decision_after_path_correction_fixture_present',
  'upstream_path_correction_fixture_present',
  'upstream_blocked_evidence_fixture_present',
  'upstream_scaffolding_build_fixture_present',
  'manifest_fixture_present',
  'source_of_truth_commit_ae23997_referenced',
  'prior_post_build_116_blocked_evidence_commit_ae23997_referenced',
  'prior_post_build_116_blocked_evidence_status_closed',
  'prior_fresh_execution_pre_run_guard_after_path_correction_commit_2f1bbe3_referenced',
  'prior_capture_after_path_correction_commit_ddd193f_referenced',
  'prior_fresh_decision_after_path_correction_commit_2ea4c2e_referenced',
  'prior_runner_execution_path_correction_commit_750d5a5_referenced',
  'capture_fresh_runner_command_blocked_evidence_commit_847592a_referenced',
  'runner_scaffolding_build_commit_145bf15_referenced',
  'build_117_post_build_116_blocked_evidence_packet_referenced',
  'build_116_fresh_pre_run_guard_after_path_correction_packet_referenced',
  'build_115_capture_after_path_correction_packet_referenced',
  'build_114_fresh_decision_after_path_correction_packet_referenced',
  'build_113_path_correction_packet_referenced',
  'build_112_blocked_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'runner_execution_path_after_guard_wiring_gap_status_detected',
  'runner_execution_path_after_guard_wiring_correction_status_design_or_corrected_review_only',
  'prior_exact_command_attempt_after_build_116_status_attempted_blocked_nonzero',
  'prior_exact_command_exit_status_nonzero_blocked',
  'prior_exact_command_attempt_consumption_status_consumed_by_blocked_after_build_116_guard',
  'runner_output_state_before_after_guard_wiring_correction_stale_removed',
  'runner_did_not_recognize_build_114_before_correction_documented',
  'runner_did_not_recognize_build_115_before_correction_documented',
  'runner_did_not_recognize_build_116_before_correction_documented',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_after_guard_wiring_correction_true',
  'fresh_pre_run_guard_required_after_after_guard_wiring_correction_true',
  'fresh_runner_execution_decision_after_path_correction_closed',
  'fresh_runner_execution_approval_capture_after_path_correction_captured_signed',
  'fresh_execution_pre_run_guard_after_path_correction_passed',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_after_guard_wiring_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_after_guard_wiring_correction_fresh_decision_and_fresh_guard',
  'runner_command_path_exists',
  'runner_command_path_executable',
  'runner_command_corrected_blocked_state_language',
  'runner_command_recognizes_build_114_fresh_decision',
  'runner_command_recognizes_build_115_approval_capture',
  'runner_command_recognizes_build_116_pre_run_guard',
  'runner_command_build_117_consumed_post_build_116_attempt',
  'runner_command_corrected_future_command_status',
  'runner_command_no_stale_future_command_status',
  'runner_command_no_stale_ready_future_command_status',
  'runner_command_no_stale_build_112_era_primary_no_go',
  ...
  'build_117_consumed_post_build_116_attempt_documented',
  'prior_build_114_115_116_chain_not_reusable_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_after_guard_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-after-guard-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-after-guard-wiring-correction-readonly.js',
  'runner-execution-path-after-guard-wiring-correction.json',
  'Native Workflow Fixture Runner Execution Path After-Guard Wiring Correction',
  'native workflow fixture runner execution path after guard wiring correction',
  'runner execution path after guard wiring correction',
];
...
read(postBuild116BlockedEvidenceDocPath);
read(freshPreRunGuardAfterPathCorrectionDocPath);
read(captureAfterPathCorrectionPacketDocPath);
read(freshDecisionAfterPathCorrectionDocPath);
read(pathCorrectionPacketDocPath);
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-after-guard-wiring-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_ae23997_referenced');

mustHave(packetDoc, PRIOR_POST_BUILD_116_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_post_build_116_blocked_evidence_status | closed', 'packet doc');
passAssertion('prior_post_build_116_blocked_evidence_commit_ae23997_referenced');
passAssertion('prior_post_build_116_blocked_evidence_status_closed');

mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_PATH_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_PATH_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_execution_pre_run_guard_after_path_correction_commit_2f1bbe3_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_PATH_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_PATH_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_capture_after_path_correction_commit_ddd193f_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_PATH_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_PATH_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_decision_after_path_correction_commit_2ea4c2e_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_RUNNER_EXECUTION_PATH_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_runner_execution_path_correction_commit_750d5a5_referenced');

mustHave(packetDoc, CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE_COMMIT, 'no-go review');
passAssertion('capture_fresh_runner_command_blocked_evidence_commit_847592a_referenced');
...
mustHave(packetDoc, postBuild116BlockedEvidenceDocPath, 'packet doc');
...
mustHave(packetDoc, freshPreRunGuardAfterPathCorrectionDocPath, 'packet doc');
...
passAssertion('build_116_fresh_pre_run_guard_after_path_correction_packet_referenced');
...
passAssertion('build_115_capture_after_path_correction_packet_referenced');

mustHave(packetDoc, freshDecisionAfterPathCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterPathCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 114', 'packet doc');
passAssertion('build_114_fresh_decision_after_path_correction_packet_referenced');

mustHave(packetDoc, pathCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamPathCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 113', 'packet doc');
passAssertion('build_113_path_correction_packet_referenced');
...
mustHave(packetDoc, 'Build 112', 'packet doc');
passAssertion('build_112_blocked_evidence_packet_referenced');
...
mustHave(packetDoc, 'runner_execution_path_after_guard_wiring_gap_status | detected', 'packet doc');
mustHave(noGoReviewDoc, 'runner_execution_path_after_guard_wiring_gap_status | detected', 'no-go review');
passAssertion('runner_execution_path_after_guard_wiring_gap_status_detected');
...
passAssertion('runner_execution_path_after_guard_wiring_correction_status_design_or_corrected_review_only');

mustHave(packetDoc, 'prior_exact_command_attempt_after_build_116_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_exact_command_attempt_after_build_116_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_exact_command_attempt_after_build_116_status_attempted_blocked_nonzero');
...
passAssertion('prior_exact_command_attempt_consumption_status_consumed_by_blocked_after_build_116_guard');
...
passAssertion('runner_output_state_before_after_guard_wiring_correction_stale_removed');

mustHave(packetDoc, 'runner_did_not_recognize_build_114_fresh_decision_status', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_115_approval_capture_status', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_116_pre_run_guard_status', 'packet doc');
passAssertion('runner_did_not_recognize_build_114_before_correction_documented');
passAssertion('runner_did_not_recognize_build_115_before_correction_documented');
passAssertion('runner_did_not_recognize_build_116_before_correction_documented');
...
mustHave(packetDoc, 'fresh_decision_required_after_after_guard_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_decision_required_after_after_guard_wiring_correction | true', 'no-go review');
passAssertion('fresh_decision_required_after_after_guard_wiring_correction_true');

mustHave(packetDoc, 'fresh_pre_run_guard_required_after_after_guard_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_pre_run_guard_required_after_after_guard_wiring_correction | true', 'no-go review');
passAssertion('fresh_pre_run_guard_required_after_after_guard_wiring_correction_true');

mustHave(packetDoc, 'fresh_runner_execution_decision_after_path_correction_status | closed', 'packet doc');
passAssertion('fresh_runner_execution_decision_after_path_correction_closed');

mustHave(packetDoc, 'fresh_runner_execution_approval_capture_after_path_correction_status | captured_signed', 'packet doc');
passAssertion('fresh_runner_execution_approval_capture_after_path_correction_captured_signed');

mustHave(packetDoc, 'fresh_execution_pre_run_guard_after_path_correction_status | passed', 'packet doc');
passAssertion('fresh_execution_pre_run_guard_after_path_correction_passed');
...
passAssertion('incoming_future_command_status_blocked_until_after_guard_wiring_correction_and_fresh_decision');
...
passAssertion('corrected_future_command_status_blocked_until_after_guard_wiring_correction_fresh_decision_and_fresh_guard');
...
mustHave(
  packetDoc,
  'This packet corrects runner execution path after-guard wiring messaging/design **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'Build 117 consumed the post-Build-116 exact approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_117_consumed_post_build_116_attempt_documented');
...
passAssertion('prior_build_114_115_116_chain_not_reusable_documented');
...
readJson(upstreamFreshPreRunGuardAfterPathCorrectionFixturePath);
readJson(upstreamCaptureAfterPathCorrectionFixturePath);
readJson(upstreamFreshDecisionAfterPathCorrectionFixturePath);
readJson(upstreamPathCorrectionFixturePath);
...
passAssertion('upstream_fresh_decision_after_path_correction_fixture_present');
passAssertion('upstream_path_correction_fixture_present');
...
if (fixture.prior_post_build_116_blocked_evidence_status !== 'closed') {
  fail('fixture prior_post_build_116_blocked_evidence_status mismatch');
}
if (fixture.runner_execution_path_after_guard_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_guard_wiring_gap_status mismatch');
}
if (fixture.runner_execution_path_after_guard_wiring_correction_status !== 'design_or_corrected_review_only') {
  fail('fixture runner_execution_path_after_guard_wiring_correction_status mismatch');
}
if (fixture.prior_exact_command_attempt_after_build_116_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_exact_command_attempt_after_build_116_status mismatch');
}
if (fixture.prior_exact_command_exit_status !== 'nonzero_blocked') {
  fail('fixture prior_exact_command_exit_status mismatch');
}
if (
  fixture.prior_exact_command_attempt_consumption_status !==
  'consumed_by_blocked_fail_closed_result_after_build_116_guard'
) {
  fail('fixture prior_exact_command_attempt_consumption_status mismatch');
}
if (fixture.immediate_rerun_allowed !== false) {
  fail('fixture immediate_rerun_allowed must be false');
}
if (fixture.fresh_decision_required_after_after_guard_wiring_correction !== true) {
  fail('fixture fresh_decision_required_after_after_guard_wiring_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_after_guard_wiring_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_after_guard_wiring_correction must be true');
}
if (fixture.fresh_runner_execution_decision_after_path_correction_status !== 'closed') {
  fail('fixture fresh_runner_execution_decision_after_path_correction_status mismatch');
}
if (fixture.fresh_runner_execution_approval_capture_after_path_correction_status !== 'captured_signed') {
  fail('fixture fresh_runner_execution_approval_capture_after_path_correction_status mismatch');
}
if (fixture.fresh_execution_pre_run_guard_after_path_correction_status !== 'passed') {
  fail('fixture fresh_execution_pre_run_guard_after_path_correction_status mismatch');
}
...
mustHave(
  runnerScript,
  'prior_exact_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_116_guard (Build 117)',
  'runner script',
);
mustHave(
  runnerScript,
...
mustHave(runnerScript, 'fresh_decision_required_after_after_guard_wiring_correction: true', 'runner script');
mustHave(runnerScript, 'fresh_pre_run_guard_required_after_after_guard_wiring_correction: true', 'runner script');
...
passAssertion('runner_command_recognizes_build_114_fresh_decision');
passAssertion('runner_command_recognizes_build_115_approval_capture');
passAssertion('runner_command_recognizes_build_116_pre_run_guard');
passAssertion('runner_command_build_117_consumed_post_build_116_attempt');
passAssertion('runner_command_corrected_future_command_status');
...
mustNotHave(runnerScript, STALE_BUILD_112_NO_GO_MESSAGE, 'runner script');
...
passAssertion('runner_command_no_stale_build_112_era_primary_no_go');
...
mustHave(wrapper, 'local runner execution path after-guard wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'Build 117', 'wrapper Build 117');
mustHave(wrapper, 'Build 116', 'wrapper Build 116');
mustHave(wrapper, 'Build 115', 'wrapper Build 115');
mustHave(wrapper, 'Build 114', 'wrapper Build 114');
mustHave(wrapper, 'runner_execution_path_after_guard_wiring_gap_status is detected', 'wrapper mode');
mustHave(
  wrapper,
  'runner_execution_path_after_guard_wiring_correction_status is design_or_corrected_review_only',
  'wrapper mode',
);
mustHave(
  wrapper,
  'prior_exact_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_116_guard',
  'wrapper mode',
);
...
mustHave(wrapper, 'Build 117 consumed the post-Build-116 attempt', 'wrapper mode');
mustHave(
  wrapper,
  'fresh runner-execution decision and fresh execution pre-run guard after after-guard wiring correction',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `runner execution path after-guard wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('runner_execution_path_after_guard_wiring_correction_dry_run_wrapper_present_and_safe');
...
if (REQUIRED_ASSERTIONS.length !== 111) {
  fail(`REQUIRED_ASSERTIONS must contain 111 items (found ${REQUIRED_ASSERTIONS.length})`);
}

console.log(
  `PASS: Native Workflow Fixture Runner Execution Path After-Guard Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
