...
const packetDocPath = 'docs/NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_156_FRESH_CHAIN_WIRING_CORRECTION.md';
const fixturePath = 'backend/fixtures/native-workflow-demo-roofer/runner-execution-path-after-build-156-fresh-chain-wiring-correction.json';
const wrapperPath = 'scripts/run-native-workflow-fixture-runner-execution-path-after-build-156-fresh-chain-wiring-correction-dry-run.sh';
...
mustHave(doc, 'Native Workflow Fixture Runner Execution Path After Build 156 Fresh Chain Wiring Correction', 'packet doc');
mustHave(doc, 'source_of_truth_commit | 5dde6ce', 'packet doc');
mustHave(doc, 'prior_post_build_156_blocked_evidence_commit | 5dde6ce', 'packet doc');
mustHave(doc, 'runner_execution_path_after_build_156_fresh_chain_wiring_gap_status | detected', 'packet doc');
mustHave(doc, 'runner_execution_path_after_build_156_fresh_chain_wiring_correction_status | design_or_corrected_review_only', 'packet doc');
mustHave(doc, 'stale_build_153_154_155_156_non_recognition_removed | true', 'packet doc');
mustHave(doc, 'future_command_status | blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_156_fresh_chain_wiring_correction', 'packet doc');
...
expectEq(fixture, 'source_of_truth_commit', '5dde6ce');
...
expectEq(fixture, 'prior_exact_command_attempt_after_build_156_status', 'attempted_blocked_nonzero');
...
expectEq(fixture, 'prior_build_154_155_156_decision_approval_guard_chain_reusable_after_build_156_blocked_evidence', false);
expectEq(fixture, 'runner_output_source_of_truth_commit_observed_before_correction', '0c6abaf');
expectEq(fixture, 'runner_output_state_after_build_156_status', 'stale_pre_build_154_155_156_state_detected');
expectEq(fixture, 'runner_did_not_recognize_build_153_runner_execution_path_after_build_151_fresh_chain_wiring_correction_status_before_correction', true);
expectEq(fixture, 'runner_did_not_recognize_build_154_fresh_decision_after_build_151_fresh_chain_wiring_correction_status_before_correction', true);
expectEq(fixture, 'runner_did_not_recognize_build_155_approval_capture_after_build_154_build_151_fresh_chain_wiring_correction_status_before_correction', true);
expectEq(fixture, 'runner_did_not_recognize_build_156_pre_run_guard_after_build_154_build_151_fresh_chain_wiring_correction_status_before_correction', true);
expectEq(fixture, 'runner_execution_path_after_build_156_fresh_chain_wiring_gap_status', 'detected');
expectEq(fixture, 'runner_execution_path_after_build_156_fresh_chain_wiring_correction_status', 'design_or_corrected_review_only');
...
expectEq(fixture, 'runner_direct_invocation_status_after_correction', 'blocked_nonzero_expected');
expectEq(fixture, 'stale_build_147_era_0c6abaf_primary_state_removed', true);
expectEq(fixture, 'stale_build_153_154_155_156_non_recognition_removed', true);
expectEq(fixture, 'fresh_decision_required_after_build_156_fresh_chain_wiring_correction', true);
expectEq(fixture, 'fresh_pre_run_guard_required_after_build_156_fresh_chain_wiring_correction', true);
expectEq(fixture, 'no_immediate_runner_invocation_by_blocked_path', true);
expectEq(fixture, 'incoming_future_command_status_before_correction', 'blocked_until_runner_execution_path_after_build_156_fresh_chain_wiring_correction_and_fresh_decision');
expectEq(fixture, 'future_command_status', 'blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_156_fresh_chain_wiring_correction');
...
mustHave(wrapper, 'node backend/scripts/verify-native-workflow-fixture-runner-execution-path-after-build-156-fresh-chain-wiring-correction-readonly.js', 'wrapper');

for (const text of [aggregate, index, contextFirstPaid, contextAgent, guide, safeReadiness]) {
  if (!text.includes('Native Workflow Fixture Runner Execution Path After Build 156 Fresh Chain Wiring Correction') || !text.includes('native workflow fixture runner execution path after build 156 fresh chain wiring correction')) {
...
console.log('PASS: Native Workflow Fixture Runner Execution Path After Build 156 Fresh Chain Wiring Correction verified (' + passCount + ' assertions).');
