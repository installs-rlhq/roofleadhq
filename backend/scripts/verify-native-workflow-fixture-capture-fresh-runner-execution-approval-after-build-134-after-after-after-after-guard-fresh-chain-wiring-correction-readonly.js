...
const SOURCE_OF_TRUTH_COMMIT = 'a07dda6';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'a07dda6';
...
const APPROVED_EXACT_VALUES = {
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction',
...
const FRESH_RUNNER_EXECUTION_CAPTURE_CHECKS = [
  'Build 134 fresh runner-execution decision after after-after-after-after-guard fresh-chain wiring correction packet referenced upstream and closed at a07dda6',
  'Build 133 runner execution path after-after-after-after-guard fresh-chain wiring correction and Build 132 blocked command evidence referenced',
  'runner command path exists executable and corrected fail-closed pending fresh execution pre-run guard after Build 134 after-after-after-after-guard fresh-chain wiring correction approval capture',
  ...
  'future_command_status blocked until fresh execution pre-run guard passes after Build 134 after-after-after-after-guard fresh-chain wiring correction approval capture',
];
...
const REQUIRED_APPROVAL_LANGUAGE = [
  ...
  '30',
  'I approve only a scoped sandbox/test-mode runner-execution approval capture packet after the Build 133 after-after-after-after-guard fresh-chain wiring correction and Build 134 fresh decision/template packet.',
  ...
  'I understand Build 132 consumed the prior post-Build-131 attempt and no prior approval/guard chain is reusable.',
  'Signed: Jason Lohse',
  'Date/time: 06/20/2026 3:09pm MST',
];

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_a07dda6_referenced',
  'prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit_a07dda6_referenced',
  ...
  'build_134_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  ...
  'build_131_fresh_execution_pre_run_guard_after_after_all_after_guard_fresh_chain_wiring_correction_referenced',
  ...
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction',
  ...
  'future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction_approval_capture',
  ...
  'fresh_runner_execution_approval_capture_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_134_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION.md',
  'run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-134-after-after-after-after-guard-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-134-after-after-after-after-guard-fresh-chain-wiring-correction-readonly.js',
  'capture-fresh-runner-execution-approval-after-build-134-after-after-after-after-guard-fresh-chain-wiring-correction.json',
  ...
  'native workflow fixture capture fresh runner execution approval after build 134 after after after after guard fresh chain wiring correction',
  'capture fresh runner execution approval after build 134 after after after after guard fresh chain wiring correction',
];
...
passAssertion('source_of_truth_commit_a07dda6_referenced');
...
passAssertion('build_131_fresh_execution_pre_run_guard_after_after_all_after_guard_fresh_chain_wiring_correction_referenced');
...
mustHave(
  packetDoc,
  'fresh_runner_execution_approval_status | granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction',
  'packet doc',
);
mustHave(
  packetDoc,
...
mustHave(
  packetDoc,
  'This packet captures fresh runner-execution approval after Build 134 after-after-after-after-guard fresh-chain wiring correction **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'fresh execution pre-run guard pass after Build 134 after-after-after-after-guard fresh-chain wiring correction approval capture**, not execution', 'packet doc');
...
const upstreamAfterAfterAllAfterGuardFreshChainFixture = readJson(upstreamAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath);
const upstreamPostBuild131BlockedEvidenceFixture = readJson(upstreamPostBuild131BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterAfterAllAfterGuardFixture = readJson(upstreamFreshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath);
const upstreamCaptureAfterAfterAllAfterGuardFixture = readJson(upstreamCaptureAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be a07dda6');
}
if (
...
if (fixture.prior_runner_execution_path_after_after_all_after_guard_fresh_chain_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
...
if (!upstreamAfterAfterAllAfterGuardFreshChainFixture.packet_name) {
...
if (!upstreamFreshPreRunGuardAfterAfterAllAfterGuardFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterAfterAllAfterGuardFixture.packet_name) {
...
mustHave(wrapper, 'local fresh runner-execution approval capture after Build 134 after-after-after-after-guard fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 133');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 134 After-After-After-After-Guard Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
