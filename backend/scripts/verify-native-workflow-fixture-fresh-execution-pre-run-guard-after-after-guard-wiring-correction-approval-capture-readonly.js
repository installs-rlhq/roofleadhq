...
const freshDecisionAfterAfterGuardWiringCorrectionDocPath =
...
const SOURCE_OF_TRUTH_COMMIT = '203c0af';
...
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_PATH_CORRECTION_COMMIT = '2f1bbe3';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_PATH_CORRECTION_COMMIT = 'ddd193f';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_PATH_CORRECTION_COMMIT = '2ea4c2e';
const RUNNER_SCAFFOLDING_BUILD_COMMIT = '145bf15';
const SIGNED_APPROVAL_SIGNATURE_NAME = 'Jason Lohse';
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 12:06pm MST';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: '3b7719b',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_guard_wiring_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_after_guard_wiring_correction',
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_203c0af',
  'build_120_approval_capture_is_closed',
  'fresh_signed_approval_after_after_guard_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_after_guard_wiring_correction',
  ...
  'prior_build_114_115_116_approvals_guard_chain_not_reusable',
  'build_117_consumed_prior_post_build_116_attempt',
  'build_118_after_guard_wiring_correction_referenced',
  'build_119_fresh_decision_template_referenced',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_203c0af_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_commit_203c0af_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_status_closed',
  'prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_commit_3b7719b_referenced',
  'prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_status_closed',
  ...
  'build_120_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_packet_referenced',
  'build_119_fresh_runner_execution_decision_after_after_guard_wiring_correction_packet_referenced',
  'build_118_runner_execution_path_after_guard_wiring_correction_referenced',
  'build_117_post_build_116_blocked_evidence_referenced',
  'build_116_fresh_execution_pre_run_guard_after_path_correction_referenced',
  'build_115_capture_fresh_runner_execution_approval_after_path_correction_referenced',
  ...
  'approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_guard_wiring_correction',
  ...
  'prior_post_build_116_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_116_guard',
  'immediate_rerun_allowed_false',
  'fresh_runner_execution_approval_required_after_after_guard_wiring_correction_true',
  'fresh_execution_pre_run_guard_required_after_after_guard_wiring_correction_true',
  'prior_fresh_runner_execution_approval_reusable_after_after_guard_wiring_correction_false',
  'prior_fresh_execution_pre_run_guard_reusable_after_after_guard_wiring_correction_false',
  'prior_build_114_115_116_decision_approval_guard_chain_reusable_after_build_117_118_false',
  'runner_scaffolding_build_status_built_review_only',
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_guard_wiring_correction_guard',
  'runner_fail_closed_sanity_check_status_blocked_exit_code_1',
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_after_guard_wiring_correction',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_after_guard_wiring_correction_guard_review_only',
  ...
  'packet_does_not_treat_prior_build_114_115_116_approvals_guard_chain_as_reusable',
  'next_step_exact_approved_runner_execution_command_after_after_guard_wiring_correction_guard_review_only',
  ...
  'upstream_fresh_decision_after_after_guard_wiring_correction_fixture_present',
  'upstream_after_guard_wiring_correction_fixture_present',
  'upstream_post_build_116_blocked_evidence_fixture_present',
  'upstream_fresh_pre_run_guard_after_path_correction_fixture_present',
  'upstream_capture_after_path_correction_fixture_present',
  ...
  'fresh_execution_pre_run_guard_after_after_guard_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_GUARD_WIRING_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-guard-wiring-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-guard-wiring-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-after-guard-wiring-correction-approval-capture.json',
  'Native Workflow Fixture Fresh Execution Pre-Run Guard After After-Guard Wiring Correction Approval Capture',
  'native workflow fixture fresh execution pre run guard after after-guard wiring correction approval capture',
  'fresh execution pre run guard after after-guard wiring correction approval capture',
];
...
read(freshDecisionAfterAfterGuardWiringCorrectionDocPath);
read(approvalTemplateDocPath);
read(afterGuardWiringCorrectionPacketDocPath);
read(postBuild116BlockedEvidencePacketDocPath);
read(freshPreRunGuardAfterPathCorrectionPacketDocPath);
read(captureAfterPathCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_203c0af_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_commit_203c0af_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_status_closed');

mustHave(packetDoc, captureAfterAfterGuardWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, 'Build 120', 'packet doc');
passAssertion('build_120_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_packet_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_commit_3b7719b_referenced');

mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_status_closed');
...
mustHave(packetDoc, freshDecisionAfterAfterGuardWiringCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 119', 'packet doc');
passAssertion('build_119_fresh_runner_execution_decision_after_after_guard_wiring_correction_packet_referenced');
...
passAssertion('build_118_runner_execution_path_after_guard_wiring_correction_referenced');
...
passAssertion('build_117_post_build_116_blocked_evidence_referenced');

mustHave(packetDoc, freshPreRunGuardAfterPathCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterPathCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 116', 'packet doc');
passAssertion('build_116_fresh_execution_pre_run_guard_after_path_correction_referenced');

mustHave(packetDoc, captureAfterPathCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterPathCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 115', 'packet doc');
passAssertion('build_115_capture_fresh_runner_execution_approval_after_path_correction_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_guard_wiring_correction');
...
mustHave(
  packetDoc,
  'prior_post_build_116_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_116_guard',
  'packet doc',
);
passAssertion('prior_post_build_116_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_116_guard');

mustHave(packetDoc, 'immediate_rerun_allowed | false', 'packet doc');
passAssertion('immediate_rerun_allowed_false');

mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_after_guard_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_after_guard_wiring_correction | true', 'packet doc');
passAssertion('fresh_runner_execution_approval_required_after_after_guard_wiring_correction_true');
passAssertion('fresh_execution_pre_run_guard_required_after_after_guard_wiring_correction_true');

mustHave(packetDoc, 'prior_fresh_runner_execution_approval_reusable_after_after_guard_wiring_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_fresh_execution_pre_run_guard_reusable_after_after_guard_wiring_correction | false', 'packet doc');
passAssertion('prior_fresh_runner_execution_approval_reusable_after_after_guard_wiring_correction_false');
passAssertion('prior_fresh_execution_pre_run_guard_reusable_after_after_guard_wiring_correction_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_guard_wiring_correction_guard');
...
passAssertion('future_command_status_ready_for_exact_approved_runner_execution_command_after_after_guard_wiring_correction_guard_review_only');
...
mustHave(
  packetDoc,
  'This is the **fresh execution pre-run guard only** after after-guard wiring correction approval capture.',
  'packet doc',
);
...
mustHave(packetDoc, 'exact approved runner execution command after after-guard wiring correction guard review', 'packet doc');
passAssertion('next_step_exact_approved_runner_execution_command_after_after_guard_wiring_correction_guard_review_only');
mustHave(packetDoc, 'Fresh execution pre-run guard pass does **not** equal runner execution.', 'packet doc');
mustHave(packetDoc, 'This packet does **not** treat prior Build 114/115/116 approvals/guard chain as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_114_115_116_approvals_guard_chain_as_reusable');
...
for (const upstreamFixturePath of [
  ...
  upstreamFreshPreRunGuardAfterPathCorrectionFixturePath,
  upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath,
...
passAssertion('upstream_fresh_decision_after_after_guard_wiring_correction_fixture_present');
...
passAssertion('upstream_fresh_pre_run_guard_after_path_correction_fixture_present');
passAssertion('upstream_capture_after_path_correction_fixture_present');
...
const upstreamCaptureAfterAfterGuardWiringCorrectionFixture = readJson(
  upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath,
);
const upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixturePath,
);
const upstreamAfterGuardWiringCorrectionFixture = readJson(upstreamAfterGuardWiringCorrectionFixturePath);
const upstreamPostBuild116BlockedEvidenceFixture = readJson(upstreamPostBuild116BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterPathCorrectionFixture = readJson(upstreamFreshPreRunGuardAfterPathCorrectionFixturePath);
const upstreamCaptureAfterPathCorrectionFixture = readJson(upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 203c0af');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_commit must be 203c0af');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_status must be closed');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_commit must be 3b7719b');
}
if (fixture.prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_status !== 'closed') {
  fail('fixture prior_fresh_runner_execution_decision_after_after_guard_wiring_correction_status must be closed');
}
if (fixture.prior_runner_execution_path_after_guard_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_runner_execution_path_after_guard_wiring_correction_commit must be 9348a64');
}
...
if (
  fixture.prior_post_build_116_command_attempt_consumption_status !==
  'consumed_by_blocked_fail_closed_result_after_build_116_guard'
) {
  fail('fixture prior_post_build_116_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result_after_build_116_guard');
}
if (fixture.immediate_rerun_allowed !== false) {
  fail('fixture immediate_rerun_allowed must be false');
}
if (fixture.fresh_runner_execution_approval_required_after_after_guard_wiring_correction !== true) {
  fail('fixture fresh_runner_execution_approval_required_after_after_guard_wiring_correction must be true');
}
if (fixture.fresh_execution_pre_run_guard_required_after_after_guard_wiring_correction !== true) {
  fail('fixture fresh_execution_pre_run_guard_required_after_after_guard_wiring_correction must be true');
}
if (fixture.prior_fresh_runner_execution_approval_reusable_after_after_guard_wiring_correction !== false) {
  fail('fixture prior_fresh_runner_execution_approval_reusable_after_after_guard_wiring_correction must be false');
}
if (fixture.prior_fresh_execution_pre_run_guard_reusable_after_after_guard_wiring_correction !== false) {
  fail('fixture prior_fresh_execution_pre_run_guard_reusable_after_after_guard_wiring_correction must be false');
}
if (fixture.prior_build_114_115_116_decision_approval_guard_chain_reusable_after_build_117_118 !== false) {
  fail('fixture prior_build_114_115_116_decision_approval_guard_chain_reusable_after_build_117_118 must be false');
}
if (fixture.prior_build_117_consumed_attempt_status !== 'consumed') {
  fail('fixture prior_build_117_consumed_attempt_status must be consumed');
}
...
for (const field of EXACT_VALUE_FIELDS) {
  ...
  const expected = pendingGuardFields.includes(field)
    ? upstreamCaptureAfterAfterGuardWiringCorrectionFixture.accepted_exact_values[field]
    : APPROVED_EXACT_VALUES[field];
  if (upstreamCaptureAfterAfterGuardWiringCorrectionFixture.accepted_exact_values[field] !== expected) {
    fail(`upstream capture after after-guard wiring correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureAfterAfterGuardWiringCorrectionFixture.approved_exact_values[field] !== expected) {
    fail(`upstream capture after after-guard wiring correction fixture approved_exact_values.${field} mismatch`);
  }
  if (!pendingGuardFields.includes(field) && APPROVED_EXACT_VALUES[field] !== upstreamCaptureAfterAfterGuardWiringCorrectionFixture.accepted_exact_values[field]) {
...
if (upstreamCaptureAfterAfterGuardWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after path correction fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureAfterAfterGuardWiringCorrectionFixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
...
if (
  upstreamCaptureAfterAfterGuardWiringCorrectionFixture.future_command_status !==
  'blocked_until_fresh_execution_pre_run_guard_passes_after_after_guard_wiring_correction_approval_capture'
) {
  fail('upstream capture after path correction fixture future_command_status mismatch');
}

if (
  upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
...
if (!upstreamAfterGuardWiringCorrectionFixture.packet_name) {
  fail('upstream path correction fixture must exist with packet_name');
}

if (!upstreamPostBuild116BlockedEvidenceFixture.packet_name) {
  fail('upstream blocked evidence fixture must exist with packet_name');
}

if (!upstreamFreshPreRunGuardAfterPathCorrectionFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterPathCorrectionFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after after-guard wiring correction approval capture only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'wrapper Build 118');
mustHave(wrapper, PRIOR_POST_BUILD_116_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 117');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_after_guard_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after after-guard wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after after-guard wiring correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_execution_pre_run_guard_after_after_guard_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After After-Guard Wiring Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
