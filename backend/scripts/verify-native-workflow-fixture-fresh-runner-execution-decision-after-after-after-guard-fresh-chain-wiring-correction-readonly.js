...
const SOURCE_OF_TRUTH_COMMIT = 'c678189';
...
const FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_runner_execution_approval_captured_after_after_after_guard_fresh_chain_wiring_correction';
...
const FRESH_RUNNER_EXECUTION_TEMPLATE_CHECKS = [
  'Build 103-123 upstream packets referenced and runner execution path after-after-guard fresh-chain wiring correction closed at c678189',
  'runner command path exists executable and corrected fail-closed pending fresh decision after after-after-guard fresh-chain wiring correction',
  ...
  'future_command_status blocked until fresh runner execution approval captured after after-after-guard fresh-chain wiring correction',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, explicitly approve one-time fresh runner execution for the exact scoped actual external/sandbox 30-scenario validation described below after Build 123 runner execution path after-after-guard fresh-chain wiring correction.',
  'This fresh runner-execution approval is for fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_guard_fresh_chain_wiring_correction only.',
  ...
  'Even if signed later, runner execution remains blocked until a separate fresh execution pre-run guard passes after after-after-guard fresh-chain wiring correction.',
  'Prior Build 119/120/121 decision/approval/guard chain is not reusable after Build 122/123.',
  'Signature:',
  'Timestamp:',
  'Expiration:',
];
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_fixture_present',
  'upstream_fresh_runner_execution_decision_after_after_guard_wiring_correction_fixture_present',
  ...
  'source_of_truth_commit_c678189_referenced',
  ...
  'build_121_fresh_pre_run_guard_after_after_guard_wiring_correction_referenced',
  'build_120_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_referenced',
  'build_119_fresh_runner_execution_decision_after_after_guard_wiring_correction_referenced',
  ...
  'prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status_closed',
  'prior_post_build_121_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_121_guard',
  'prior_build_122_consumed_attempt_status_consumed',
  ...
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_after_guard_fresh_chain_wiring_correction',
  ...
  'future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'packet_does_not_treat_prior_build_119_120_121_chain_as_reusable',
  ...
  'fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_TEMPLATE.md',
  'run-native-workflow-fixture-fresh-runner-execution-decision-after-after-after-guard-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-fresh-runner-execution-decision-after-after-after-guard-fresh-chain-wiring-correction-readonly.js',
  'fresh-runner-execution-decision-after-after-after-guard-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Fresh Runner-Execution Decision After After-After-Guard Fresh-Chain Wiring Correction',
  'native workflow fixture fresh runner execution decision after after after guard fresh chain wiring correction',
  'fresh runner execution decision after after after guard fresh chain wiring correction',
];
...
passAssertion('source_of_truth_commit_c678189_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(approvalTemplateDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'approval template doc');
...
passAssertion('build_121_fresh_pre_run_guard_after_after_guard_wiring_correction_referenced');
...
passAssertion('build_119_fresh_runner_execution_decision_after_after_guard_wiring_correction_referenced');
...
mustHave(packetDoc, 'prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status | closed', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status | closed', 'approval template doc');
passAssertion('prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, 'prior_post_build_121_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_121_guard', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_post_build_121_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_121_guard', 'approval template doc');
...
mustHave(approvalTemplateDoc, 'prior_build_122_consumed_attempt_status | consumed', 'approval template doc');
passAssertion('prior_build_122_consumed_attempt_status_consumed');
...
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_after_after_guard_fresh_chain_wiring_correction is `true`', 'packet doc');
...
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction is `true`', 'packet doc');
...
mustHave(packetDoc, 'This packet **does not** treat prior Build 119/120/121 decision/approval/guard chain as reusable.', 'packet doc');
mustHave(approvalTemplateDoc, '**Explicit note:** This template does **not** treat prior Build 119/120/121 decision/approval/guard chain as reusable.', 'approval template doc');
passAssertion('packet_does_not_treat_prior_build_119_120_121_chain_as_reusable');
...
passAssertion('future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_after_after_guard_fresh_chain_wiring_correction');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_after_guard_fresh_chain_wiring_correction');
...
if (!fs.existsSync(path.join(root, upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixturePath))) fail(`missing upstream fresh pre-run guard after after-guard wiring correction fixture: ${upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixturePath}`);
passAssertion('upstream_fresh_pre_run_guard_after_after_guard_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath))) fail(`missing upstream capture after after-guard wiring correction fixture: ${upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath}`);
passAssertion('upstream_capture_fresh_runner_execution_approval_after_after_guard_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixturePath))) fail(`missing upstream fresh decision after after-guard wiring correction fixture: ${upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixturePath}`);
passAssertion('upstream_fresh_runner_execution_decision_after_after_guard_wiring_correction_fixture_present');
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) fail('fixture source_of_truth_commit must be c678189');
if (fixture.prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) fail('fixture prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_commit must be c678189');
if (fixture.prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') fail('fixture prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status must be closed');
if (fixture.prior_post_build_121_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_121_guard') fail('fixture prior_post_build_121_command_attempt_consumption_status mismatch');
if (fixture.prior_build_122_consumed_attempt_status !== 'consumed') fail('fixture prior_build_122_consumed_attempt_status must be consumed');
if (fixture.immediate_rerun_allowed !== false) fail('fixture immediate_rerun_allowed must be false');
if (fixture.fresh_runner_execution_approval_required_after_after_after_guard_fresh_chain_wiring_correction !== true) fail('fixture fresh_runner_execution_approval_required_after_after_after_guard_fresh_chain_wiring_correction must be true');
if (fixture.fresh_execution_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction !== true) fail('fixture fresh_execution_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction must be true');
if (fixture.prior_fresh_runner_execution_approval_reusable_after_after_after_guard_fresh_chain_wiring_correction !== false) fail('fixture prior_fresh_runner_execution_approval_reusable_after_after_after_guard_fresh_chain_wiring_correction must be false');
if (fixture.prior_fresh_execution_pre_run_guard_reusable_after_after_after_guard_fresh_chain_wiring_correction !== false) fail('fixture prior_fresh_execution_pre_run_guard_reusable_after_after_after_guard_fresh_chain_wiring_correction must be false');
if (fixture.prior_build_119_120_121_decision_approval_guard_chain_reusable_after_build_122_123 !== false) fail('fixture prior_build_119_120_121_decision_approval_guard_chain_reusable_after_build_122_123 must be false');
...
mustHave(runnerScript, 'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_121_guard (Build 122)', 'runner script');
...
mustHave(aggregate, 'Native Workflow Fixture Fresh Runner-Execution Decision After After-After-Guard Fresh-Chain Wiring Correction', 'aggregate readiness');
...
mustHave(wrapper, 'local fresh runner-execution decision/template after after-after-guard fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'prior_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status is closed', 'wrapper mode');
mustHave(wrapper, 'prior_post_build_121_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_121_guard', 'wrapper mode');
mustHave(wrapper, 'prior_build_122_consumed_attempt_status is consumed', 'wrapper mode');
mustHave(wrapper, 'immediate_rerun_allowed is false', 'wrapper mode');
mustHave(wrapper, 'prior Build 119/120/121 decision/approval/guard chain is not reusable after Build 122/123', 'wrapper mode');
...
mustHave(wrapper, 'Jason review/sign fresh runner-execution approval template after after-after-guard fresh-chain wiring correction', 'wrapper mode');
...
if (!isExecutable(wrapperPath)) fail(`fresh runner execution decision after after-after-guard fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`);
passAssertion('fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Runner-Execution Decision After After-After-Guard Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
