...
const FRESH_RUNNER_EXECUTION_TEMPLATE_CHECKS = [
  ...
  'future_command_status blocked until fresh runner execution approval captured after after-after-after-after-guard fresh-chain wiring correction',
];
...
const REQUIRED_ASSERTIONS = [
  ...
  'future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_after_after_after_guard_fresh_chain_wiring_correction is `true`', 'packet doc');
...
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_after_after_after_guard_fresh_chain_wiring_correction is `true`', 'packet doc');
...
passAssertion('future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_after_after_after_guard_fresh_chain_wiring_correction');
