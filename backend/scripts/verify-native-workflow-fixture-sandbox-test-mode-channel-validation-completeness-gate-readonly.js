...
const SOURCE_OF_TRUTH_COMMIT = '15644fa';
const UPSTREAM_EVIDENCE_CAPTURE_SOURCE_COMMIT = 'aa3f818';
...
const RECOMMENDED_NEXT_STEP =
  'JASON_COMPLETE_ALL_30_SANDBOX_TEST_MODE_CHANNEL_VALIDATION_EVIDENCE_BEFORE_ACTIVATION_CONSIDERATION';
const EXACT_COMMAND =
...
const NO_GO_MISSING_ITEMS = [
  'all 30 scenario IDs completed',
  'all 14 evidence fields filled per scenario',
  'expected behavior recorded',
  'observed behavior recorded',
  'external calls observed recorded',
  'captured artifacts/log paths recorded',
  'pass/fail result recorded',
  'stop/rollback result recorded',
  'evidence owner recorded',
  'timestamp recorded',
  'reviewer signoff recorded',
  'no unexpected external calls',
  'final post-run safety state verified',
];

const NO_GO_MISSING_KEYS = [
  'all_30_scenario_ids_completed',
  'all_14_evidence_fields_filled_per_scenario',
  'expected_behavior_recorded',
  'observed_behavior_recorded',
  'external_calls_observed_recorded',
  'captured_artifacts_log_paths_recorded',
  'pass_fail_result_recorded',
  'stop_rollback_result_recorded',
  'evidence_owner_recorded',
  'timestamp_recorded',
  'reviewer_signoff_recorded',
  'no_unexpected_external_calls',
  'final_post_run_safety_state_verified',
];
...
const REQUIRED_ASSERTIONS = [
  ...
  'source_of_truth_commit_15644fa_referenced',
  ...
  'channel_validation_evidence_capture_packet_status_completed',
  ...
  'channel_validation_completeness_gate_does_not_equal_approval',
  'no_go_review_does_not_equal_approval',
  ...
  'channel_validation_completeness_status_incomplete',
  'channel_validation_gate_decision_no_go_or_hold',
  'total_sandbox_test_mode_validation_scenarios_30',
  'captured_validation_scenarios_count_0',
  'passed_validation_scenarios_count_0',
  'failed_validation_scenarios_count_0',
  'missing_validation_evidence_scenarios_count_30',
  'sms_validation_scenarios_5_captured_0',
  'call_vapi_validation_scenarios_3_captured_0',
  'lead_intake_validation_scenarios_5_captured_0',
  'manual_review_escalation_validation_scenarios_4_captured_0',
  'calendar_appointment_validation_scenarios_4_captured_0',
  'reporting_admin_visibility_validation_scenarios_3_captured_0',
  'audit_log_evidence_validation_scenarios_3_captured_0',
  'stop_rollback_validation_scenarios_3_captured_0',
  'no_go_missing_items_checklist_all_13_present',
  'fixture_all_13_no_go_missing_items_marked_missing',
  'fixture_all_14_evidence_fields_required_per_scenario',
  'upstream_evidence_capture_all_30_scenarios_not_captured',
  'upstream_evidence_capture_packet_status_completed',
  'gate_does_not_approve_sandbox_test_mode_activation',
  'gate_live_activation_remains_not_granted',
  'gate_blocks_channel_validation_completeness',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_SANDBOX_TEST_MODE_CHANNEL_VALIDATION_COMPLETENESS_GATE.md',
  'NATIVE_WORKFLOW_FIXTURE_SANDBOX_TEST_MODE_CHANNEL_VALIDATION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-sandbox-test-mode-channel-validation-completeness-gate-dry-run.sh',
  'verify-native-workflow-fixture-sandbox-test-mode-channel-validation-completeness-gate-readonly.js',
  'sandbox-test-mode-channel-validation-completeness-gate.json',
  'Native Workflow Fixture Sandbox/Test-Mode Channel Validation Completeness Gate',
  'native workflow fixture sandbox test mode channel validation completeness gate',
  'sandbox test mode channel validation completeness gate',
];
...
passAssertion('source_of_truth_commit_15644fa_referenced');
...
mustHave(packetDoc, 'channel_validation_evidence_capture_packet_status | completed', 'packet doc');
passAssertion('channel_validation_evidence_capture_packet_status_completed');
...
mustHave(noGoReviewDoc, 'Evidence template does **not** equal approval', 'no-go review doc');
...
passAssertion('channel_validation_completeness_gate_does_not_equal_approval');

mustHave(packetDoc, 'No-go review does **not** equal approval', 'packet doc');
mustHave(noGoReviewDoc, 'No-go review does **not** equal approval', 'no-go review doc');
passAssertion('no_go_review_does_not_equal_approval');
...
mustHave(packetDoc, 'channel_validation_completeness_status | incomplete', 'packet doc');
passAssertion('channel_validation_completeness_status_incomplete');
...
mustHave(packetDoc, 'total_sandbox_test_mode_validation_scenarios | 30', 'packet doc');
mustHave(packetDoc, 'captured_validation_scenarios_count | 0', 'packet doc');
mustHave(packetDoc, 'passed_validation_scenarios_count | 0', 'packet doc');
mustHave(packetDoc, 'failed_validation_scenarios_count | 0', 'packet doc');
mustHave(packetDoc, 'missing_validation_evidence_scenarios_count | 30', 'packet doc');
passAssertion('total_sandbox_test_mode_validation_scenarios_30');
passAssertion('captured_validation_scenarios_count_0');
passAssertion('passed_validation_scenarios_count_0');
passAssertion('failed_validation_scenarios_count_0');
...
mustHave(packetDoc, '| 5 | 0 | RECOMMENDED_DEFAULT_ONLY_NOT_APPROVED |', 'packet doc');
passAssertion('sms_validation_scenarios_5_captured_0');
mustHave(packetDoc, 'sandbox_test_mode_call_vapi_validation', 'packet doc');
mustHave(packetDoc, '| 3 | 0 | RECOMMENDED_DEFAULT_ONLY_NOT_APPROVED |', 'packet doc');
passAssertion('call_vapi_validation_scenarios_3_captured_0');
mustHave(packetDoc, 'lead_intake_validation', 'packet doc');
passAssertion('lead_intake_validation_scenarios_5_captured_0');
mustHave(packetDoc, 'manual_review_escalation_validation', 'packet doc');
passAssertion('manual_review_escalation_validation_scenarios_4_captured_0');
mustHave(packetDoc, 'calendar_appointment_validation', 'packet doc');
passAssertion('calendar_appointment_validation_scenarios_4_captured_0');
mustHave(packetDoc, 'reporting_admin_visibility_validation', 'packet doc');
passAssertion('reporting_admin_visibility_validation_scenarios_3_captured_0');
mustHave(packetDoc, 'audit_log_evidence_validation', 'packet doc');
passAssertion('audit_log_evidence_validation_scenarios_3_captured_0');
mustHave(packetDoc, 'stop_rollback_validation', 'packet doc');
passAssertion('stop_rollback_validation_scenarios_3_captured_0');

for (const item of NO_GO_MISSING_ITEMS) {
  mustHave(noGoReviewDoc, item, 'no-go review doc missing items checklist');
}
passAssertion('no_go_missing_items_checklist_all_13_present');
...
mustHave(
  noGoReviewDoc,
  'No future sandbox/test-mode channel validation can be marked complete',
  'no-go review doc',
);
passAssertion('gate_blocks_channel_validation_completeness');
...
mustHave(packetDoc, 'does **not** run the recommended channel validation command', 'packet doc');
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 15644fa');
}
if (fixture.packet_status !== 'review_only') {
  fail('fixture packet_status must be review_only');
}
if (fixture.review_status !== 'channel_validation_completeness_gate_review_only') {
  fail('fixture review_status must be channel_validation_completeness_gate_review_only');
}
if (fixture.channel_validation_completeness_status !== 'incomplete') {
  fail('fixture channel_validation_completeness_status must be incomplete');
}
if (fixture.channel_validation_gate_decision !== 'NO_GO') {
  fail('fixture channel_validation_gate_decision must be NO_GO');
}
if (fixture.channel_validation_completeness_gate_does_not_equal_approval !== true) {
  fail('fixture channel_validation_completeness_gate_does_not_equal_approval must be true');
}
if (fixture.no_go_review_does_not_equal_approval !== true) {
  fail('fixture no_go_review_does_not_equal_approval must be true');
}
...
if (fixture.channel_validation_evidence_capture_packet_status !== 'completed') {
  fail('fixture channel_validation_evidence_capture_packet_status must be completed');
}
...
if (fixture.captured_validation_scenarios_count !== 0) {
  fail('fixture captured_validation_scenarios_count must be 0');
}
if (fixture.passed_validation_scenarios_count !== 0) {
  fail('fixture passed_validation_scenarios_count must be 0');
}
if (fixture.failed_validation_scenarios_count !== 0) {
  fail('fixture failed_validation_scenarios_count must be 0');
}
...
const capturedCountFields = {
  sandbox_test_mode_sms_validation: 'sandbox_test_mode_sms_validation_captured_count',
  sandbox_test_mode_call_vapi_validation: 'sandbox_test_mode_call_vapi_validation_captured_count',
  lead_intake_validation: 'lead_intake_validation_captured_count',
  manual_review_escalation_validation: 'manual_review_escalation_validation_captured_count',
  calendar_appointment_validation: 'calendar_appointment_validation_captured_count',
  reporting_admin_visibility_validation: 'reporting_admin_visibility_validation_captured_count',
  audit_log_evidence_validation: 'audit_log_evidence_validation_captured_count',
  stop_rollback_validation: 'stop_rollback_validation_captured_count',
};

for (const [category, expectedCount] of Object.entries(CATEGORY_COUNTS)) {
  const countField = `${category}_count`;
  if (fixture[countField] !== expectedCount) {
    fail(`fixture ${countField} must be ${expectedCount}`);
  }
  const capturedField = capturedCountFields[category];
  if (fixture[capturedField] !== 0) {
    fail(`fixture ${capturedField} must be 0`);
  }
}
...
passAssertion('fixture_all_13_no_go_missing_items_marked_missing');
...
if (evidenceCaptureFixture.source_of_truth_commit !== UPSTREAM_EVIDENCE_CAPTURE_SOURCE_COMMIT) {
  fail('upstream evidence capture fixture source_of_truth_commit must be aa3f818');
}
...
if (evidenceCaptureFixture.evidence_capture_status !== 'not_captured') {
  fail('upstream evidence capture fixture evidence_capture_status must be not_captured');
}

let upstreamTotalScenarios = 0;
for (const [category, expectedCount] of Object.entries(CATEGORY_COUNTS)) {
  const cat = evidenceCaptureFixture.validation_categories[category];
  if (!cat) fail(`upstream fixture missing validation category ${category}`);
  for (const scenario of cat.scenarios) {
    upstreamTotalScenarios += 1;
    if (scenario.evidence_capture_status !== 'not_captured') {
      fail(`upstream scenario ${scenario.scenario_id} evidence_capture_status must be not_captured`);
    }
    for (const field of EVIDENCE_FIELDS) {
...
if (upstreamTotalScenarios !== 30) {
  fail(`upstream fixture must contain 30 total scenarios (found ${upstreamTotalScenarios})`);
}
passAssertion('upstream_evidence_capture_all_30_scenarios_not_captured');
passAssertion('upstream_evidence_capture_packet_status_completed');
...
if (
  ...
  fixture.evidence_chain_commits.length !== 26
) {
  fail('fixture evidence_chain_commits must contain 26 commits');
}
for (const commit of EVIDENCE_CHAIN_COMMITS) {
...
mustHave(wrapper, 'No-go review does not equal approval', 'wrapper mode');
...
if (REQUIRED_ASSERTIONS.length !== 124) {
  fail(`REQUIRED_ASSERTIONS must contain 124 items (found ${REQUIRED_ASSERTIONS.length})`);
}

console.log(
  `PASS: Native Workflow Fixture Sandbox/Test-Mode Channel Validation Completeness Gate verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
