...
const upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '68c220d';
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_68c220d',
  'build_125_approval_capture_is_closed',
  'fresh_signed_approval_after_after_after_guard_fresh_chain_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'prior_build_119_120_121_approvals_guard_chain_not_reusable',
  'build_122_consumed_prior_post_build_121_attempt',
  'build_123_after_after_guard_fresh_chain_wiring_correction_referenced',
  'build_124_fresh_decision_template_referenced',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_68c220d_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_commit_68c220d_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_status_closed',
  ...
  'build_125_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  ...
  'prior_build_119_120_121_decision_approval_guard_chain_reusable_after_build_122_123_false',
  'runner_scaffolding_build_status_built_review_only',
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_after_guard_fresh_chain_wiring_correction_guard',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  ...
  'next_step_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  ...
  'fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-after-guard-fresh-chain-wiring-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-after-guard-fresh-chain-wiring-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-after-after-guard-fresh-chain-wiring-correction-approval-capture.json',
...
passAssertion('source_of_truth_commit_68c220d_referenced');
...
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_commit_68c220d_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, captureAfterAfterGuardWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, 'Build 125', 'packet doc');
passAssertion('build_125_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_after_guard_fresh_chain_wiring_correction_guard');
...
passAssertion('future_command_status_ready_for_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only');
...
mustHave(packetDoc, 'exact approved runner execution command after after-after-guard fresh-chain wiring correction guard review', 'packet doc');
passAssertion('next_step_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only');
...
for (const upstreamFixturePath of [
  upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
...
const upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamAfterAfterGuardFreshChainWiringCorrectionFixture = readJson(upstreamAfterAfterGuardFreshChainWiringCorrectionFixturePath);
const upstreamPostBuild121BlockedEvidenceFixture = readJson(upstreamPostBuild121BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixture = readJson(upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixturePath);
const upstreamCaptureAfterAfterGuardWiringCorrectionFixture = readJson(upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 68c220d');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_commit must be 68c220d');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_after_guard_fresh_chain_wiring_correction_status must be closed');
}
if (
...
if (
  fixture.prior_post_build_121_command_attempt_consumption_status !==
...
for (const field of EXACT_VALUE_FIELDS) {
  ...
  const expected = pendingGuardFields.includes(field)
    ? upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field]
    : APPROVED_EXACT_VALUES[field];
  if (upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field] !== expected) {
    fail(`upstream capture after after-after-guard fresh-chain wiring correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.approved_exact_values[field] !== expected) {
    fail(`upstream capture after after-after-guard fresh-chain wiring correction fixture approved_exact_values.${field} mismatch`);
  }
  if (!pendingGuardFields.includes(field) && APPROVED_EXACT_VALUES[field] !== upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field]) {
...
if (upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after path correction fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
...
if (
  upstreamCaptureAfterAfterAfterGuardFreshChainWiringCorrectionFixture.future_command_status !==
...
if (!upstreamAfterAfterGuardFreshChainWiringCorrectionFixture.packet_name) {
...
if (!upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterAfterGuardWiringCorrectionFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after after-after-guard fresh-chain wiring correction approval capture only', 'wrapper mode');
...
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after after-after-guard fresh-chain wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after after-after-guard fresh-chain wiring correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After After-After-Guard Fresh-Chain Wiring Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
