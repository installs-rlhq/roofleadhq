...
const freshPreRunGuardAfterAfterAllGuardDocPath =
...
const captureAfterAfterAllGuardPacketDocPath =
...
const freshDecisionAfterAfterAllGuardDocPath =
...
const postBuild121BlockedEvidencePacketDocPath =
...
const upstreamFreshPreRunGuardAfterAfterAllGuardFixturePath =
...
const upstreamCaptureAfterAfterAllGuardFixturePath =
...
const upstreamFreshDecisionAfterAfterAllGuardFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '4597948';
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '4597948';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '68c220d';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'e96c82c';
...
const RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED = '5e78db0';
...
const STALE_STATE_LINE =
  'NO-GO: Fresh runner-execution decision and fresh execution pre-run guard pass are required after runner execution path after-after-guard fresh-chain wiring correction';

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'structured_fixture_present',
  'structured_fixture_valid_json',
  'upstream_fresh_pre_run_guard_after_after_all_guard_fixture_present',
  'upstream_capture_after_after_all_guard_fixture_present',
  'upstream_fresh_decision_after_after_all_guard_fixture_present',
  ...
  'source_of_truth_commit_4597948_referenced',
  'prior_fresh_execution_pre_run_guard_after_after_all_guard_commit_4597948_referenced',
  'prior_fresh_execution_pre_run_guard_after_after_all_guard_status_closed',
  'prior_capture_after_after_all_guard_commit_68c220d_referenced',
  'prior_fresh_decision_after_after_all_guard_commit_e96c82c_referenced',
  ...
  'build_126_fresh_pre_run_guard_after_after_all_guard_packet_referenced',
  'build_125_capture_after_after_all_guard_packet_referenced',
  'build_124_fresh_decision_after_after_all_guard_packet_referenced',
  ...
  'approval_scope_fresh_run_after_after_all_guard_fresh_chain_wiring_correction',
  'exact_command_attempted_from_root_roofleadhq_documented',
  'exact_command_attempted_documented',
  'exact_command_attempted_after_build_126_status_attempted_blocked_nonzero',
  'exact_command_exit_status_nonzero_blocked',
  'command_attempt_consumption_status_consumed_by_blocked_after_build_126_guard',
  'runner_output_source_of_truth_commit_observed_5e78db0',
  'runner_output_state_after_build_126_stale_detected',
  'runner_recognized_build_118_119_120_121_chain',
  'runner_recognized_build_114_115_116_chain',
  'runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction',
  'runner_did_not_recognize_build_124_fresh_decision',
  'runner_did_not_recognize_build_125_approval_capture',
  'runner_did_not_recognize_build_126_pre_run_guard',
  'runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_detected',
  ...
  'future_command_status_blocked_until_after_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision',
  ...
  'next_step_after_after_after_guard_fresh_chain_wiring_correction_not_immediate_rerun',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'capture_post_build_126_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_126_RUNNER_COMMAND_BLOCKED_EVIDENCE.md',
  'run-native-workflow-fixture-capture-post-build-126-runner-command-blocked-evidence-dry-run.sh',
  'verify-native-workflow-fixture-capture-post-build-126-runner-command-blocked-evidence-readonly.js',
  'capture-post-build-126-runner-command-blocked-evidence.json',
  'Native Workflow Fixture Capture Post-Build-126 Runner Command Blocked Evidence',
  'native workflow fixture capture post build 126 runner command blocked evidence',
  'capture post build 126 runner command blocked evidence',
];
...
read(freshPreRunGuardAfterAfterAllGuardDocPath);
read(captureAfterAfterAllGuardPacketDocPath);
read(freshDecisionAfterAfterAllGuardDocPath);
read(afterAfterGuardFreshChainWiringCorrectionPacketDocPath);
read(postBuild121BlockedEvidencePacketDocPath);
...
passAssertion('source_of_truth_commit_4597948_referenced');

mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(
  packetDoc,
  'prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status | closed',
  'packet doc',
);
passAssertion('prior_fresh_execution_pre_run_guard_after_after_all_guard_commit_4597948_referenced');
passAssertion('prior_fresh_execution_pre_run_guard_after_after_all_guard_status_closed');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_capture_after_after_all_guard_commit_68c220d_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_decision_after_after_all_guard_commit_e96c82c_referenced');
...
mustHave(packetDoc, freshPreRunGuardAfterAfterAllGuardDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterAfterAllGuardFixturePath, 'packet doc');
mustHave(packetDoc, 'fresh-execution-pre-run-guard-after-after-after-guard-fresh-chain-wiring-correction-approval-capture', 'packet doc');
mustHave(packetDoc, 'Build 126', 'packet doc');
passAssertion('build_126_fresh_pre_run_guard_after_after_all_guard_packet_referenced');

mustHave(packetDoc, captureAfterAfterAllGuardPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterAfterAllGuardFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 125', 'packet doc');
passAssertion('build_125_capture_after_after_all_guard_packet_referenced');

mustHave(packetDoc, freshDecisionAfterAfterAllGuardDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterAfterAllGuardFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 124', 'packet doc');
passAssertion('build_124_fresh_decision_after_after_all_guard_packet_referenced');
...
mustHave(packetDoc, postBuild121BlockedEvidencePacketDocPath, 'packet doc');
...
passAssertion('approval_scope_fresh_run_after_after_all_guard_fresh_chain_wiring_correction');
...
mustHave(packetDoc, 'exact_command_attempted_after_build_126_status | attempted_blocked_nonzero', 'packet doc');
passAssertion('exact_command_attempted_after_build_126_status_attempted_blocked_nonzero');
...
passAssertion('command_attempt_consumption_status_consumed_by_blocked_after_build_126_guard');
...
passAssertion('runner_output_source_of_truth_commit_observed_5e78db0');

mustHave(
  packetDoc,
  'runner_output_state_after_build_126_status | stale_pre_build_123_124_125_126_state_detected',
  'packet doc',
);
passAssertion('runner_output_state_after_build_126_stale_detected');

mustHave(packetDoc, 'runner_recognized_build_118_119_120_121_chain_status | true', 'packet doc');
passAssertion('runner_recognized_build_118_119_120_121_chain');
...
mustHave(packetDoc, 'runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction');

mustHave(packetDoc, 'runner_did_not_recognize_build_124_fresh_decision_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_124_fresh_decision');

mustHave(packetDoc, 'runner_did_not_recognize_build_125_approval_capture_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_125_approval_capture');

mustHave(packetDoc, 'runner_did_not_recognize_build_126_pre_run_guard_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_126_pre_run_guard');
...
passAssertion('runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_detected');
...
passAssertion('future_command_status_blocked_until_after_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision');
...
mustHave(packetDoc, 'after-after-after-guard fresh-chain wiring correction', 'packet doc');
mustHave(packetDoc, 'fresh decision path', 'packet doc');
mustHave(packetDoc, 'not immediate rerun', 'packet doc');
passAssertion('next_step_after_after_after_guard_fresh_chain_wiring_correction_not_immediate_rerun');
...
readJson(upstreamFreshPreRunGuardAfterAfterAllGuardFixturePath);
readJson(upstreamCaptureAfterAfterAllGuardFixturePath);
readJson(upstreamFreshDecisionAfterAfterAllGuardFixturePath);
...
passAssertion('upstream_fresh_pre_run_guard_after_after_all_guard_fixture_present');
passAssertion('upstream_capture_after_after_all_guard_fixture_present');
passAssertion('upstream_fresh_decision_after_after_all_guard_fixture_present');
...
if (
  fixture.prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_commit !==
  PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_commit mismatch');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status must be closed');
}
...
if (fixture.exact_command_attempted_after_build_126_status !== 'attempted_blocked_nonzero') {
  fail('fixture exact_command_attempted_after_build_126_status mismatch');
}
if (fixture.exact_command_exit_status !== 'nonzero_blocked') {
  fail('fixture exact_command_exit_status mismatch');
}
if (fixture.command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_126_guard') {
...
if (fixture.runner_output_state_after_build_126_status !== 'stale_pre_build_123_124_125_126_state_detected') {
  fail('fixture runner_output_state_after_build_126_status mismatch');
}
if (fixture.runner_recognized_build_118_119_120_121_chain_status !== true) {
  fail('fixture runner_recognized_build_118_119_120_121_chain_status must be true');
}
...
if (fixture.runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction_status !== true) {
  fail('fixture runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction_status must be true');
}
if (fixture.runner_did_not_recognize_build_124_fresh_decision_status !== true) {
  fail('fixture runner_did_not_recognize_build_124_fresh_decision_status must be true');
}
if (fixture.runner_did_not_recognize_build_125_approval_capture_status !== true) {
  fail('fixture runner_did_not_recognize_build_125_approval_capture_status must be true');
}
if (fixture.runner_did_not_recognize_build_126_pre_run_guard_status !== true) {
  fail('fixture runner_did_not_recognize_build_126_pre_run_guard_status must be true');
}
if (fixture.runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status must be detected');
}
...
mustHave(wrapper, 'exact_command_attempted_after_build_126_status is attempted_blocked_nonzero', 'wrapper mode');
mustHave(wrapper, 'exact_command_exit_status is nonzero_blocked', 'wrapper mode');
mustHave(
  wrapper,
  'command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_126_guard',
  'wrapper mode',
);
mustHave(wrapper, 'runner_output_state_after_build_126_status is stale_pre_build_123_124_125_126_state_detected', 'wrapper mode');
...
mustHave(
  wrapper,
  'runner execution path after-after-after-guard fresh-chain wiring correction/design and fresh decision path',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`capture post-build-126 runner command blocked evidence dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('capture_post_build_126_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Post-Build-126 Runner Command Blocked Evidence verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
