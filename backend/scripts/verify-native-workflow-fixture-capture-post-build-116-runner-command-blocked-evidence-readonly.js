...
const SOURCE_OF_TRUTH_COMMIT = '2f1bbe3';
...
const STALE_STATE_LINE =
  'NO-GO: Fresh runner-execution decision and fresh execution pre-run guard pass are required after runner execution path correction';
...
const REQUIRED_ASSERTIONS = [
  ...
  'source_of_truth_commit_2f1bbe3_referenced',
  'prior_fresh_execution_pre_run_guard_after_path_correction_commit_2f1bbe3_referenced',
  'prior_fresh_execution_pre_run_guard_after_path_correction_status_closed',
  ...
  'approval_scope_fresh_run_after_path_correction',
  'exact_command_attempted_from_root_roofleadhq_documented',
  'exact_command_attempted_documented',
  'exact_command_attempted_after_build_116_status_attempted_blocked_nonzero',
  'exact_command_exit_status_nonzero_blocked',
  'command_attempt_consumption_status_consumed_by_blocked_after_build_116_guard',
  'runner_output_state_after_build_116_stale_detected',
  'runner_did_not_recognize_build_114_fresh_decision',
  'runner_did_not_recognize_build_115_approval_capture',
  'runner_did_not_recognize_build_116_pre_run_guard',
  'runner_execution_path_after_guard_wiring_gap_detected',
  ...
  'future_command_status_blocked_until_after_guard_wiring_correction_and_fresh_decision',
  ...
  'next_step_after_guard_wiring_correction_not_immediate_rerun',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'capture_post_build_116_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_116_RUNNER_COMMAND_BLOCKED_EVIDENCE.md',
  'run-native-workflow-fixture-capture-post-build-116-runner-command-blocked-evidence-dry-run.sh',
  'verify-native-workflow-fixture-capture-post-build-116-runner-command-blocked-evidence-readonly.js',
  'capture-post-build-116-runner-command-blocked-evidence.json',
  'Native Workflow Fixture Capture Post-Build-116 Runner Command Blocked Evidence',
  'native workflow fixture capture post build 116 runner command blocked evidence',
  'capture post build 116 runner command blocked evidence',
];
...
passAssertion('source_of_truth_commit_2f1bbe3_referenced');
...
passAssertion('prior_fresh_execution_pre_run_guard_after_path_correction_status_closed');
...
mustHave(packetDoc, 'fresh-execution-pre-run-guard-after-path-correction-approval-capture', 'packet doc');
...
passAssertion('approval_scope_fresh_run_after_path_correction');
...
mustHave(packetDoc, 'exact_command_attempted_after_build_116_status | attempted_blocked_nonzero', 'packet doc');
passAssertion('exact_command_attempted_after_build_116_status_attempted_blocked_nonzero');
...
passAssertion('command_attempt_consumption_status_consumed_by_blocked_after_build_116_guard');
...
passAssertion('runner_output_state_after_build_116_stale_detected');

mustHave(packetDoc, 'runner_did_not_recognize_build_114_fresh_decision_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_114_fresh_decision');

mustHave(packetDoc, 'runner_did_not_recognize_build_115_approval_capture_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_115_approval_capture');

mustHave(packetDoc, 'runner_did_not_recognize_build_116_pre_run_guard_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_116_pre_run_guard');

mustHave(packetDoc, 'runner_execution_path_after_guard_wiring_gap_status | detected', 'packet doc');
passAssertion('runner_execution_path_after_guard_wiring_gap_detected');
...
passAssertion('future_command_status_blocked_until_after_guard_wiring_correction_and_fresh_decision');
...
mustHave(packetDoc, 'after-guard wiring correction', 'packet doc');
mustHave(packetDoc, 'fresh decision path', 'packet doc');
mustHave(packetDoc, 'not immediate rerun', 'packet doc');
passAssertion('next_step_after_guard_wiring_correction_not_immediate_rerun');
...
if (fixture.prior_fresh_execution_pre_run_guard_after_path_correction_commit !== PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_PATH_CORRECTION_COMMIT) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_path_correction_commit mismatch');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_path_correction_status !== 'closed') {
  fail('fixture prior_fresh_execution_pre_run_guard_after_path_correction_status must be closed');
}
...
if (fixture.exact_command_attempted_after_build_116_status !== 'attempted_blocked_nonzero') {
  fail('fixture exact_command_attempted_after_build_116_status mismatch');
}
if (fixture.exact_command_exit_status !== 'nonzero_blocked') {
  fail('fixture exact_command_exit_status mismatch');
}
if (fixture.command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_116_guard') {
  fail('fixture command_attempt_consumption_status mismatch');
}
if (fixture.runner_output_state_after_build_116_status !== 'stale_pre_build_114_115_116_state_detected') {
  fail('fixture runner_output_state_after_build_116_status mismatch');
}
if (fixture.runner_did_not_recognize_build_114_fresh_decision_status !== true) {
  fail('fixture runner_did_not_recognize_build_114_fresh_decision_status must be true');
}
if (fixture.runner_did_not_recognize_build_115_approval_capture_status !== true) {
  fail('fixture runner_did_not_recognize_build_115_approval_capture_status must be true');
}
if (fixture.runner_did_not_recognize_build_116_pre_run_guard_status !== true) {
  fail('fixture runner_did_not_recognize_build_116_pre_run_guard_status must be true');
}
if (fixture.runner_execution_path_after_guard_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_guard_wiring_gap_status must be detected');
}
...
mustHave(wrapper, 'exact_command_attempted_after_build_116_status is attempted_blocked_nonzero', 'wrapper mode');
mustHave(wrapper, 'exact_command_exit_status is nonzero_blocked', 'wrapper mode');
mustHave(
  wrapper,
  'command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_116_guard',
  'wrapper mode',
);
mustHave(wrapper, 'runner_output_state_after_build_116_status is stale_pre_build_114_115_116_state_detected', 'wrapper mode');
...
mustHave(
  wrapper,
  'runner execution path after-guard wiring correction/design and fresh decision path',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`capture post-build-116 runner command blocked evidence dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('capture_post_build_116_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Post-Build-116 Runner Command Blocked Evidence verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
