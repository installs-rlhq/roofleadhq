...
const SOURCE_OF_TRUTH_COMMIT = '135b367';
...
const REQUIRED_ASSERTIONS = [
  ...
  'source_of_truth_commit_135b367_referenced',
  ...
  'fresh_runner_command_attempt_status_attempted_blocked_nonzero',
  'fresh_runner_command_exit_status_nonzero_blocked',
  'fresh_runner_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result',
  'runner_direct_invocation_status_after_fresh_guard_blocked_nonzero_expected',
  ...
  'external_calls_made_by_runner_attempt_false',
  'credentials_accessed_by_runner_attempt_false',
  'secret_values_logged_by_runner_attempt_false',
  'production_data_accessed_by_runner_attempt_false',
  'real_contact_made_by_runner_attempt_false',
  'sms_email_calls_calendar_booking_performed_by_runner_attempt_false',
  'validation_log_written_by_runner_attempt_false',
  'structured_evidence_written_by_runner_attempt_false',
  ...
  'future_command_status_blocked_until_runner_execution_path_correction_and_fresh_decision',
  ...
  'next_step_runner_execution_path_correction_not_immediate_rerun',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'capture_fresh_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE.md',
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-capture-fresh-runner-command-blocked-evidence-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-command-blocked-evidence-readonly.js',
  'capture-fresh-runner-command-blocked-evidence.json',
  'Native Workflow Fixture Capture Fresh Runner Command Blocked Evidence',
  'native workflow fixture capture fresh runner command blocked evidence',
  'capture fresh runner command blocked evidence',
];
...
passAssertion('source_of_truth_commit_135b367_referenced');
...
mustHave(packetDoc, 'fresh-execution-pre-run-guard', 'packet doc');
...
mustHave(packetDoc, `exact_command_attempted_from_working_directory | ${EXACT_WORKING_DIRECTORY}`, 'packet doc');
...
mustHave(packetDoc, 'fresh_runner_command_attempt_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_runner_command_attempt_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('fresh_runner_command_attempt_status_attempted_blocked_nonzero');

mustHave(packetDoc, 'fresh_runner_command_exit_status | nonzero_blocked', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_runner_command_exit_status | nonzero_blocked', 'no-go review');
passAssertion('fresh_runner_command_exit_status_nonzero_blocked');
...
passAssertion('fresh_runner_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result');
...
passAssertion('runner_direct_invocation_status_after_fresh_guard_blocked_nonzero_expected');

mustHave(packetDoc, 'runner_execution_status | not_run', 'packet doc');
mustHave(noGoReviewDoc, 'runner_execution_status | not_run', 'no-go review');
passAssertion('runner_execution_status_not_run');

mustHave(packetDoc, 'command_execution_status | not_run', 'packet doc');
mustHave(noGoReviewDoc, 'command_execution_status | not_run', 'no-go review');
...
mustHave(packetDoc, 'external_calls_made_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'credentials_accessed_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'secret_values_logged_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'production_data_accessed_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'sms_email_calls_calendar_booking_performed_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'real_contact_made_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'validation_log_written_by_runner_attempt | false', 'packet doc');
mustHave(packetDoc, 'structured_evidence_written_by_runner_attempt | false', 'packet doc');
passAssertion('external_calls_made_by_runner_attempt_false');
passAssertion('credentials_accessed_by_runner_attempt_false');
passAssertion('secret_values_logged_by_runner_attempt_false');
passAssertion('production_data_accessed_by_runner_attempt_false');
passAssertion('sms_email_calls_calendar_booking_performed_by_runner_attempt_false');
passAssertion('real_contact_made_by_runner_attempt_false');
passAssertion('validation_log_written_by_runner_attempt_false');
passAssertion('structured_evidence_written_by_runner_attempt_false');
...
passAssertion('future_command_status_blocked_until_runner_execution_path_correction_and_fresh_decision');
...
mustHave(packetDoc, 'runner execution path correction', 'packet doc');
mustHave(packetDoc, 'fresh decision path', 'packet doc');
mustHave(packetDoc, 'not immediate rerun', 'packet doc');
passAssertion('next_step_runner_execution_path_correction_not_immediate_rerun');
...
if (fixture.exact_command_attempted_from_working_directory !== EXACT_WORKING_DIRECTORY) {
  fail('fixture exact_command_attempted_from_working_directory mismatch');
}
if (fixture.exact_command_attempted !== EXACT_COMMAND) {
  fail('fixture exact_command_attempted mismatch');
}
if (fixture.fresh_runner_command_attempt_status !== 'attempted_blocked_nonzero') {
  fail('fixture fresh_runner_command_attempt_status mismatch');
}
if (fixture.fresh_runner_command_exit_status !== 'nonzero_blocked') {
  fail('fixture fresh_runner_command_exit_status mismatch');
}
if (fixture.fresh_runner_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result') {
  fail('fixture fresh_runner_command_attempt_consumption_status mismatch');
}
if (fixture.runner_direct_invocation_status_after_fresh_guard !== 'blocked_nonzero_expected') {
  fail('fixture runner_direct_invocation_status_after_fresh_guard mismatch');
}
if (fixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('fixture fresh_runner_execution_approval_capture_status mismatch');
}
if (fixture.fresh_runner_execution_jason_signed_approval_status !== 'signed') {
  fail('fixture fresh_runner_execution_jason_signed_approval_status mismatch');
}
...
if (fixture.external_calls_made_by_runner_attempt !== false) {
  fail('fixture external_calls_made_by_runner_attempt must be false');
}
if (fixture.credentials_accessed_by_runner_attempt !== false) {
  fail('fixture credentials_accessed_by_runner_attempt must be false');
}
if (fixture.secret_values_logged_by_runner_attempt !== false) {
  fail('fixture secret_values_logged_by_runner_attempt must be false');
}
if (fixture.production_data_accessed_by_runner_attempt !== false) {
  fail('fixture production_data_accessed_by_runner_attempt must be false');
}
if (fixture.sms_email_calls_calendar_booking_performed_by_runner_attempt !== false) {
  fail('fixture sms_email_calls_calendar_booking_performed_by_runner_attempt must be false');
}
if (fixture.real_contact_made_by_runner_attempt !== false) {
  fail('fixture real_contact_made_by_runner_attempt must be false');
}
if (fixture.validation_log_written_by_runner_attempt !== false) {
  fail('fixture validation_log_written_by_runner_attempt must be false');
}
if (fixture.structured_evidence_written_by_runner_attempt !== false) {
  fail('fixture structured_evidence_written_by_runner_attempt must be false');
}
...
mustHave(wrapper, 'Build 108', 'wrapper Build 108');
mustHave(wrapper, 'fresh_runner_command_attempt_status is attempted_blocked_nonzero', 'wrapper mode');
mustHave(wrapper, 'fresh_runner_command_exit_status is nonzero_blocked', 'wrapper mode');
mustHave(wrapper, 'fresh_runner_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result', 'wrapper mode');
mustHave(wrapper, 'runner_direct_invocation_status_after_fresh_guard is blocked_nonzero_expected', 'wrapper mode');
...
mustHave(
  wrapper,
  'runner execution path correction/design and fresh decision path',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`capture fresh runner command blocked evidence dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('capture_fresh_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner Command Blocked Evidence verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
