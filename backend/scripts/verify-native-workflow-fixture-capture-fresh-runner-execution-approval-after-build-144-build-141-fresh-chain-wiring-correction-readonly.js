...
const SOURCE_OF_TRUTH_COMMIT = 'f4c3069';
...
const FRESH_RUNNER_EXECUTION_CAPTURE_CHECKS = [
  'Build 144 fresh runner-execution decision after Build 141 fresh-chain wiring correction packet referenced upstream and closed at f4c3069',
  'Build 143 runner execution path after Build 141 fresh-chain wiring correction and Build 142 blocked command evidence referenced',
  'runner command path exists executable and corrected fail-closed pending fresh execution pre-run guard after Build 144 Build 141 fresh-chain wiring correction approval capture',
  ...
  'future_command_status blocked until fresh execution pre-run guard passes after Build 144 Build 141 fresh-chain wiring correction approval capture',
];
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_f4c3069_referenced',
  ...
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture',
  ...
  'future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture',
  ...
  'packet_does_not_treat_prior_build_138_139_140_141_approvals_guard_chain_as_reusable',
  ...
  'fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_144_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION.md',
  'run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-144-build-141-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-144-build-141-fresh-chain-wiring-correction-readonly.js',
  'capture-fresh-runner-execution-approval-after-build-144-build-141-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 144 Build 141 Fresh-Chain Wiring Correction',
  'native workflow fixture capture fresh runner execution approval after build 144 build 141 fresh chain wiring correction',
  'capture fresh runner execution approval after build 144 build 141 fresh chain wiring correction',
];
...
passAssertion('source_of_truth_commit_f4c3069_referenced');
...
mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_status | closed', 'packet doc');
...
passAssertion('build_144_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_141_fresh_chain_wiring_correction');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_141_guard');
...
mustHave(packetDoc, 'fresh_runner_execution_scope_approved | fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_141_fresh_chain_wiring_correction', 'packet doc');
...
passAssertion('prior_build_138_139_140_141_decision_approval_guard_chain_reusable_after_build_142_blocked_evidence_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture');
...
passAssertion('future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture');
...
passAssertion('packet_does_not_treat_prior_build_138_139_140_141_approvals_guard_chain_as_reusable');
mustHave(packetDoc, 'fresh execution pre-run guard pass after Build 144 Build 141 fresh-chain wiring correction approval capture**, not execution', 'packet doc');
...
for (const upstreamFixturePath of [
  upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixturePath,
  upstreamRunnerExecutionPathAfterBuild141FreshChainWiringCorrectionFixturePath,
...
const upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixturePath,
);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be f4c3069');
}
if (
...
if (
  upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
...
if (
  upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !==
  'not_captured'
) {
  fail(
    'upstream fresh decision after Build 141 fresh-chain wiring correction fixture fresh_runner_execution_approval_capture_status must be not_captured (prior to this capture packet)',
  );
}
...
mustHave(wrapper, 'local fresh runner-execution approval capture after Build 144 Build 141 fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(
  wrapper,
  'future_command_status is blocked_until_fresh_execution_pre_run_guard_passes_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh runner-execution approval capture after Build 144 Build 141 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 144 Build 141 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
