#!/usr/bin/env node
/*
 * SUPERSEDED BY BUILD 224 — Website Founder-Led Launch Copy Cleanup verifier.
 * Formerly enforced REMOVAL of public founder-led language (replacing it with
 * "Guided Setup / RoofLeadHQ AI / 14-day trial" copy).
 *
