...
const packetPath = 'docs/ROOFER_DRY_RUN_FIRST_ROOFER_SETUP_PACKET.md';
...
assertIncludes(
  aggregatePath,
  'verify-roofer-dry-run-first-roofer-setup-packet-readonly.js'
);
...
console.log('Roofer dry-run first roofer setup packet verifier passed.');
