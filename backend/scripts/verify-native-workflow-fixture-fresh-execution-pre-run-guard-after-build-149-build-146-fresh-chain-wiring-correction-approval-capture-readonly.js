...
const SOURCE_OF_TRUTH_COMMIT = '09bf972';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_149_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '09bf972';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'df9fee3';
const PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '135b26c';
const PRIOR_POST_BUILD_141_BLOCKED_EVIDENCE_COMMIT = '0c6abaf';
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '628436a';
...
const RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_ready_for_exact_approved_execution_after_build_149_build_146_fresh_chain_wiring_correction_guard';
const FUTURE_COMMAND_STATUS =
  'ready_for_exact_approved_runner_execution_command_after_build_149_build_146_fresh_chain_wiring_correction_guard_review_only';
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_09bf972',
  'build_145_approval_capture_is_closed',
  'fresh_signed_approval_after_build_149_build_146_fresh_chain_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_build_149_build_146_fresh_chain_wiring_correction',
  ...
  'build_147_consumed_prior_post_build_146_attempt',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_09bf972_referenced',
  'prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_commit_09bf972_referenced',
  'prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_status_closed',
  ...
  'build_145_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_packet_referenced',
  ...
  'build_146_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_referenced',
  ...
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_build_149_build_146_fresh_chain_wiring_correction_guard',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_build_149_build_146_fresh_chain_wiring_correction_guard_review_only',
  ...
  'next_step_exact_approved_runner_execution_command_after_build_149_build_146_fresh_chain_wiring_correction_guard_review_only',
  ...
  'upstream_capture_after_build_149_build_146_fresh_chain_wiring_correction_fixture_present',
  ...
  'upstream_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_fixture_present_not_reusable',
  ...
  'fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_149_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-149-build-146-fresh-chain-wiring-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-149-build-146-fresh-chain-wiring-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-build-149-build-146-fresh-chain-wiring-correction-approval-capture.json',
  'Native Workflow Fixture Fresh Execution Pre-Run Guard Build 149 Build 146 Fresh-Chain Wiring Correction Approval Capture',
  'native workflow fixture fresh execution pre run guard after build 149 build 146 fresh chain wiring correction approval capture',
  'fresh execution pre run guard after build 149 build 146 fresh chain wiring correction approval capture',
];
...
passAssertion('source_of_truth_commit_09bf972_referenced');

mustHave(
  packetDoc,
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_149_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT,
  'packet doc',
);
mustHave(
  packetDoc,
...
mustHave(packetDoc, 'Build 150', 'packet doc');
passAssertion(
  'build_145_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_packet_referenced',
);
...
passAssertion('build_146_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_referenced');
...
mustHave(
  packetDoc,
  'exact approved runner execution command after build 149 build 146 fresh-chain wiring correction guard review',
  'packet doc',
);
passAssertion(
  'next_step_exact_approved_runner_execution_command_after_build_149_build_146_fresh_chain_wiring_correction_guard_review_only',
...
passAssertion('upstream_capture_after_build_149_build_146_fresh_chain_wiring_correction_fixture_present');
...
passAssertion('upstream_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_fixture_present_not_reusable');
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 09bf972');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_149_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail(
    'fixture prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_commit must be 09bf972',
  );
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_status !==
  'closed'
) {
  fail(
    'fixture prior_capture_fresh_runner_execution_approval_after_build_149_build_146_fresh_chain_wiring_correction_status must be closed',
  );
}
if (
...
if (
  fixture.prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_commit !==
  PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
...
if (
  fixture.prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence !==
  false
) {
  fail(
    'fixture prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence must be false',
  );
}
...
for (const field of EXACT_VALUE_FIELDS) {
  ...
  if (upstreamCaptureFixture.accepted_exact_values[field] !== expected) {
    fail(`upstream capture after build 149 build 146 fresh-chain wiring correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureFixture.approved_exact_values[field] !== expected) {
    fail(`upstream capture after build 149 build 146 fresh-chain wiring correction fixture approved_exact_values.${field} mismatch`);
  }
  if (
...
if (upstreamCaptureFixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after build 149 build 146 fresh-chain wiring correction fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureFixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
  fail('upstream capture after build 149 build 146 fresh-chain wiring correction fixture fresh_execution_pre_run_guard_status must be not_passed_by_this_packet');
}
if (
  ...
  fail('upstream capture after build 149 build 146 fresh-chain wiring correction fixture future_command_status mismatch');
}
...
if (!upstreamPostBuild141BlockedEvidenceFixture.packet_name) {
  fail('upstream post build 146 blocked evidence fixture must exist with packet_name');
}

if (!upstreamPriorFreshPreRunGuardFixture.packet_name) {
  fail('upstream fresh pre-run guard after build 144 build 141 fresh-chain wiring correction fixture must exist with packet_name');
}
...
mustHave(
  wrapper,
  'local fresh execution pre-run guard after build 149 build 146 fresh-chain wiring correction approval capture only',
  'wrapper mode',
);
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 148');
mustHave(wrapper, PRIOR_POST_BUILD_141_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 147');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_build_149_build_146_fresh_chain_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after build 149 build 146 fresh-chain wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after build 149 build 146 fresh-chain wiring correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion(
  'fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe',
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard Build 149 Build 146 Fresh-Chain Wiring Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
