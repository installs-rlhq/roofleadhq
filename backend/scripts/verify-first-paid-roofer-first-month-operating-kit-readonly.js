...
const docPath = "docs/FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md";
const wrapperPath = "scripts/run-first-paid-roofer-first-month-operating-kit-dry-run.sh";
const verifierPath = "backend/scripts/verify-first-paid-roofer-first-month-operating-kit-readonly.js";
...
console.log("PASS: all expected files for first paid roofer first-month operating kit exist.");

// File existence and basic properties
mustHave(doc, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "first paid roofer first-month operating kit doc");
mustHave(doc, "run-first-paid-roofer-first-month-operating-kit-dry-run.sh", "first paid roofer first-month operating kit doc references wrapper");
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_CONVERSION_PAYMENT_HANDOFF_KIT.md", "first paid roofer first-month operating kit doc references trial conversion payment handoff kit (primary input)");
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "first paid roofer first-month operating kit doc references trial reporting success review kit");
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_DAY_ONE_OPERATING_KIT.md", "first paid roofer first-month operating kit doc references trial day one operating kit");
mustHave(doc, "FIRST_PAID_ROOFER_GO_LIVE_READINESS_EXECUTION_KIT.md", "first paid roofer first-month operating kit doc references go-live readiness execution kit");
mustHave(doc, "FIRST_PAID_ROOFER_GUIDED_SETUP_EXECUTION_KIT.md", "first paid roofer first-month operating kit doc references guided setup execution kit");
mustHave(doc, "FIRST_PAID_ROOFER_LAUNCH_SYSTEM_PACKET.md", "first paid roofer first-month operating kit doc references launch system packet");
mustHave(doc, "WEBSITE_TRIAL_DIRECTION_REGRESSION_PACKET.md", "first paid roofer first-month operating kit doc references website trial direction regression packet");
mustHave(doc, "ROOFER_DATA_PROTECTION_TENANT_ISOLATION_PLAN_PLACEMENT_PACKET.md", "first paid roofer first-month operating kit doc references data protection tenant isolation packet");
...
mustHave(wrapper, "verify-first-paid-roofer-first-month-operating-kit-readonly.js", "wrapper must call this verifier");
mustHave(wrapper, "node --check backend/scripts/verify-first-paid-roofer-first-month-operating-kit-readonly.js", "wrapper must run node --check on verifier");
...
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_CONVERSION_PAYMENT_HANDOFF_KIT.md", "kit doc must reference trial conversion payment handoff kit (primary input)");
...
mustHave(aggregate, "verify-first-paid-roofer-first-month-operating-kit-readonly.js", "aggregate pilot readiness must wire the first-month operating kit verifier");
mustHave(verifierIndex, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "verifier index must list the first-month operating kit doc");
mustHave(contextFirstPaid, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_FIRST_PAID_LAUNCH must record first-month operating kit");
mustHave(contextRooferDryRun, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_ROOFER_DRY_RUN_ONBOARDING must record first-month operating kit");
mustHave(workflow, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_AGENT_GROK_BUILD_WORKFLOW must record first-month operating kit");
mustHave(businessGuide, "FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md", "ROOFLEADHQ_BUSINESS_BUILDOUT_DAILY_GUIDE must record first-month operating kit");
...
assertSectionWithContent(doc, "## 1. Internal-only dry-run scope", [
  ...
  "manual first-month operating readiness and customer success tracking only",
  "No live systems"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 2. First-month operating purpose", [
  "after the first monthly payment confirmation",
  "first-month kickoff checklist",
  "14-day trial begins after RoofLeadHQ AI setup goes live",
  "PASS/HOLD/BLOCKED",
  "manual first-month operating"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 3. Inputs from Trial Conversion / Payment Handoff", [
  "FIRST_PAID_ROOFER_TRIAL_CONVERSION_PAYMENT_HANDOFF_KIT.md",
  "first monthly payment confirmation",
  "post-trial customer status"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 4. First-month kickoff checklist", [
  "First-month kickoff checklist",
  "First-Month Kickoff Tracker",
  "PASS/HOLD/BLOCKED"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 5. Paid customer status confirmation", [
  "Paid customer status confirmation",
  "PAYING — FIRST MONTH",
  "Paid Customer Status Tracker"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 6. Lead intake operating rhythm", [
  "Lead intake operating rhythm",
  "Lead Intake Operating Tracker",
  "manual review"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 7. Response and follow-up monitoring rhythm", [
  "Response and follow-up monitoring rhythm",
  "Response Follow-Up Monitoring Tracker",
  "manual only"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 8. Missed-lead recovery review rhythm", [
  "Missed-lead recovery review rhythm",
  "Missed-Lead Recovery Review Tracker",
  "manual recovery"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 9. Booked homeowner appointment tracking", [
  "Booked homeowner appointment tracking",
  "Booked Homeowner Appointment Tracker",
  "booked homeowner appointments"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 10. Weekly value report preparation", [
  "Weekly value report preparation",
  "Weekly Value Report Tracker",
  "approved public language"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 11. Roofer feedback and support review", [
  "Roofer feedback and support review",
  "Roofer Feedback Support Tracker",
  "manual channels only"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 12. Cancellation-risk and blocker review", [
  "Cancellation-risk and blocker review",
  "cancellation-risk",
  "Cancellation-Risk Register"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 13. First-month issue escalation register", [
...
assertSectionWithContent(doc, "## 15. Ongoing monthly operations handoff", [
  "Ongoing monthly operations handoff",
  "handoff artifact",
  "Launch System Packet"
], "first paid roofer first-month operating kit doc");

assertSectionWithContent(doc, "## 16. First-month PASS/HOLD/BLOCKED decision gate", [
...
assertSectionWithContent(doc, "### First-Month Kickoff Tracker", ["First-Month Kickoff Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Paid Customer Status Tracker", ["Paid Customer Status Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Lead Intake Operating Tracker", ["Lead Intake Operating Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Response Follow-Up Monitoring Tracker", ["Response Follow-Up Monitoring Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Missed-Lead Recovery Review Tracker", ["Missed-Lead Recovery Review Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Booked Homeowner Appointment Tracker", ["Booked Homeowner Appointment Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Weekly Value Report Tracker", ["Weekly Value Report Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### Roofer Feedback Support Tracker", ["Roofer Feedback Support Tracker"], "first paid roofer first-month operating kit doc");
assertSectionWithContent(doc, "### First-Month Success Review Tracker", ["First-Month Success Review Tracker"], "first paid roofer first-month operating kit doc");
...
for (const g of goodLanguage) {
  mustHave(doc, g, "first paid roofer first-month operating kit doc (customer-facing language)");
}
...
for (const f of forbiddenBusiness) {
  mustNotHave(docBeforeForbiddenList, f, "first paid roofer first-month operating kit doc (customer-facing / outside forbidden list section)");
}
...
// Confirm references to Trial Conversion / Payment Handoff (primary), Trial Reporting + Success Review, Trial Day One, Go-Live, Guided Setup, Launch System, Trial Direction Regression, Data Protection/Tenant Isolation
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_CONVERSION_PAYMENT_HANDOFF_KIT.md", "kit must reference Trial Conversion / Payment Handoff (primary input)");
...
console.log("PASS: required packet references present (Trial Conversion / Payment Handoff, Trial Reporting + Success Review, Trial Day One Operating Kit, Go-Live Readiness, Guided Setup, Launch System, Trial Direction Regression, Data Protection/Tenant Isolation).");

// Final self-reference confirmation
mustHave(doc, "This kit file: `docs/FIRST_PAID_ROOFER_FIRST_MONTH_OPERATING_KIT.md`", "kit doc must self-reference correctly");
