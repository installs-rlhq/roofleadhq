...
const SOURCE_OF_TRUTH_COMMIT = '0c6abaf';
...
const CORRECTED_FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_146_fresh_chain_wiring_correction';
const STALE_FUTURE_COMMAND_STATUS_141 =
...
const STALE_BUILD_142_NO_GO_MESSAGE =
...
const REQUIRED_ASSERTIONS = [
  ...
  'source_of_truth_commit_0c6abaf_referenced',
  ...
  'build_147_post_build_146_blocked_evidence_packet_referenced',
  'build_146_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_packet_referenced',
  'build_145_capture_after_build_144_build_141_fresh_chain_wiring_correction_packet_referenced',
  'build_144_fresh_decision_after_build_141_fresh_chain_wiring_correction_packet_referenced',
  'build_143_runner_execution_path_after_build_141_fresh_chain_wiring_correction_packet_referenced',
  'build_142_post_build_141_blocked_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'runner_execution_path_after_build_146_fresh_chain_wiring_gap_status_detected',
  'runner_execution_path_after_build_146_fresh_chain_wiring_correction_status_design_or_corrected_review_only',
  'prior_exact_command_attempt_after_build_146_status_attempted_blocked_nonzero',
  'prior_exact_command_exit_status_nonzero_blocked',
  'prior_command_attempt_consumption_status_consumed_by_blocked_after_build_146_guard',
  'runner_output_state_after_build_146_stale_removed',
  'runner_did_not_recognize_build_143_before_correction_documented',
  'runner_did_not_recognize_build_144_before_correction_documented',
  'runner_did_not_recognize_build_145_before_correction_documented',
  'runner_did_not_recognize_build_146_before_correction_documented',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_build_146_fresh_chain_wiring_correction_true',
  'fresh_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction_true',
  'fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_closed',
  'fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_captured_signed',
  'fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_passed',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_runner_execution_path_after_build_146_fresh_chain_wiring_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_146_fresh_chain_wiring_correction',
  'runner_command_path_exists',
  'runner_command_path_executable',
  'runner_command_corrected_blocked_state_language',
  'runner_command_recognizes_build_143_runner_execution_path_after_build_141_fresh_chain_wiring_correction',
  'runner_command_recognizes_build_144_fresh_decision',
  'runner_command_recognizes_build_145_approval_capture',
  'runner_command_recognizes_build_146_pre_run_guard',
  'runner_command_build_147_consumed_post_build_146_attempt',
  'runner_command_no_stale_future_command_status',
  'runner_command_no_stale_ready_future_command_status',
  'runner_command_no_stale_build_142_era_primary_no_go',
  ...
  'build_147_consumed_post_build_146_attempt_documented',
  'prior_build_143_144_145_146_chain_not_reusable_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_after_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-after-build-146-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-after-build-146-fresh-chain-wiring-correction-readonly.js',
  'runner-execution-path-after-build-146-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Runner Execution Path After Build 146 Fresh-Chain Wiring Correction',
  'native workflow fixture runner execution path after build 146 fresh chain wiring correction',
  'runner execution path after build 146 fresh chain wiring correction',
];
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-after-build-146-fresh-chain-wiring-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_0c6abaf_referenced');
...
passAssertion('prior_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_commit_f4c3069_referenced');
...
passAssertion('build_147_post_build_146_blocked_evidence_packet_referenced');
...
passAssertion('build_146_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_packet_referenced');
...
passAssertion('build_145_capture_after_build_144_build_141_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_144_fresh_decision_after_build_141_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_143_runner_execution_path_after_build_141_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('runner_execution_path_after_build_146_fresh_chain_wiring_gap_status_detected');
...
mustHave(packetDoc, 'prior_exact_command_attempt_after_build_146_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_exact_command_attempt_after_build_146_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_exact_command_attempt_after_build_146_status_attempted_blocked_nonzero');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_after_build_146_guard');
...
passAssertion('runner_output_state_after_build_146_stale_removed');

mustHave(
  packetDoc,
  'runner_did_not_recognize_build_143_after_build_141_fresh_chain_wiring_correction_status_before_correction | true',
  'packet doc',
);
mustHave(packetDoc, 'runner_did_not_recognize_build_144_fresh_decision_status_before_correction | true', 'packet doc');
mustHave(
  packetDoc,
  'runner_did_not_recognize_build_145_approval_capture_status_before_correction | true',
  'packet doc',
);
mustHave(
  packetDoc,
  'runner_did_not_recognize_build_146_pre_run_guard_status_before_correction | true',
  'packet doc',
);
passAssertion('runner_did_not_recognize_build_143_before_correction_documented');
passAssertion('runner_did_not_recognize_build_144_before_correction_documented');
passAssertion('runner_did_not_recognize_build_145_before_correction_documented');
passAssertion('runner_did_not_recognize_build_146_before_correction_documented');
...
passAssertion('fresh_decision_required_after_build_146_fresh_chain_wiring_correction_true');
...
passAssertion('fresh_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction_true');

mustHave(
  packetDoc,
  'fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_status | closed',
  'packet doc',
);
passAssertion('fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_closed');

mustHave(
  packetDoc,
  'fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_status | captured_signed',
  'packet doc',
);
passAssertion(
  'fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_captured_signed',
...
mustHave(
  packetDoc,
  'fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_status | passed',
  'packet doc',
);
passAssertion('fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_passed');
...
mustHave(
  packetDoc,
  'This packet corrects runner execution path after Build 146 fresh-chain wiring messaging/design **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'Build 147 consumed the post-Build-146 exact approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_147_consumed_post_build_146_attempt_documented');

mustHave(
  packetDoc,
  'prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_146_blocked_evidence | false',
  'packet doc',
);
passAssertion('prior_build_143_144_145_146_chain_not_reusable_documented');
...
if (fixture.prior_post_build_146_blocked_evidence_status !== 'closed') {
  fail('fixture prior_post_build_146_blocked_evidence_status mismatch');
}
if (fixture.runner_execution_path_after_build_146_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_build_146_fresh_chain_wiring_gap_status mismatch');
}
if (
  fixture.runner_execution_path_after_build_146_fresh_chain_wiring_correction_status !==
  'design_or_corrected_review_only'
) {
  fail('fixture runner_execution_path_after_build_146_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.prior_exact_command_attempt_after_build_146_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_exact_command_attempt_after_build_146_status mismatch');
}
...
if (fixture.fresh_decision_required_after_build_146_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_decision_required_after_build_146_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction must be true');
}
if (
  fixture.fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_status !== 'closed'
) {
  fail('fixture fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_status mismatch');
}
if (
  fixture.fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_status !==
  'captured_signed'
) {
  fail(
    'fixture fresh_runner_execution_approval_capture_after_build_144_build_141_fresh_chain_wiring_correction_status mismatch',
  );
}
if (
  fixture.fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_status !== 'passed'
) {
  fail('fixture fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_status mismatch');
}
...
mustHave(
  runnerScript,
  'runner_execution_path_after_build_141_fresh_chain_wiring_correction_status: design_or_corrected_review_only (Build 143)',
  'runner script',
);
mustHave(
  runnerScript,
...
mustHave(
  runnerScript,
  'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_146_guard (Build 147)',
  'runner script',
);
mustHave(
  runnerScript,
...
passAssertion('runner_command_recognizes_build_143_runner_execution_path_after_build_141_fresh_chain_wiring_correction');
passAssertion('runner_command_recognizes_build_144_fresh_decision');
passAssertion('runner_command_recognizes_build_145_approval_capture');
passAssertion('runner_command_recognizes_build_146_pre_run_guard');
passAssertion('runner_command_build_147_consumed_post_build_146_attempt');

mustNotHave(runnerScript, `future_command_status: ${STALE_FUTURE_COMMAND_STATUS_141}`, 'runner script');
mustNotHave(runnerScript, STALE_READY_FUTURE_COMMAND_STATUS, 'runner script');
mustNotHave(runnerScript, STALE_BUILD_142_NO_GO_MESSAGE, 'runner script');
...
passAssertion('runner_command_no_stale_build_142_era_primary_no_go');
...
mustHave(
  wrapper,
  'local runner execution path after Build 146 fresh-chain wiring correction only',
  'wrapper mode',
);
...
mustHave(wrapper, 'Build 147', 'wrapper Build 147');
...
mustHave(
  wrapper,
  'runner_execution_path_after_build_146_fresh_chain_wiring_gap_status is detected',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_execution_path_after_build_146_fresh_chain_wiring_correction_status is design_or_corrected_review_only',
  'wrapper mode',
);
mustHave(
  wrapper,
  'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_146_guard',
  'wrapper mode',
);
...
mustHave(
  wrapper,
  'fresh runner-execution decision and fresh execution pre-run guard after Build 146 fresh-chain wiring correction',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `runner execution path after Build 146 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion(
  'runner_execution_path_after_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
console.log(
  `PASS: Native Workflow Fixture Runner Execution Path After Build 146 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
