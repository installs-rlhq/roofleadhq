...
const freshPreRunGuardAfterAfterAllGuardWiringCorrectionDocPath =
...
const upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = 'e3a576a';
...
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_ALL_GUARD_WIRING_CORRECTION_COMMIT = '4597948';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_ALL_GUARD_WIRING_CORRECTION_COMMIT = '68c220d';
...
const FRESH_RUNNER_EXECUTION_CAPTURE_CHECKS = [
  'Build 129 fresh runner-execution decision after after-after-after-guard fresh-chain wiring correction packet referenced upstream and closed at e3a576a',
  'Build 128 runner execution path after-after-after-guard fresh-chain wiring correction and Build 127 blocked command evidence referenced',
  'runner command path exists executable and corrected fail-closed pending fresh execution pre-run guard after after-after-after-guard fresh-chain wiring correction approval capture',
  ...
  'future_command_status blocked until fresh execution pre-run guard passes after after-after-after-guard fresh-chain wiring correction approval capture',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, approve the fresh runner-execution approval capture after after-after-after-guard fresh-chain wiring correction for RoofLeadHQ.',
  'Scope approved:',
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  '30',
  'I approve only a scoped sandbox/test-mode runner-execution approval capture packet after the Build 128 after-after-after-guard fresh-chain wiring correction and Build 129 fresh decision/template packet.',
  ...
  'I understand Build 127 consumed the prior post-Build-126 attempt and no prior approval/guard chain is reusable.',
  'Signed: Jason Lohse',
  'Date/time: 06/20/2026 2:17pm MST',
];

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_e3a576a_referenced',
  ...
  'prior_runner_execution_path_after_after_after_after_guard_fresh_chain_wiring_correction_commit_59b74bf_referenced',
  ...
  'build_128_runner_execution_path_after_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  ...
  'future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture',
  ...
  'upstream_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  ...
  'fresh_runner_execution_approval_capture_after_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION.md',
  'run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-after-after-after-guard-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-after-after-after-guard-fresh-chain-wiring-correction-readonly.js',
  'capture-fresh-runner-execution-approval-after-after-after-after-guard-fresh-chain-wiring-correction.json',
  ...
  'native workflow fixture capture fresh runner execution approval after after after after guard fresh chain wiring correction',
  'capture fresh runner execution approval after after after after guard fresh chain wiring correction',
];
...
read(freshPreRunGuardAfterAfterAllGuardWiringCorrectionDocPath);
...
passAssertion('source_of_truth_commit_e3a576a_referenced');
...
passAssertion('prior_runner_execution_path_after_after_after_after_guard_fresh_chain_wiring_correction_commit_59b74bf_referenced');
...
mustHave(packetDoc, upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath, 'packet doc');
...
passAssertion('build_128_runner_execution_path_after_after_after_after_guard_fresh_chain_wiring_correction_referenced');
...
mustHave(packetDoc, freshPreRunGuardAfterAfterAllGuardWiringCorrectionDocPath, 'packet doc');
...
mustHave(packetDoc, 'fresh_runner_execution_scope_approved | fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction', 'packet doc');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_after_after_after_guard_fresh_chain_wiring_correction');
...
passAssertion('future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture');
...
mustHave(
  packetDoc,
  'This packet captures fresh runner-execution approval after after-after-after-guard fresh-chain wiring correction **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'fresh execution pre-run guard pass after after-after-after-guard fresh-chain wiring correction approval capture**, not execution', 'packet doc');
...
for (const upstreamFixturePath of [
  upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamAfterAfterAllGuardFreshChainWiringCorrectionFixturePath,
  upstreamPostBuild126BlockedEvidenceFixturePath,
  upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath,
  upstreamCaptureAfterAfterAllGuardWiringCorrectionFixturePath,
...
const upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamAfterAfterAllGuardFreshChainFixture = readJson(upstreamAfterAfterAllGuardFreshChainWiringCorrectionFixturePath);
const upstreamPostBuild126BlockedEvidenceFixture = readJson(upstreamPostBuild126BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterAfterAllGuardFixture = readJson(upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath);
const upstreamCaptureAfterAfterAllGuardFixture = readJson(upstreamCaptureAfterAfterAllGuardWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be e3a576a');
}
if (
...
if (fixture.prior_post_build_126_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_126_guard') {
...
if (
  upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
    'upstream fresh decision after after-after-after-guard fresh-chain wiring correction fixture fresh_runner_execution_decision_template_status must be created_review_only',
  );
}
if (
  upstreamFreshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !==
  'not_captured'
) {
  fail(
    'upstream fresh decision after after-after-after-guard fresh-chain wiring correction fixture fresh_runner_execution_approval_capture_status must be not_captured (prior to this capture packet)',
  );
}

if (!upstreamAfterAfterAllGuardFreshChainFixture.packet_name) {
  fail('upstream after-after-all-guard fresh-chain wiring correction fixture must exist with packet_name');
}
...
if (!upstreamFreshPreRunGuardAfterAfterAllGuardFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterAfterAllGuardFixture.packet_name) {
...
mustHave(wrapper, 'local fresh runner-execution approval capture after after-after-after-guard fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(
  wrapper,
  'future_command_status is blocked_until_fresh_execution_pre_run_guard_passes_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh runner-execution approval capture after after-after-after-guard fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_runner_execution_approval_capture_after_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner-Execution Approval After After-After-After-Guard Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
