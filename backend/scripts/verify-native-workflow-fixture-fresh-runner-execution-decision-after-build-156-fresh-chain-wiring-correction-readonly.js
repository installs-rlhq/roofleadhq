...
const packetDocPath = 'docs/NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_156_FRESH_CHAIN_WIRING_CORRECTION.md';
const fixturePath = 'backend/fixtures/native-workflow-demo-roofer/fresh-runner-execution-decision-after-build-156-fresh-chain-wiring-correction.json';
const wrapperPath = 'scripts/run-native-workflow-fixture-fresh-runner-execution-decision-after-build-156-fresh-chain-wiring-correction-dry-run.sh';
...
mustHave(doc, 'Native Workflow Fixture Fresh Runner Execution Decision After Build 156 Fresh Chain Wiring Correction', 'packet doc');
mustHave(doc, 'source_of_truth_commit | 28b6413', 'packet doc');
mustHave(doc, 'fresh_runner_execution_decision_template_gate_decision | NO_GO', 'packet doc');
mustHave(doc, 'does **not** capture Jason', 'packet doc');
mustHave(doc, 'does **not** rerun the runner', 'packet doc');
mustHave(doc, 'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_156_fresh_chain_wiring_correction', 'packet doc');
mustHave(doc, 'Actual 30-scenario external/sandbox validation remains', 'packet doc');

expectEq(fixture, 'source_of_truth_commit', '28b6413');
expectEq(fixture, 'prior_runner_execution_path_after_build_156_fresh_chain_wiring_correction_commit', '28b6413');
expectEq(fixture, 'prior_post_build_156_blocked_evidence_commit', '5dde6ce');
expectEq(fixture, 'prior_fresh_execution_pre_run_guard_after_build_154_build_151_fresh_chain_wiring_correction_approval_capture_commit', '634d258');
...
expectEq(fixture, 'fresh_runner_execution_decision_template_status', 'created_review_only');
expectEq(fixture, 'fresh_runner_execution_decision_template_gate_decision', 'NO_GO');
expectEq(fixture, 'runner_command_path_status', 'corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_156_fresh_chain_wiring_correction');
expectEq(fixture, 'approval_scope', 'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_156_fresh_chain_wiring_correction');
...
expectEq(fixture, 'total_manifest_scenarios_count', 30);
expectEq(fixture, 'all_manifest_scenarios_execution_status', 'not_run');
expectEq(fixture, 'all_manifest_scenarios_pass_fail_status', 'not_captured');
expectEq(fixture, 'fresh_runner_execution_approval_capture_status', 'not_captured');
expectEq(fixture, 'fresh_runner_execution_jason_signed_approval_status', 'not_signed');
expectEq(fixture, 'fresh_runner_execution_exact_values_required_count', 24);
expectEq(fixture, 'fresh_runner_execution_exact_values_accepted_count', 0);
expectEq(fixture, 'fresh_runner_execution_exact_values_approved_count', 0);
expectEq(fixture, 'fresh_runner_execution_approval_status', 'not_granted');
expectEq(fixture, 'fresh_execution_pre_run_guard_status', 'not_passed');
expectEq(fixture, 'fresh_execution_pre_run_guard_checks_required_count', 30);
expectEq(fixture, 'fresh_execution_pre_run_guard_checks_passed_count', 0);
expectEq(fixture, 'fresh_execution_pre_run_guard_next_packet_required', true);
expectEq(fixture, 'external_sandbox_calls_approval_status', 'not_granted_by_this_packet');
expectEq(fixture, 'credentials_access_approval_status', 'not_granted_by_this_packet');
expectEq(fixture, 'test_account_use_approval_status', 'not_granted_by_this_packet');
...
expectEq(fixture, 'future_command_status', 'blocked_until_fresh_runner_execution_approval_captured_after_build_156_fresh_chain_wiring_correction');
...
expectEq(fixture, 'prior_command_attempt_consumption_status', 'consumed_by_blocked_fail_closed_result_after_build_156_guard');
expectEq(fixture, 'prior_build_157_consumed_attempt_status', 'consumed');
expectEq(fixture, 'fresh_runner_execution_approval_required_after_build_156_fresh_chain_wiring_correction', true);
expectEq(fixture, 'fresh_execution_pre_run_guard_required_after_build_156_fresh_chain_wiring_correction', true);
expectEq(fixture, 'prior_fresh_runner_execution_approval_reusable_after_build_156_fresh_chain_wiring_correction', false);
expectEq(fixture, 'prior_fresh_execution_pre_run_guard_reusable_after_build_156_fresh_chain_wiring_correction', false);
...
mustHave(wrapper, 'node backend/scripts/verify-native-workflow-fixture-fresh-runner-execution-decision-after-build-156-fresh-chain-wiring-correction-readonly.js', 'wrapper');

for (const text of [aggregate, index, contextFirstPaid, contextAgent, guide, safeReadiness]) {
  if (!text.includes('Native Workflow Fixture Fresh Runner Execution Decision After Build 156 Fresh Chain Wiring Correction') || !text.includes('native workflow fixture fresh runner execution decision after build 156 fresh chain wiring correction')) {
...
console.log('PASS: Native Workflow Fixture Fresh Runner Execution Decision After Build 156 Fresh Chain Wiring Correction verified (' + passCount + ' assertions).');
