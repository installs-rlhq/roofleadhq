...
const postBuild131BlockedEvidencePacketDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_131_RUNNER_COMMAND_BLOCKED_EVIDENCE.md';
const freshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionPacketDocPath =
...
const SOURCE_OF_TRUTH_COMMIT = '9b736c0';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_134_COMMIT = '9b736c0';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'a07dda6';
...
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 3:09pm MST';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: 'a07dda6',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_134_after_after_after_after_guard_fresh_chain_wiring_correction',
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_9b736c0',
  'build_135_approval_capture_is_closed',
  'fresh_signed_approval_after_build_134_after_after_after_after_guard_fresh_chain_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_build_134_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'prior_build_128_129_130_131_decision_approval_guard_chain_not_reusable',
  'build_132_consumed_prior_post_build_131_attempt',
  'build_133_after_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  'build_134_fresh_decision_template_referenced',
  'build_135_approval_capture_referenced',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_9b736c0_referenced',
  ...
  'prior_post_build_131_blocked_evidence_commit_0e7db2d_referenced',
  ...
  'build_131_fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  'build_130_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  ...
  'prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_131_guard',
  ...
  'prior_build_128_129_130_131_decision_approval_guard_chain_reusable_after_build_132_133_false',
  ...
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_134_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'packet_does_not_treat_prior_build_128_129_130_131_approvals_guard_chain_as_reusable',
  ...
  'upstream_fresh_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  'upstream_capture_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_134_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-134-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-134-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-build-134-approval-capture.json',
  'Native Workflow Fixture Fresh Execution Pre-Run Guard After Build 134 Approval Capture',
  'native workflow fixture fresh execution pre run guard after build 134 approval capture',
  'fresh execution pre run guard after build 134 approval capture',
];

const UPSTREAM_CAPTURE_EXACT_VALUE_GUARD_EVOLVED_FIELDS = [
  'fresh_runner_execution_approval_status',
  'external_sandbox_calls_approval_status',
  'credentials_access_approval_status',
  'test_account_use_approval_status',
...
read(postBuild131BlockedEvidencePacketDocPath);
read(freshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_9b736c0_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_134_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_build_134_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_build_134_commit_9b736c0_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_build_134_status_closed');

mustHave(packetDoc, captureAfterBuild134PacketDocPath, 'packet doc');
mustHave(packetDoc, 'Build 135', 'packet doc');
passAssertion('build_135_capture_fresh_runner_execution_approval_after_build_134_packet_referenced');
passAssertion('build_135_approval_capture_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit_a07dda6_referenced');
...
passAssertion('build_134_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced');
...
mustHave(packetDoc, postBuild131BlockedEvidencePacketDocPath, 'packet doc');
...
mustHave(packetDoc, freshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionPacketDocPath, 'packet doc');
...
passAssertion('build_131_fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_referenced');
...
passAssertion('build_130_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_referenced');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_131_guard');
...
mustHave(
  packetDoc,
  'This is the **fresh execution pre-run guard only** after Build 134 approval capture.',
  'packet doc',
);
...
mustHave(packetDoc, 'exact approved runner execution command after Build 134 after-after-after-after-guard fresh-chain wiring correction guard review', 'packet doc');
...
mustHave(packetDoc, 'This packet does **not** treat prior Build 128/129/130/131 approvals/guard chain as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_128_129_130_131_approvals_guard_chain_as_reusable');
...
for (const upstreamFixturePath of [
  upstreamCaptureAfterBuild134FixturePath,
  upstreamFreshDecisionAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamPostBuild131BlockedEvidenceFixturePath,
  upstreamFreshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamCaptureAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
...
passAssertion('upstream_capture_after_build_134_fixture_present');
passAssertion('upstream_fresh_decision_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_post_build_131_blocked_evidence_fixture_present');
passAssertion('upstream_fresh_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
...
const upstreamCaptureAfterBuild134Fixture = readJson(upstreamCaptureAfterBuild134FixturePath);
const upstreamFreshDecisionAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamPostBuild131BlockedEvidenceFixture = readJson(upstreamPostBuild131BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamFreshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamCaptureAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamCaptureAfterAfterAllAfterGuardFreshChainWiringCorrectionFixturePath,
);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 9b736c0');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_build_134_commit !==
...
if (fixture.prior_capture_fresh_runner_execution_approval_after_build_134_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_build_134_status must be closed');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit must be a07dda6');
}
...
if (
  ...
  fail('fixture prior_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result_after_build_131_guard');
}
...
if (fixture.prior_build_132_consumed_attempt_status !== 'consumed') {
  fail('fixture prior_build_132_consumed_attempt_status must be consumed');
}
...
for (const field of EXACT_VALUE_FIELDS) {
  const upstreamAccepted = upstreamCaptureAfterBuild134Fixture.accepted_exact_values[field];
  const upstreamApproved = upstreamCaptureAfterBuild134Fixture.approved_exact_values[field];
  if (upstreamAccepted !== upstreamApproved) {
    fail(
      `upstream capture after build 134 fixture accepted_exact_values.${field} must match approved_exact_values`,
    );
  }
  if (UPSTREAM_CAPTURE_EXACT_VALUE_GUARD_EVOLVED_FIELDS.includes(field)) {
    continue;
  }
  if (upstreamAccepted !== APPROVED_EXACT_VALUES[field]) {
    fail(`upstream capture after build 134 fixture accepted_exact_values.${field} mismatch`);
  }
}
...
if (upstreamCaptureAfterBuild134Fixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after build 134 fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureAfterBuild134Fixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
  fail('upstream capture after build 134 fixture fresh_execution_pre_run_guard_status must be not_passed_by_this_packet');
}
if (
  upstreamCaptureAfterBuild134Fixture.future_command_status !==
  'blocked_until_fresh_execution_pre_run_guard_passes_after_build_134_after_after_all_after_guard_fresh_chain_wiring_correction_approval_capture'
) {
  fail('upstream capture after build 134 fixture future_command_status mismatch');
}

if (
  upstreamFreshDecisionAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
...
if (!upstreamAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture.packet_name) {
  fail('upstream path correction fixture must exist with packet_name');
}

if (!upstreamPostBuild131BlockedEvidenceFixture.packet_name) {
  fail('upstream blocked evidence fixture must exist with packet_name');
}

if (!upstreamFreshPreRunGuardAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterAfterAllAfterGuardFreshChainWiringCorrectionFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after Build 134 approval capture only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_ALL_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 133');
mustHave(wrapper, PRIOR_POST_BUILD_131_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 132');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_build_134_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after Build 134 after-after-after-after-guard fresh-chain wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
passAssertion('fresh_execution_pre_run_guard_after_build_134_approval_capture_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After Build 134 Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
