...
const SOURCE_OF_TRUTH_COMMIT = '5e78db0';
...
const STALE_BUILD_117_NO_GO_MESSAGE =
  'Build 117 consumed the post-Build-116 exact approved command attempt';
...
const REQUIRED_ASSERTIONS = [
  ...
  'source_of_truth_commit_5e78db0_referenced',
  'prior_post_build_121_blocked_evidence_commit_5e78db0_referenced',
  'prior_post_build_121_blocked_evidence_status_closed',
  'prior_fresh_execution_pre_run_guard_after_after_guard_wiring_correction_commit_7cb5222_referenced',
  'prior_capture_after_after_guard_wiring_correction_commit_203c0af_referenced',
  'prior_fresh_decision_after_after_guard_wiring_correction_commit_3b7719b_referenced',
  ...
  'build_121_fresh_pre_run_guard_after_after_guard_wiring_correction_packet_referenced',
  'build_120_capture_after_after_guard_wiring_correction_packet_referenced',
  'build_119_fresh_decision_after_after_guard_wiring_correction_packet_referenced',
  ...
  'runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status_detected',
  'runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status_design_or_corrected_review_only',
  'prior_exact_command_attempt_after_build_121_status_attempted_blocked_nonzero',
  'prior_exact_command_exit_status_nonzero_blocked',
  'prior_command_attempt_consumption_status_consumed_by_blocked_after_build_121_guard',
  'runner_output_state_after_build_121_stale_removed',
  'runner_did_not_recognize_build_118_before_correction_documented',
  'runner_did_not_recognize_build_119_before_correction_documented',
  'runner_did_not_recognize_build_120_before_correction_documented',
  'runner_did_not_recognize_build_121_before_correction_documented',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_after_guard_fresh_chain_wiring_correction_true',
  'fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction_true',
  'fresh_runner_execution_decision_after_after_guard_wiring_correction_closed',
  'fresh_runner_execution_approval_capture_after_after_guard_wiring_correction_captured_signed',
  'fresh_execution_pre_run_guard_after_after_guard_wiring_correction_passed',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_after_after_guard_fresh_chain_wiring_correction_fresh_decision_and_fresh_guard',
  'runner_command_path_exists',
  'runner_command_path_executable',
  'runner_command_corrected_blocked_state_language',
  'runner_command_recognizes_build_118_after_guard_wiring_correction',
  'runner_command_recognizes_build_119_fresh_decision',
  'runner_command_recognizes_build_120_approval_capture',
  'runner_command_recognizes_build_121_pre_run_guard',
  'runner_command_build_122_consumed_post_build_121_attempt',
  'runner_command_no_stale_future_command_status',
  'runner_command_no_stale_ready_future_command_status',
  'runner_command_no_stale_build_117_era_primary_no_go',
  ...
  'build_122_consumed_post_build_121_attempt_documented',
  'prior_build_119_120_121_chain_not_reusable_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-after-after-guard-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-after-after-guard-fresh-chain-wiring-correction-readonly.js',
  'runner-execution-path-after-after-guard-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Runner Execution Path After-After-Guard Fresh-Chain Wiring Correction',
  'native workflow fixture runner execution path after after guard fresh chain wiring correction',
  'runner execution path after after guard fresh chain wiring correction',
];
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-after-after-guard-fresh-chain-wiring-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_5e78db0_referenced');

mustHave(packetDoc, PRIOR_POST_BUILD_121_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_post_build_121_blocked_evidence_status | closed', 'packet doc');
passAssertion('prior_post_build_121_blocked_evidence_commit_5e78db0_referenced');
passAssertion('prior_post_build_121_blocked_evidence_status_closed');

mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_execution_pre_run_guard_after_after_guard_wiring_correction_commit_7cb5222_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_capture_after_after_guard_wiring_correction_commit_203c0af_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_decision_after_after_guard_wiring_correction_commit_3b7719b_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_GUARD_WIRING_CORRECTION_COMMIT, 'no-go review');
...
passAssertion('build_121_fresh_pre_run_guard_after_after_guard_wiring_correction_packet_referenced');
...
passAssertion('build_120_capture_after_after_guard_wiring_correction_packet_referenced');
...
passAssertion('build_119_fresh_decision_after_after_guard_wiring_correction_packet_referenced');
...
mustHave(packetDoc, 'runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status | detected', 'packet doc');
mustHave(noGoReviewDoc, 'runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status | detected', 'no-go review');
passAssertion('runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status_detected');

mustHave(
  packetDoc,
  'runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status | design_or_corrected_review_only',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status_design_or_corrected_review_only');

mustHave(packetDoc, 'prior_exact_command_attempt_after_build_121_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_exact_command_attempt_after_build_121_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_exact_command_attempt_after_build_121_status_attempted_blocked_nonzero');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_after_build_121_guard');

mustHave(packetDoc, 'runner_output_state_after_build_121_status | stale_pre_build_118_119_120_121_state_detected', 'packet doc');
passAssertion('runner_output_state_after_build_121_stale_removed');

mustHave(packetDoc, 'runner_did_not_recognize_build_118_after_guard_wiring_correction_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_119_fresh_decision_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_120_approval_capture_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_121_pre_run_guard_status_before_correction | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_118_before_correction_documented');
passAssertion('runner_did_not_recognize_build_119_before_correction_documented');
passAssertion('runner_did_not_recognize_build_120_before_correction_documented');
passAssertion('runner_did_not_recognize_build_121_before_correction_documented');
...
mustHave(packetDoc, 'fresh_decision_required_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_decision_required_after_after_guard_fresh_chain_wiring_correction | true', 'no-go review');
passAssertion('fresh_decision_required_after_after_guard_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction | true', 'no-go review');
passAssertion('fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_runner_execution_decision_after_after_guard_wiring_correction_status | closed', 'packet doc');
passAssertion('fresh_runner_execution_decision_after_after_guard_wiring_correction_closed');

mustHave(packetDoc, 'fresh_runner_execution_approval_capture_after_after_guard_wiring_correction_status | captured_signed', 'packet doc');
passAssertion('fresh_runner_execution_approval_capture_after_after_guard_wiring_correction_captured_signed');

mustHave(packetDoc, 'fresh_execution_pre_run_guard_after_after_guard_wiring_correction_status | passed', 'packet doc');
passAssertion('fresh_execution_pre_run_guard_after_after_guard_wiring_correction_passed');
...
passAssertion('incoming_future_command_status_blocked_until_runner_execution_path_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision');
...
passAssertion('corrected_future_command_status_blocked_until_after_after_guard_fresh_chain_wiring_correction_fresh_decision_and_fresh_guard');
...
mustHave(
  packetDoc,
  'This packet corrects runner execution path after-after-guard fresh-chain wiring messaging/design **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'Build 122 consumed the post-Build-121 exact approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_122_consumed_post_build_121_attempt_documented');

mustHave(
  packetDoc,
  'prior_build_119_120_121_decision_approval_guard_chain_reusable_after_build_122_blocked_evidence | false',
  'packet doc',
);
passAssertion('prior_build_119_120_121_chain_not_reusable_documented');
...
readJson(upstreamFreshPreRunGuardAfterAfterGuardWiringCorrectionFixturePath);
readJson(upstreamCaptureAfterAfterGuardWiringCorrectionFixturePath);
readJson(upstreamFreshDecisionAfterAfterGuardWiringCorrectionFixturePath);
...
if (fixture.prior_post_build_121_blocked_evidence_status !== 'closed') {
  fail('fixture prior_post_build_121_blocked_evidence_status mismatch');
}
if (fixture.runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_after_guard_fresh_chain_wiring_gap_status mismatch');
}
if (
  fixture.runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status !==
  'design_or_corrected_review_only'
) {
  fail('fixture runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.prior_exact_command_attempt_after_build_121_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_exact_command_attempt_after_build_121_status mismatch');
}
...
if (fixture.fresh_decision_required_after_after_guard_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_decision_required_after_after_guard_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_runner_execution_decision_after_after_guard_wiring_correction_status !== 'closed') {
  fail('fixture fresh_runner_execution_decision_after_after_guard_wiring_correction_status mismatch');
}
if (fixture.fresh_runner_execution_approval_capture_after_after_guard_wiring_correction_status !== 'captured_signed') {
  fail('fixture fresh_runner_execution_approval_capture_after_after_guard_wiring_correction_status mismatch');
}
if (fixture.fresh_execution_pre_run_guard_after_after_guard_wiring_correction_status !== 'passed') {
  fail('fixture fresh_execution_pre_run_guard_after_after_guard_wiring_correction_status mismatch');
}
...
mustHave(
  runnerScript,
  'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_121_guard (Build 122)',
  'runner script',
);
mustHave(
  runnerScript,
...
mustHave(runnerScript, 'fresh_decision_required_after_after_guard_fresh_chain_wiring_correction: true', 'runner script');
mustHave(runnerScript, 'fresh_pre_run_guard_required_after_after_guard_fresh_chain_wiring_correction: true', 'runner script');
...
passAssertion('runner_command_recognizes_build_118_after_guard_wiring_correction');
passAssertion('runner_command_recognizes_build_119_fresh_decision');
passAssertion('runner_command_recognizes_build_120_approval_capture');
passAssertion('runner_command_recognizes_build_121_pre_run_guard');
passAssertion('runner_command_build_122_consumed_post_build_121_attempt');
...
mustNotHave(runnerScript, STALE_BUILD_117_NO_GO_MESSAGE, 'runner script');
...
passAssertion('runner_command_no_stale_build_117_era_primary_no_go');
...
mustHave(wrapper, 'local runner execution path after-after-guard fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'Build 122', 'wrapper Build 122');
...
mustHave(
  wrapper,
  'runner_execution_path_after_after_guard_fresh_chain_wiring_correction_status is design_or_corrected_review_only',
  'wrapper mode',
);
mustHave(
  wrapper,
  'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_121_guard',
  'wrapper mode',
);
...
mustHave(wrapper, 'Build 122 consumed the post-Build-121 attempt', 'wrapper mode');
mustHave(
  wrapper,
  'fresh runner-execution decision and fresh execution pre-run guard after after-after-guard fresh-chain wiring correction',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `runner execution path after-after-guard fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('runner_execution_path_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Runner Execution Path After-After-Guard Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
