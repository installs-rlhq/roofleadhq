...
const freshDecisionAfterBuild146FreshChainWiringCorrectionDocPath =
...
const runnerExecutionPathAfterBuild146FreshChainWiringCorrectionPacketDocPath =
...
const upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixturePath =
...
const upstreamRunnerExecutionPathAfterBuild146FreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = 'df9fee3';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'df9fee3';
...
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 8:25pm MST';
const SIGNED_APPROVAL_CAPTURE_SOURCE = 'chat';
const APPROVAL_SCOPE =
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction';
const RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture';
const FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_execution_pre_run_guard_passes_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: 'df9fee3',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction',
...
const FRESH_RUNNER_EXECUTION_CAPTURE_CHECKS = [
  'Build 149 fresh runner-execution decision after Build 146 fresh-chain wiring correction packet referenced upstream and closed at df9fee3',
  'Build 148 runner execution path after Build 146 fresh-chain wiring correction and Build 147 blocked command evidence referenced',
  'runner command path exists executable and corrected fail-closed pending fresh execution pre-run guard after Build 149 Build 146 fresh-chain wiring correction approval capture',
  ...
  'future_command_status blocked until fresh execution pre-run guard passes after Build 149 Build 146 fresh-chain wiring correction approval capture',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, approve the fresh runner-execution approval capture after Build 146 fresh-chain wiring correction for RoofLeadHQ.',
  'Scope approved:',
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction',
  ...
  '30',
  'I approve only a scoped sandbox/test-mode runner-execution approval capture packet after the Build 148 runner execution path after Build 146 fresh-chain wiring correction and Build 149 fresh decision/template packet.',
  ...
  'I understand Build 147 consumed the prior post-Build-146 attempt and no prior approval/guard chain is reusable.',
  'Signed: Jason Lohse',
  'Date/time: 06/20/2026 8:25pm MST',
];

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_df9fee3_referenced',
  'prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_commit_df9fee3_referenced',
  'prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_status_closed',
  ...
  'prior_post_build_146_blocked_evidence_status_closed',
  ...
  'build_144_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_packet_referenced',
  'build_143_runner_execution_path_after_build_146_fresh_chain_wiring_correction_referenced',
  'build_142_post_build_146_blocked_evidence_referenced',
  ...
  'approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction',
  ...
  'prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_146_guard',
  ...
  'prior_fresh_runner_execution_approval_reusable_after_build_146_fresh_chain_wiring_correction_false',
  'prior_fresh_execution_pre_run_guard_reusable_after_build_146_fresh_chain_wiring_correction_false',
  'prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence_false',
  'runner_scaffolding_build_status_built_review_only',
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture',
  'runner_fail_closed_sanity_check_status_blocked_exit_code_1',
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction',
  ...
  'future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture',
  ...
  'packet_does_not_treat_prior_build_143_144_145_146_approvals_guard_chain_as_reusable',
  ...
  'upstream_fresh_decision_after_build_146_fresh_chain_wiring_correction_fixture_present',
  ...
  'fresh_runner_execution_approval_capture_after_build_149_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_149_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION.md',
  'run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-149-build-146-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-149-build-146-fresh-chain-wiring-correction-readonly.js',
  'capture-fresh-runner-execution-approval-after-build-149-build-146-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 149 Build 146 Fresh-Chain Wiring Correction',
  'native workflow fixture capture fresh runner execution approval after build 149 build 146 fresh chain wiring correction',
  'capture fresh runner execution approval after build 149 build 146 fresh chain wiring correction',
];
...
read(freshDecisionAfterBuild146FreshChainWiringCorrectionDocPath);
read(approvalTemplateDocPath);
read(runnerExecutionPathAfterBuild146FreshChainWiringCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_df9fee3_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_commit_df9fee3_referenced');

mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_status_closed');
...
mustHave(packetDoc, 'prior_post_build_146_blocked_evidence_status | closed', 'packet doc');
passAssertion('prior_post_build_146_blocked_evidence_status_closed');
...
mustHave(packetDoc, freshDecisionAfterBuild146FreshChainWiringCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 149', 'packet doc');
passAssertion('build_144_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_packet_referenced');

mustHave(packetDoc, runnerExecutionPathAfterBuild146FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamRunnerExecutionPathAfterBuild146FreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 148', 'packet doc');
passAssertion('build_143_runner_execution_path_after_build_146_fresh_chain_wiring_correction_referenced');
...
passAssertion('build_142_post_build_146_blocked_evidence_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_146_guard');
...
mustHave(packetDoc, 'fresh_runner_execution_scope_approved | fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction', 'packet doc');
...
passAssertion('prior_fresh_runner_execution_approval_reusable_after_build_146_fresh_chain_wiring_correction_false');
passAssertion('prior_fresh_execution_pre_run_guard_reusable_after_build_146_fresh_chain_wiring_correction_false');
passAssertion('prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture');
...
passAssertion('future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture');
...
mustHave(
  packetDoc,
  'This packet captures fresh runner-execution approval after Build 149 Build 146 fresh-chain wiring correction **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'This packet does **not** treat prior Build 138/139/140/141 approvals/guard chain as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_143_144_145_146_approvals_guard_chain_as_reusable');
mustHave(packetDoc, 'fresh execution pre-run guard pass after Build 149 Build 146 fresh-chain wiring correction approval capture**, not execution', 'packet doc');
...
for (const upstreamFixturePath of [
  upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixturePath,
  upstreamRunnerExecutionPathAfterBuild146FreshChainWiringCorrectionFixturePath,
  upstreamPostBuild146BlockedEvidenceFixturePath,
...
passAssertion('upstream_fresh_decision_after_build_146_fresh_chain_wiring_correction_fixture_present');
...
const upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixturePath,
);
const upstreamRunnerExecutionPathAfterBuild136Fixture = readJson(
  upstreamRunnerExecutionPathAfterBuild146FreshChainWiringCorrectionFixturePath,
);
const upstreamPostBuild146BlockedEvidenceFixture = readJson(upstreamPostBuild146BlockedEvidenceFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be df9fee3');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_commit must be df9fee3');
}
if (fixture.prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_status must be closed');
}
...
if (fixture.prior_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_146_guard') {
  fail('fixture prior_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result_after_build_146_guard');
}
if (fixture.prior_build_147_consumed_attempt_status !== 'consumed') {
  fail('fixture prior_build_147_consumed_attempt_status must be consumed');
}
...
if (
  upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
    'upstream fresh decision after Build 146 fresh-chain wiring correction fixture fresh_runner_execution_decision_template_status must be created_review_only',
  );
}
if (
  upstreamFreshDecisionAfterBuild146FreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !==
  'not_captured'
) {
  fail(
    'upstream fresh decision after Build 146 fresh-chain wiring correction fixture fresh_runner_execution_approval_capture_status must be not_captured (prior to this capture packet)',
  );
}

if (!upstreamRunnerExecutionPathAfterBuild136Fixture.packet_name) {
  fail('upstream runner execution path after Build 146 fresh-chain wiring correction fixture must exist with packet_name');
}

if (!upstreamPostBuild146BlockedEvidenceFixture.packet_name) {
...
mustHave(wrapper, 'local fresh runner-execution approval capture after Build 149 Build 146 fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 148');
mustHave(wrapper, PRIOR_POST_BUILD_146_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 147');
mustHave(
  wrapper,
  'future_command_status is blocked_until_fresh_execution_pre_run_guard_passes_after_build_149_build_146_fresh_chain_wiring_correction_approval_capture',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh runner-execution approval capture after Build 149 Build 146 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_runner_execution_approval_capture_after_build_149_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 149 Build 146 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
