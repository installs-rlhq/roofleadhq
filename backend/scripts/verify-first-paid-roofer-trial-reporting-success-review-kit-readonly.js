...
const docPath = "docs/FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md";
const wrapperPath = "scripts/run-first-paid-roofer-trial-reporting-success-review-kit-dry-run.sh";
const verifierPath = "backend/scripts/verify-first-paid-roofer-trial-reporting-success-review-kit-readonly.js";
...
console.log("PASS: all expected files for first paid roofer trial reporting + success review kit exist.");

// File existence and basic properties
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "first paid roofer trial reporting success review kit doc");
mustHave(doc, "run-first-paid-roofer-trial-reporting-success-review-kit-dry-run.sh", "first paid roofer trial reporting success review kit doc references wrapper");
mustHave(doc, "FIRST_PAID_ROOFER_TRIAL_DAY_ONE_OPERATING_KIT.md", "first paid roofer trial reporting success review kit doc references trial day one operating kit");
mustHave(doc, "FIRST_PAID_ROOFER_GO_LIVE_READINESS_EXECUTION_KIT.md", "first paid roofer trial reporting success review kit doc references go-live readiness execution kit");
mustHave(doc, "FIRST_PAID_ROOFER_GUIDED_SETUP_EXECUTION_KIT.md", "first paid roofer trial reporting success review kit doc references guided setup execution kit");
mustHave(doc, "FIRST_PAID_ROOFER_LAUNCH_SYSTEM_PACKET.md", "first paid roofer trial reporting success review kit doc references launch system packet");
mustHave(doc, "FIRST_ROOFER_DAY_ONE_COMMAND_CENTER.md", "first paid roofer trial reporting success review kit doc references first roofer day-one command center");
mustHave(doc, "FIRST_ROOFER_LEAD_TO_INSPECTION_OPS_PACK.md", "first paid roofer trial reporting success review kit doc references lead-to-inspection ops pack");
mustHave(doc, "WEBSITE_TRIAL_DIRECTION_REGRESSION_PACKET.md", "first paid roofer trial reporting success review kit doc references website trial direction regression packet");
mustHave(doc, "ROOFER_DATA_PROTECTION_TENANT_ISOLATION_PLAN_PLACEMENT_PACKET.md", "first paid roofer trial reporting success review kit doc references data protection tenant isolation packet");
...
mustHave(wrapper, "verify-first-paid-roofer-trial-reporting-success-review-kit-readonly.js", "wrapper must call this verifier");
mustHave(wrapper, "node --check backend/scripts/verify-first-paid-roofer-trial-reporting-success-review-kit-readonly.js", "wrapper must run node --check on verifier");
...
mustHave(aggregate, "verify-first-paid-roofer-trial-reporting-success-review-kit-readonly.js", "aggregate pilot readiness must wire the trial reporting success review kit verifier");
mustHave(verifierIndex, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "verifier index must list the trial reporting success review kit doc");
mustHave(contextFirstPaid, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_FIRST_PAID_LAUNCH must record trial reporting success review kit");
mustHave(contextRooferDryRun, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_ROOFER_DRY_RUN_ONBOARDING must record trial reporting success review kit");
mustHave(workflow, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "NEXT_CHAT_CONTEXT_PACKAGE_AGENT_GROK_BUILD_WORKFLOW must record trial reporting success review kit");
mustHave(businessGuide, "FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md", "ROOFLEADHQ_BUSINESS_BUILDOUT_DAILY_GUIDE must record trial reporting success review kit");
console.log("PASS: wiring to aggregate, verifier index, 4 context/daily files present.");

// All required sections exist with substantive content (1-18 plus intro structure + 19 trackers)
assertSectionWithContent(doc, "## 1. Internal-only dry-run scope", [
  "Internal-only / founder-operator-only",
  "manual trial reporting and success review only",
  "No live systems"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 2. Trial reporting and success review purpose", [
  "after Trial Day One",
  "during and at the end of the 14-day trial",
  "14-day trial begins after RoofLeadHQ AI setup goes live",
  "PASS/HOLD/BLOCKED",
  "manual trial reporting"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 3. Inputs from Trial Day One and Launch System", [
  "FIRST_PAID_ROOFER_TRIAL_DAY_ONE_OPERATING_KIT.md",
  "End-of-Day Trial Handoff Tracker",
  "Setup-to-Trial Handoff Artifact"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 4. Daily trial reporting rhythm", [
...
assertSectionWithContent(doc, "## 5. Lead intake and source performance review", [
  "lead completeness checklist",
  "Lead Source Performance Tracker",
  "PASS/HOLD/BLOCKED per source"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 6. Response and follow-up outcome review", [
...
assertSectionWithContent(doc, "## 7. Missed-lead recovery outcome review", [
...
assertSectionWithContent(doc, "## 8. Booked homeowner appointment tracking", [
  "booked homeowner appointment",
  "Confirm manual coordination steps logged",
  "no auto-booking or \"You book the inspection\"",
  "Booked Homeowner Appointment Tracker"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 9. Roofer communication and feedback review", [
  "Roofer Feedback Review Tracker",
  "manual update channel",
  "No production dashboard or portal exposure to roofer"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 10. Trial health scorecard", [
...
assertSectionWithContent(doc, "## 11. Blocker and risk review", [
  "PASS / HOLD / BLOCKED Rules (enforced)",
  "Data protection / tenant isolation red flag",
  "Wants live automation activated during trial: BLOCKED"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 12. Pre-payment email readiness checklist", [
  "Pre-payment email readiness",
  "An automated email is sent 2 days before the first monthly payment",
  "Pre-Payment Email Readiness Tracker"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 13. Cancellation/no-go handling", [
  "Cancellation/no-go handling",
  "during-trial cancel",
  "CANCELLED / NO-GO"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 14. First monthly payment handoff readiness", [
  "First monthly payment handoff readiness",
  "PAYMENT RECEIVED — FIRST MONTH ACTIVE",
  "manual payment request"
], "first paid roofer trial reporting success review kit doc");

assertSectionWithContent(doc, "## 15. Success review call agenda and script", [
  "Success review call agenda and script",
...
assertSectionWithContent(doc, "## 16. End-of-trial PASS/HOLD/BLOCKED decision gate", [
  "End-of-trial PASS/HOLD/BLOCKED decision gate",
  "final gate at end of 14-day trial",
  "Only PASS advances to section 14"
], "first paid roofer trial reporting success review kit doc");
...
assertSectionWithContent(doc, "## 18. Public-vs-internal language boundary", [
  "Customer-facing trial communications",
...
// 19. Manual tracker templates — all 9 required tables with exact names (user-specified)
assertSectionWithContent(doc, "### Daily Trial Reporting Tracker", ["Daily Trial Reporting Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Lead Source Performance Tracker", ["Lead Source Performance Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Response Follow-Up Outcome Tracker", ["Response Follow-Up Outcome Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Missed-Lead Recovery Outcome Tracker", ["Missed-Lead Recovery Outcome Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Booked Homeowner Appointment Tracker", ["Booked Homeowner Appointment Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Roofer Feedback Review Tracker", ["Roofer Feedback Review Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Trial Health Scorecard Tracker", ["Trial Health Scorecard Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### Pre-Payment Email Readiness Tracker", ["Pre-Payment Email Readiness Tracker"], "first paid roofer trial reporting success review kit doc");
assertSectionWithContent(doc, "### End-of-Trial Decision Handoff Tracker", ["End-of-Trial Decision Handoff Tracker"], "first paid roofer trial reporting success review kit doc");
...
for (const g of goodLanguage) {
  mustHave(doc, g, "first paid roofer trial reporting success review kit doc (customer-facing language)");
}
...
for (const f of forbiddenBusiness) {
  mustNotHave(docBeforeForbiddenList, f, "first paid roofer trial reporting success review kit doc (customer-facing / outside forbidden list section)");
}
...
// Confirm references to Trial Day One, Go-Live Readiness, Guided Setup, Launch System, First Roofer Day-One Command Center, Trial Direction Regression, Data Protection/Tenant Isolation
...
mustHave(doc, "FIRST_ROOFER_LEAD_TO_INSPECTION_OPS_PACK.md", "kit must reference Lead-to-Inspection Ops Pack");
...
console.log("PASS: required packet references present (Trial Day One Operating Kit, Go-Live Readiness, Guided Setup, Launch System, Day-One Command Center, Lead-to-Inspection Ops Pack, Trial Direction Regression, Data Protection/Tenant Isolation).");

// Final self-reference confirmation
mustHave(doc, "This kit file: `docs/FIRST_PAID_ROOFER_TRIAL_REPORTING_SUCCESS_REVIEW_KIT.md`", "kit doc must self-reference correctly");
...
console.log("PASS: all required sections (1-18 + 19 trackers), 9 tables, customer-facing language, forbidden absence, wiring, references to Trial Day One Operating Kit + Go-Live Readiness + Guided Setup + Launch System + First Roofer Day-One Command Center + Lead-to-Inspection Ops Pack + Trial Direction Regression + Data Protection/Tenant Isolation packets, safety boundaries, and no forbidden impl file changes verified for first paid roofer trial reporting + success review kit.");

console.log("PASS: first paid roofer trial reporting + success review kit verifier checks complete.");
