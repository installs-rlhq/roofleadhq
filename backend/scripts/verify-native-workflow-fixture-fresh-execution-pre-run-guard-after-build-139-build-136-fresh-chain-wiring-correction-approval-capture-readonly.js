...
const upstreamCaptureAfterBuild134ApprovalCaptureFixturePath =
  'backend/fixtures/native-workflow-demo-roofer/fresh-execution-pre-run-guard-after-build-134-approval-capture.json';
...
const SOURCE_OF_TRUTH_COMMIT = '47fbba3';
...
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '7f9714e';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '7f9714e';
...
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 6:35pm MST';
const SIGNED_APPROVAL_CAPTURE_SOURCE = 'chat';
const APPROVAL_SCOPE =
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction';
const RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_ready_for_exact_approved_execution_after_build_139_build_136_fresh_chain_wiring_correction_guard';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: 'debb60e',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction',
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_47fbba3',
  'build_140_approval_capture_is_closed',
  'fresh_signed_approval_after_build_139_build_136_fresh_chain_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_build_139_build_136_fresh_chain_wiring_correction',
  ...
  'prior_build_133_134_135_136_decision_approval_guard_chain_not_reusable',
  'build_137_consumed_prior_post_build_136_attempt',
  'build_138_runner_execution_path_after_build_136_fresh_chain_wiring_correction_referenced',
  'build_139_fresh_decision_template_referenced',
  'build_140_approval_capture_referenced',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_47fbba3_referenced',
  'prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_commit_47fbba3_referenced',
  'prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_status_closed',
  'prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit_debb60e_referenced',
  'prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status_closed',
  ...
  'build_140_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  'build_139_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  'build_138_runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  'build_137_post_build_136_blocked_evidence_referenced',
  'build_136_fresh_execution_pre_run_guard_after_after_all_guard_wiring_correction_referenced',
  'build_136_capture_fresh_runner_execution_approval_after_after_all_guard_wiring_correction_referenced',
  ...
  'approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction',
  ...
  'prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_136_guard',
  ...
  'prior_fresh_runner_execution_approval_reusable_after_build_136_fresh_chain_wiring_correction_false',
  'prior_fresh_execution_pre_run_guard_reusable_after_build_136_fresh_chain_wiring_correction_false',
  'prior_build_133_134_135_136_decision_approval_guard_chain_reusable_after_build_137_blocked_evidence_false',
  'runner_scaffolding_build_status_built_review_only',
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_build_139_build_136_fresh_chain_wiring_correction_guard',
  'runner_fail_closed_sanity_check_status_blocked_exit_code_1',
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_build_139_build_136_fresh_chain_wiring_correction_guard_review_only',
  ...
  'packet_does_not_treat_prior_build_133_134_135_136_decision_approval_guard_chain_as_reusable',
  'next_step_exact_approved_runner_execution_command_after_build_139_build_136_fresh_chain_wiring_correction_guard_review_only',
  ...
  'upstream_fresh_pre_run_guard_after_build_134_approval_capture_fixture_present_not_reusable',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-139-build-136-fresh-chain-wiring-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-139-build-136-fresh-chain-wiring-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-build-139-build-136-fresh-chain-wiring-correction-approval-capture.json',
  'Native Workflow Fixture Fresh Execution Pre-Run Guard Build 139 Build 136 Fresh-Chain Wiring Correction Approval Capture',
  'native workflow fixture fresh execution pre run guard after build 139 build 136 fresh chain wiring correction approval capture',
  'fresh execution pre run guard after build 139 build 136 fresh chain wiring correction approval capture',
];
...
read(postBuild136BlockedEvidencePacketDocPath);
read(freshPreRunGuardAfterBuild134ApprovalCapturePacketDocPath);
...
passAssertion('source_of_truth_commit_47fbba3_referenced');
...
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_commit_47fbba3_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_status_closed');
...
passAssertion('build_140_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_packet_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit_debb60e_referenced');

mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status_closed');
...
passAssertion('build_139_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_138_runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_referenced');

mustHave(packetDoc, postBuild136BlockedEvidencePacketDocPath, 'packet doc');
...
mustHave(packetDoc, freshPreRunGuardAfterBuild134ApprovalCapturePacketDocPath, 'packet doc');
...
passAssertion('build_136_fresh_execution_pre_run_guard_after_after_all_guard_wiring_correction_referenced');

mustHave(packetDoc, freshPreRunGuardAfterBuild134ApprovalCapturePacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterBuild134ApprovalCaptureFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 136', 'packet doc');
passAssertion('build_136_capture_fresh_runner_execution_approval_after_after_all_guard_wiring_correction_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_136_guard');
...
passAssertion('prior_fresh_runner_execution_approval_reusable_after_build_136_fresh_chain_wiring_correction_false');
passAssertion('prior_fresh_execution_pre_run_guard_reusable_after_build_136_fresh_chain_wiring_correction_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_build_139_build_136_fresh_chain_wiring_correction_guard');
...
passAssertion('future_command_status_ready_for_exact_approved_runner_execution_command_after_build_139_build_136_fresh_chain_wiring_correction_guard_review_only');
...
mustHave(
  packetDoc,
  'This is the **fresh execution pre-run guard only** after build 139 build 136 fresh-chain wiring correction approval capture.',
  'packet doc',
);
...
mustHave(packetDoc, 'exact approved runner execution command after build 139 build 136 fresh-chain wiring correction guard review', 'packet doc');
passAssertion('next_step_exact_approved_runner_execution_command_after_build_139_build_136_fresh_chain_wiring_correction_guard_review_only');
mustHave(packetDoc, 'Fresh execution pre-run guard pass does **not** equal runner execution.', 'packet doc');
mustHave(packetDoc, 'This packet does **not** treat prior Build 133/134/135/136 approvals/guard chain as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_133_134_135_136_decision_approval_guard_chain_as_reusable');
...
for (const upstreamFixturePath of [
  ...
  upstreamPostBuild136BlockedEvidenceFixturePath,
  upstreamFreshPreRunGuardAfterBuild134ApprovalCaptureFixturePath,
  upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
...
passAssertion('upstream_fresh_pre_run_guard_after_build_134_approval_capture_fixture_present_not_reusable');
...
const upstreamPostBuild136BlockedEvidenceFixture = readJson(upstreamPostBuild136BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterBuild134ApprovalCaptureFixture = readJson(upstreamFreshPreRunGuardAfterBuild134ApprovalCaptureFixturePath);
const upstreamCaptureAfterBuild134ApprovalCaptureFixture = readJson(upstreamCaptureAfterBuild134ApprovalCaptureFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 47fbba3');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
...
if (fixture.prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_status must be closed');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit must be debb60e');
}
if (fixture.prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status must be closed');
}
...
if (
  ...
  fail('fixture prior_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result_after_build_136_guard');
}
...
if (fixture.prior_build_137_consumed_attempt_status !== 'consumed') {
  fail('fixture prior_build_137_consumed_attempt_status must be consumed');
}
...
for (const field of EXACT_VALUE_FIELDS) {
  ...
  if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field] !== expected) {
    fail(`upstream capture after build 139 build 136 fresh-chain wiring correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.approved_exact_values[field] !== expected) {
    fail(`upstream capture after build 139 build 136 fresh-chain wiring correction fixture approved_exact_values.${field} mismatch`);
  }
...
if (
  ...
  'blocked_until_fresh_execution_pre_run_guard_passes_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture'
) {
...
if (!upstreamPostBuild136BlockedEvidenceFixture.packet_name) {
  fail('upstream blocked evidence fixture must exist with packet_name');
}

if (!upstreamFreshPreRunGuardAfterBuild134ApprovalCaptureFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterBuild134ApprovalCaptureFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after build 139 build 136 fresh-chain wiring correction approval capture only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 138');
mustHave(wrapper, PRIOR_POST_BUILD_136_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 137');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_build_139_build_136_fresh_chain_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after build 139 build 136 fresh-chain wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after build 139 build 136 fresh-chain wiring correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard Build 139 Build 136 Fresh-Chain Wiring Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
