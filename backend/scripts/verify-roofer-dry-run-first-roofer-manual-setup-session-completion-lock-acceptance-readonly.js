...
const doc = 'docs/ROOFER_DRY_RUN_FIRST_ROOFER_MANUAL_SETUP_SESSION_COMPLETION_LOCK_ACCEPTANCE.md';
const wrapper = 'scripts/accept-first-roofer-manual-setup-session-completion-lock-dry-run.sh';
const verifier = 'backend/scripts/verify-roofer-dry-run-first-roofer-manual-setup-session-completion-lock-acceptance-readonly.js';
...
mustInclude('docs/FIRST_PAID_LAUNCH_VERIFIER_INDEX.md', 'First Roofer Manual Setup Session Completion Lock Acceptance');
mustInclude('docs/FIRST_PAID_LAUNCH_VERIFIER_INDEX.md', verifier);
mustInclude('docs/NEXT_CHAT_CONTEXT_PACKAGE_FIRST_PAID_LAUNCH.md', 'First Roofer Manual Setup Session Completion Lock Acceptance');
mustInclude('docs/NEXT_CHAT_CONTEXT_PACKAGE_FIRST_PAID_LAUNCH.md', verifier);
mustInclude('docs/NEXT_CHAT_CONTEXT_PACKAGE_ROOFER_DRY_RUN_ONBOARDING.md', 'First Roofer Manual Setup Session Completion Lock Acceptance');
mustInclude('docs/NEXT_CHAT_CONTEXT_PACKAGE_ROOFER_DRY_RUN_ONBOARDING.md', verifier);

console.log('PASS: First roofer manual setup session completion lock acceptance verifier passed.');
