...
const packetDocPath = 'docs/NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_159_BUILD_156_FRESH_CHAIN_WIRING_CORRECTION.md';
const fixturePath = 'backend/fixtures/native-workflow-demo-roofer/capture-fresh-runner-execution-approval-after-build-159-build-156-fresh-chain-wiring-correction.json';
const wrapperPath = 'scripts/run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-159-build-156-fresh-chain-wiring-correction-dry-run.sh';
...
mustHave(doc, 'Native Workflow Fixture Capture Fresh Runner Execution Approval After Build 159 Build 156 Fresh Chain Wiring Correction', 'packet doc');
mustHave(doc, 'Jason Lohse 06/20/2026 10:22pm MST', 'packet doc');
...
mustHave(doc, 'approval-capture-only', 'packet doc');
mustHave(doc, 'does **not** pass the fresh execution pre-run guard', 'packet doc');
...
expectEq(fixture, 'source_of_truth_commit', '0eefaf3');
...
expectEq(fixture, 'approval_signed_at_mst', '06/20/2026 10:22pm MST');
...
expectEq(fixture, 'fresh_runner_execution_approval_status', 'captured_not_executable_until_fresh_pre_run_guard_passes');
...
expectEq(fixture, 'runner_command_path_status', 'blocked_until_fresh_pre_run_guard_pass_after_build_159_build_156_fresh_chain_wiring_correction_approval_capture');
expectEq(fixture, 'future_command_status', 'blocked_until_fresh_pre_run_guard_pass_after_build_159_build_156_fresh_chain_wiring_correction_approval_capture');
...
mustHave(wrapper, 'node backend/scripts/verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-159-build-156-fresh-chain-wiring-correction-readonly.js', 'wrapper');

for (const text of [aggregate, index, contextFirstPaid, contextAgent, guide, safeReadiness]) {
  if (!text.includes('Native Workflow Fixture Capture Fresh Runner Execution Approval After Build 159 Build 156 Fresh Chain Wiring Correction') || !text.includes('native workflow fixture capture fresh runner execution approval after build 159 build 156 fresh chain wiring correction')) {
...
console.log('PASS: Native Workflow Fixture Capture Fresh Runner Execution Approval After Build 159 Build 156 Fresh Chain Wiring Correction verified (' + passCount + ' assertions).');
