...
const afterBuild146FreshChainWiringCorrectionPacketDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION.md';
const postBuild146BlockedEvidenceDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_146_RUNNER_COMMAND_BLOCKED_EVIDENCE.md';
const freshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureDocPath =
...
const captureAfterBuild144Build141FreshChainWiringCorrectionPacketDocPath =
...
const upstreamCaptureAfterBuild144Build141FreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '135b26c';
const PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '135b26c';
const PRIOR_POST_BUILD_146_BLOCKED_EVIDENCE_COMMIT = '0c6abaf';
...
const FIXTURE_RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_146_fresh_chain_wiring_correction';
const FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_runner_execution_approval_captured_after_build_146_fresh_chain_wiring_correction';
...
const FRESH_RUNNER_EXECUTION_TEMPLATE_CHECKS = [
  'Build 103-148 upstream packets referenced and runner execution path after Build 146 fresh-chain wiring correction closed at 135b26c',
  'runner command path exists executable and corrected fail-closed pending fresh decision after Build 146 fresh-chain wiring correction',
  ...
  'future_command_status blocked until fresh runner execution approval captured after Build 146 fresh-chain wiring correction',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, explicitly approve one-time fresh runner execution for the exact scoped actual external/sandbox 30-scenario validation described below after Build 148 runner execution path after Build 146 fresh-chain wiring correction.',
  'This fresh runner-execution approval is for fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_146_fresh_chain_wiring_correction only.',
  ...
  'Even if signed later, runner execution remains blocked until a separate fresh execution pre-run guard passes after Build 146 fresh-chain wiring correction.',
  'Prior Build 143/144/145/146 decision/approval/guard chain is not reusable after Build 147 blocked evidence.',
  'Signature:',
  'Timestamp:',
  'Expiration:',
];
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_runner_execution_path_after_build_146_fresh_chain_wiring_correction_fixture_present',
  'upstream_post_build_146_blocked_evidence_fixture_present',
  'upstream_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_fixture_present',
  'upstream_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_fixture_present',
  'upstream_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_fixture_present',
  ...
  'source_of_truth_commit_135b26c_referenced',
  'prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_commit_135b26c_referenced',
  'prior_post_build_146_blocked_evidence_commit_0c6abaf_referenced',
  'runner_scaffolding_build_commit_145bf15_referenced',
  'build_148_runner_execution_path_after_build_146_fresh_chain_wiring_correction_referenced',
  'build_147_post_build_146_blocked_evidence_referenced',
  'build_146_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_referenced',
  'build_145_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_referenced',
  'build_144_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_referenced',
  ...
  'prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status_closed',
  'prior_post_build_146_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_146_guard',
  'prior_build_147_consumed_attempt_status_consumed',
  'immediate_rerun_allowed_false',
  'fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction_true',
  'fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction_true',
  ...
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_146_fresh_chain_wiring_correction',
  'runner_command_after_build_146_fresh_chain_references_present',
  'runner_command_build_147_consumed_post_build_146_attempt_documented',
  ...
  'future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_build_146_fresh_chain_wiring_correction',
  ...
  'packet_does_not_treat_prior_build_143_144_145_146_chain_as_reusable',
  ...
  'fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_TEMPLATE.md',
  'run-native-workflow-fixture-fresh-runner-execution-decision-after-build-146-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-fresh-runner-execution-decision-after-build-146-fresh-chain-wiring-correction-readonly.js',
  'fresh-runner-execution-decision-after-build-146-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Fresh Runner-Execution Decision After Build 146 Fresh-Chain Wiring Correction',
  'native workflow fixture fresh runner execution decision after build 146 fresh chain wiring correction',
  'fresh runner execution decision after build 146 fresh chain wiring correction',
];
...
read(afterBuild146FreshChainWiringCorrectionPacketDocPath);
read(postBuild146BlockedEvidenceDocPath);
read(freshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureDocPath);
read(captureAfterBuild144Build141FreshChainWiringCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_135b26c_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(approvalTemplateDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'approval template doc');
passAssertion('prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_commit_135b26c_referenced');

mustHave(packetDoc, afterBuild146FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamAfterBuild146FreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 148', 'packet doc');
passAssertion('build_148_runner_execution_path_after_build_146_fresh_chain_wiring_correction_referenced');

mustHave(packetDoc, postBuild146BlockedEvidenceDocPath, 'packet doc');
mustHave(packetDoc, upstreamPostBuild146BlockedEvidenceFixturePath, 'packet doc');
mustHave(packetDoc, PRIOR_POST_BUILD_146_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(packetDoc, 'Build 147', 'packet doc');
passAssertion('build_147_post_build_146_blocked_evidence_referenced');
passAssertion('prior_post_build_146_blocked_evidence_commit_0c6abaf_referenced');

mustHave(packetDoc, freshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureFixturePath, 'packet doc');
mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_144_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT, 'packet doc');
mustHave(packetDoc, 'Build 146', 'packet doc');
passAssertion('build_146_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_referenced');

mustHave(packetDoc, captureAfterBuild144Build141FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterBuild144Build141FreshChainWiringCorrectionFixturePath, 'packet doc');
...
passAssertion('build_145_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
...
passAssertion('build_144_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_referenced');
...
mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
...
mustHave(packetDoc, 'prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status | closed', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status | closed', 'approval template doc');
passAssertion('prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, 'prior_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_146_guard', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_146_guard', 'approval template doc');
passAssertion('prior_post_build_146_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_146_guard');

mustHave(packetDoc, 'prior_build_147_consumed_attempt_status | consumed', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_build_147_consumed_attempt_status | consumed', 'approval template doc');
passAssertion('prior_build_147_consumed_attempt_status_consumed');
...
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction is `true`', 'packet doc');
passAssertion('fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction is `true`', 'packet doc');
passAssertion('fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'prior_fresh_runner_execution_approval_reusable_after_build_146_fresh_chain_wiring_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_fresh_execution_pre_run_guard_reusable_after_build_146_fresh_chain_wiring_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence | false', 'packet doc');
mustHave(packetDoc, 'This packet **does not** treat prior Build 143/144/145/146 decision/approval/guard chain as reusable.', 'packet doc');
mustHave(approvalTemplateDoc, '**Explicit note:** This template does **not** treat prior Build 143/144/145/146 decision/approval/guard chain as reusable.', 'approval template doc');
passAssertion('packet_does_not_treat_prior_build_143_144_145_146_chain_as_reusable');
...
passAssertion('future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_build_146_fresh_chain_wiring_correction');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_146_fresh_chain_wiring_correction');
...
if (!fs.existsSync(path.join(root, upstreamAfterBuild146FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream after Build 146 fresh-chain wiring correction fixture: ${upstreamAfterBuild146FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_runner_execution_path_after_build_146_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamPostBuild146BlockedEvidenceFixturePath))) {
  fail(`missing upstream post-Build-146 blocked evidence fixture: ${upstreamPostBuild146BlockedEvidenceFixturePath}`);
}
passAssertion('upstream_post_build_146_blocked_evidence_fixture_present');

if (!fs.existsSync(path.join(root, upstreamFreshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureFixturePath))) {
  fail(`missing upstream fresh pre-run guard after Build 144 Build 141 fresh-chain wiring correction approval capture fixture: ${upstreamFreshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureFixturePath}`);
}
passAssertion('upstream_fresh_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_fixture_present');

if (!fs.existsSync(path.join(root, upstreamCaptureAfterBuild144Build141FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream capture after Build 144 Build 141 fresh-chain wiring correction fixture: ${upstreamCaptureAfterBuild144Build141FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream fresh decision after Build 141 fresh-chain wiring correction fixture: ${upstreamFreshDecisionAfterBuild141FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamRunnerExecutionPathAfterBuild141FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream runner execution path after Build 141 fresh-chain wiring correction fixture: ${upstreamRunnerExecutionPathAfterBuild141FreshChainWiringCorrectionFixturePath}`);
}
...
readJson(upstreamAfterBuild146FreshChainWiringCorrectionFixturePath);
readJson(upstreamPostBuild146BlockedEvidenceFixturePath);
readJson(upstreamFreshPreRunGuardAfterBuild144Build141FreshChainWiringCorrectionApprovalCaptureFixturePath);
readJson(upstreamCaptureAfterBuild144Build141FreshChainWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) fail('fixture source_of_truth_commit must be 135b26c');
if (fixture.prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_146_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_commit must be 135b26c');
}
if (fixture.prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status must be closed');
}
if (fixture.prior_post_build_146_blocked_evidence_commit !== PRIOR_POST_BUILD_146_BLOCKED_EVIDENCE_COMMIT) fail('fixture prior_post_build_146_blocked_evidence_commit must be 0c6abaf');
if (fixture.prior_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_146_guard') {
  fail('fixture prior_command_attempt_consumption_status mismatch');
}
if (fixture.prior_build_147_consumed_attempt_status !== 'consumed') fail('fixture prior_build_147_consumed_attempt_status must be consumed');
if (fixture.immediate_rerun_allowed !== false) fail('fixture immediate_rerun_allowed must be false');
if (fixture.fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_runner_execution_approval_required_after_build_146_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_execution_pre_run_guard_required_after_build_146_fresh_chain_wiring_correction must be true');
}
if (fixture.prior_fresh_runner_execution_approval_reusable_after_build_146_fresh_chain_wiring_correction !== false) {
  fail('fixture prior_fresh_runner_execution_approval_reusable_after_build_146_fresh_chain_wiring_correction must be false');
}
if (fixture.prior_fresh_execution_pre_run_guard_reusable_after_build_146_fresh_chain_wiring_correction !== false) {
  fail('fixture prior_fresh_execution_pre_run_guard_reusable_after_build_146_fresh_chain_wiring_correction must be false');
}
if (fixture.prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence !== false) {
  fail('fixture prior_build_143_144_145_146_decision_approval_guard_chain_reusable_after_build_147_blocked_evidence must be false');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_commit !== PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_144_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_144_build_141_fresh_chain_wiring_correction_approval_capture_commit must be 628436a');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_commit !== PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_144_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_build_144_build_141_fresh_chain_wiring_correction_commit must be 416a61c');
}
if (fixture.prior_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_commit !== PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_commit must be f4c3069');
}
if (fixture.prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
...
mustHave(runnerScript, 'after_build_146', 'runner script');
mustHave(runnerScript, 'after Build 146 fresh-chain wiring correction', 'runner script');
mustHave(runnerScript, 'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_146_guard', 'runner script');
mustHave(runnerScript, 'Build 147 consumed the post-Build-146 exact approved command attempt', 'runner script');
mustHave(runnerScript, 'fresh_decision_required_after_build_146_fresh_chain_wiring_correction: true', 'runner script');
mustHave(runnerScript, '(Build 143)', 'runner script');
mustHave(runnerScript, '(Build 144)', 'runner script');
mustHave(runnerScript, '(Build 145)', 'runner script');
mustHave(runnerScript, '(Build 146)', 'runner script');
mustHave(runnerScript, 'immediate_rerun_allowed: false', 'runner script');
mustNotHave(runnerScript, STALE_READY_FUTURE_COMMAND_STATUS, 'runner script must not have stale ready_for_exact_approved primary future_command_status');
passAssertion('runner_command_after_build_146_fresh_chain_references_present');
passAssertion('runner_command_build_147_consumed_post_build_146_attempt_documented');
...
mustHave(aggregate, 'Native Workflow Fixture Fresh Runner-Execution Decision After Build 146 Fresh-Chain Wiring Correction', 'aggregate readiness');
...
mustHave(wrapper, 'local fresh runner-execution decision/template after Build 146 fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'prior_runner_execution_path_after_build_146_fresh_chain_wiring_correction_status is closed', 'wrapper mode');
mustHave(wrapper, 'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_146_guard', 'wrapper mode');
mustHave(wrapper, 'prior_build_147_consumed_attempt_status is consumed', 'wrapper mode');
mustHave(wrapper, 'immediate_rerun_allowed is false', 'wrapper mode');
mustHave(wrapper, 'prior Build 143/144/145/146 decision/approval/guard chain is not reusable after Build 147 blocked evidence', 'wrapper mode');
...
mustHave(wrapper, 'Jason review/sign fresh runner-execution approval template after Build 146 fresh-chain wiring correction', 'wrapper mode');
mustHave(wrapper, 'Build 147 consumed the post-Build-146 attempt', 'wrapper mode');
...
if (!isExecutable(wrapperPath)) {
  fail(`fresh runner execution decision after Build 146 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('fresh_runner_execution_decision_after_build_146_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
if (REQUIRED_ASSERTIONS.length !== 103) {
  fail(`REQUIRED_ASSERTIONS must contain 103 items (found ${REQUIRED_ASSERTIONS.length})`);
}

console.log(
  `PASS: Native Workflow Fixture Fresh Runner-Execution Decision After Build 146 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
