...
const SOURCE_OF_TRUTH_COMMIT = 'debb60e';
...
const FRESH_RUNNER_EXECUTION_CAPTURE_CHECKS = [
  'Build 139 fresh runner-execution decision after Build 136 fresh-chain wiring correction packet referenced upstream and closed at debb60e',
  'Build 138 runner execution path after Build 136 fresh-chain wiring correction and Build 137 blocked command evidence referenced',
  'runner command path exists executable and corrected fail-closed pending fresh execution pre-run guard after Build 139 Build 136 fresh-chain wiring correction approval capture',
  ...
  'future_command_status blocked until fresh execution pre-run guard passes after Build 139 Build 136 fresh-chain wiring correction approval capture',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, approve the fresh runner-execution approval capture after Build 136 fresh-chain wiring correction for RoofLeadHQ.',
  'Scope approved:',
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction',
  ...
  '30',
  'I approve only a scoped sandbox/test-mode runner-execution approval capture packet after the Build 138 runner execution path after Build 136 fresh-chain wiring correction and Build 139 fresh decision/template packet.',
  ...
  'I understand Build 137 consumed the prior post-Build-136 attempt and no prior approval/guard chain is reusable.',
  'Signed: Jason Lohse',
  'Date/time: 06/20/2026 6:35pm MST',
];

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_debb60e_referenced',
  ...
  'build_139_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_packet_referenced',
  ...
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture',
  ...
  'future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture',
  ...
  'packet_does_not_treat_prior_build_133_134_135_136_approvals_guard_chain_as_reusable',
  ...
  'fresh_runner_execution_approval_capture_after_build_139_build_136_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION.md',
  'run-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-139-build-136-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-capture-fresh-runner-execution-approval-after-build-139-build-136-fresh-chain-wiring-correction-readonly.js',
  'capture-fresh-runner-execution-approval-after-build-139-build-136-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 139 Build 136 Fresh-Chain Wiring Correction',
  'native workflow fixture capture fresh runner execution approval after build 139 build 136 fresh chain wiring correction',
  'capture fresh runner execution approval after build 139 build 136 fresh chain wiring correction',
];
...
passAssertion('source_of_truth_commit_debb60e_referenced');
...
passAssertion('build_139_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_packet_referenced');
...
mustHave(packetDoc, 'fresh_runner_execution_scope_approved | fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_136_fresh_chain_wiring_correction', 'packet doc');
...
passAssertion('prior_build_133_134_135_136_decision_approval_guard_chain_reusable_after_build_137_blocked_evidence_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture');
...
passAssertion('future_command_status_blocked_until_fresh_execution_pre_run_guard_passes_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture');
...
mustHave(
  packetDoc,
  'This packet captures fresh runner-execution approval after Build 139 Build 136 fresh-chain wiring correction **only**.',
  'packet doc',
);
...
passAssertion('packet_does_not_treat_prior_build_133_134_135_136_approvals_guard_chain_as_reusable');
mustHave(packetDoc, 'fresh execution pre-run guard pass after Build 139 Build 136 fresh-chain wiring correction approval capture**, not execution', 'packet doc');
...
for (const upstreamFixturePath of [
  upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath,
  upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath,
...
const upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath,
);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be debb60e');
}
if (
...
if (
  upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
    'upstream fresh decision after Build 136 fresh-chain wiring correction fixture fresh_runner_execution_decision_template_status must be created_review_only',
  );
}
if (
  upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !==
  'not_captured'
) {
  fail(
    'upstream fresh decision after Build 136 fresh-chain wiring correction fixture fresh_runner_execution_approval_capture_status must be not_captured (prior to this capture packet)',
  );
}

if (!upstreamRunnerExecutionPathAfterBuild136Fixture.packet_name) {
  fail('upstream runner execution path after Build 136 fresh-chain wiring correction fixture must exist with packet_name');
}
...
mustHave(wrapper, 'local fresh runner-execution approval capture after Build 139 Build 136 fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(
  wrapper,
  'future_command_status is blocked_until_fresh_execution_pre_run_guard_passes_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh runner-execution approval capture after Build 139 Build 136 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_runner_execution_approval_capture_after_build_139_build_136_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Fresh Runner-Execution Approval After Build 139 Build 136 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
