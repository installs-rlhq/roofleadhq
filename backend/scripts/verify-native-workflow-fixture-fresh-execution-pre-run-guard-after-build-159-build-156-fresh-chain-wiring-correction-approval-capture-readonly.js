...
const packetDocPath = 'docs/NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_159_BUILD_156_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE.md';
const fixturePath = 'backend/fixtures/native-workflow-demo-roofer/fresh-execution-pre-run-guard-after-build-159-build-156-fresh-chain-wiring-correction-approval-capture.json';
const wrapperPath = 'scripts/run-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-159-build-156-fresh-chain-wiring-correction-approval-capture-dry-run.sh';
...
mustHave(doc, 'Native Workflow Fixture Fresh Execution Pre-Run Guard After Build 159 Build 156 Fresh Chain Wiring Correction Approval Capture', 'packet doc');
mustHave(doc, 'fresh execution pre-run guard', 'packet doc');
mustHave(doc, 'does **not** run the runner', 'packet doc');
mustHave(doc, 'cd /root/roofleadhq && bash scripts/run-native-workflow-fixture-actual-external-sandbox-30-scenario-validation.sh', 'packet doc');
mustHave(doc, 'Actual 30-scenario external/sandbox validation remains', 'packet doc');

expectEq(fixture, 'source_of_truth_commit', '46ca819');
expectEq(fixture, 'prior_capture_fresh_runner_execution_approval_after_build_159_build_156_fresh_chain_wiring_correction_commit', '46ca819');
expectEq(fixture, 'prior_fresh_runner_execution_decision_after_build_156_fresh_chain_wiring_correction_commit', '0eefaf3');
...
expectEq(fixture, 'fresh_execution_pre_run_guard_packet_status', 'passed_for_scoped_one_time_fresh_runner_execution_after_build_159_build_156_fresh_chain_wiring_correction_review_only');
...
expectEq(fixture, 'signed_approval_timestamp', '06/20/2026 10:22pm MST');
expectEq(fixture, 'fresh_runner_execution_signed_by', 'Jason Lohse');
expectEq(fixture, 'runner_command_path_status', 'corrected_fail_closed_ready_for_exact_approved_execution_after_build_159_build_156_fresh_chain_wiring_correction_guard');
expectEq(fixture, 'runner_fail_closed_sanity_check_status', 'blocked_exit_code_1');
...
expectEq(fixture, 'future_command_status', 'ready_for_exact_approved_runner_execution_command_after_build_159_build_156_fresh_chain_wiring_correction_guard_review_only');
...
mustHave(wrapper, 'node backend/scripts/verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-build-159-build-156-fresh-chain-wiring-correction-approval-capture-readonly.js', 'wrapper');

for (const text of [aggregate, index, contextFirstPaid, contextAgent, guide, safeReadiness]) {
  if (!text.includes('Native Workflow Fixture Fresh Execution Pre-Run Guard After Build 159 Build 156 Fresh Chain Wiring Correction Approval Capture') || !text.includes('native workflow fixture fresh execution pre run guard after build 159 build 156 fresh chain wiring correction approval capture')) {
...
console.log('PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After Build 159 Build 156 Fresh Chain Wiring Correction Approval Capture verified (' + passCount + ' assertions).');
