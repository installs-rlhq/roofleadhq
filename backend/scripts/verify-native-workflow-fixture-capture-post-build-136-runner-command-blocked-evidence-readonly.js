...
const SOURCE_OF_TRUTH_COMMIT = '7f9714e';
...
const RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_136 = '0dc6d88';
...
const STALE_STATE_LINE =
  'NO-GO: Fresh runner-execution decision and fresh execution pre-run guard pass are required after runner execution path after-after-after-after-guard fresh-chain wiring correction';
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_capture_after_build_134_fixture_present',
  ...
  'source_of_truth_commit_7f9714e_referenced',
  'prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_commit_7f9714e_referenced',
  'prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_status_closed',
  'prior_capture_fresh_runner_execution_approval_after_build_134_commit_9b736c0_referenced',
  'prior_capture_fresh_runner_execution_approval_after_build_134_status_closed',
  'prior_fresh_decision_after_after_all_after_guard_commit_a07dda6_referenced',
  'prior_fresh_runner_execution_decision_after_after_all_after_guard_status_closed',
  'prior_runner_execution_path_after_after_all_after_guard_fresh_chain_wiring_correction_commit_1e2af98_referenced',
  'prior_runner_execution_path_after_after_all_after_guard_fresh_chain_wiring_correction_status_closed',
  ...
  'build_135_capture_after_build_134_packet_referenced',
  'build_134_fresh_decision_after_after_all_after_guard_packet_referenced',
  ...
  'exact_command_attempted_after_build_136_status_attempted_blocked_nonzero',
  'exact_command_exit_status_nonzero_blocked',
  'command_attempt_consumption_status_consumed_by_blocked_after_build_136_guard',
  'runner_output_source_of_truth_commit_observed_after_build_136_0dc6d88',
  'runner_output_state_after_build_136_stale_detected',
  'runner_recognized_build_128_129_130_131_chain',
  'runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction',
  'runner_did_not_recognize_build_134_fresh_decision',
  'runner_did_not_recognize_build_135_approval_capture',
  'runner_did_not_recognize_build_136_pre_run_guard',
  'runner_execution_path_after_build_136_fresh_chain_wiring_gap_detected',
  ...
  'future_command_status_blocked_until_runner_execution_path_after_build_136_fresh_chain_wiring_correction_and_fresh_decision',
  ...
  'next_step_after_build_136_fresh_chain_wiring_correction_not_immediate_rerun',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'capture_post_build_136_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_136_RUNNER_COMMAND_BLOCKED_EVIDENCE.md',
  'run-native-workflow-fixture-capture-post-build-136-runner-command-blocked-evidence-dry-run.sh',
  'verify-native-workflow-fixture-capture-post-build-136-runner-command-blocked-evidence-readonly.js',
  'capture-post-build-136-runner-command-blocked-evidence.json',
  'Native Workflow Fixture Capture Post-Build-136 Runner Command Blocked Evidence',
  'native workflow fixture capture post build 136 runner command blocked evidence',
  'capture post build 136 runner command blocked evidence',
];
...
passAssertion('source_of_truth_commit_7f9714e_referenced');
...
passAssertion('prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_commit_7f9714e_referenced');
passAssertion('prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_status_closed');
...
passAssertion('prior_fresh_decision_after_after_all_after_guard_commit_a07dda6_referenced');
passAssertion('prior_fresh_runner_execution_decision_after_after_all_after_guard_status_closed');
...
passAssertion('prior_runner_execution_path_after_after_all_after_guard_fresh_chain_wiring_correction_status_closed');
...
mustHave(packetDoc, 'fresh-execution-pre-run-guard-after-build-134-approval-capture', 'packet doc');
...
passAssertion('build_135_capture_after_build_134_packet_referenced');
...
passAssertion('build_134_fresh_decision_after_after_all_after_guard_packet_referenced');
...
mustHave(packetDoc, 'exact_command_attempted_after_build_136_status | attempted_blocked_nonzero', 'packet doc');
passAssertion('exact_command_attempted_after_build_136_status_attempted_blocked_nonzero');
...
passAssertion('command_attempt_consumption_status_consumed_by_blocked_after_build_136_guard');

mustHave(
  packetDoc,
  `runner_output_source_of_truth_commit_observed_after_build_136 | ${RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_136}`,
  'packet doc',
);
passAssertion('runner_output_source_of_truth_commit_observed_after_build_136_0dc6d88');
...
passAssertion('runner_output_state_after_build_136_stale_detected');

mustHave(packetDoc, 'runner_recognized_build_128_129_130_131_chain_status | true', 'packet doc');
passAssertion('runner_recognized_build_128_129_130_131_chain');

mustHave(
  packetDoc,
  'runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction_status | true',
  'packet doc',
);
passAssertion(
  'runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction',
...
mustHave(packetDoc, 'runner_did_not_recognize_build_134_fresh_decision_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_134_fresh_decision');

mustHave(packetDoc, 'runner_did_not_recognize_build_135_approval_capture_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_135_approval_capture');

mustHave(packetDoc, 'runner_did_not_recognize_build_136_pre_run_guard_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_136_pre_run_guard');
...
passAssertion('runner_execution_path_after_build_136_fresh_chain_wiring_gap_detected');
...
mustHave(packetDoc, 'after Build 136 fresh-chain wiring correction', 'packet doc');
mustHave(packetDoc, 'fresh decision path', 'packet doc');
mustHave(packetDoc, 'not immediate rerun', 'packet doc');
passAssertion('next_step_after_build_136_fresh_chain_wiring_correction_not_immediate_rerun');
...
if (
  fixture.prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_commit !==
  PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_134_APPROVAL_CAPTURE_COMMIT
) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_commit mismatch');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_status !== 'closed') {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_134_approval_capture_status must be closed');
}
...
if (fixture.exact_command_attempted_after_build_136_status !== 'attempted_blocked_nonzero') {
  fail('fixture exact_command_attempted_after_build_136_status mismatch');
}
if (fixture.exact_command_exit_status !== 'nonzero_blocked') {
  fail('fixture exact_command_exit_status mismatch');
}
if (fixture.command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_136_guard') {
  fail('fixture command_attempt_consumption_status mismatch');
}
if (
  fixture.runner_output_source_of_truth_commit_observed_after_build_136 !==
  RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_136
) {
  fail('fixture runner_output_source_of_truth_commit_observed_after_build_136 mismatch');
}
if (fixture.runner_output_state_after_build_136_status !== 'stale_pre_build_133_134_135_136_state_detected') {
  fail('fixture runner_output_state_after_build_136_status mismatch');
}
if (fixture.runner_recognized_build_128_129_130_131_chain_status !== true) {
  fail('fixture runner_recognized_build_128_129_130_131_chain_status must be true');
}
if (
  fixture.runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction_status !==
  true
) {
  fail(
    'fixture runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction_status must be true',
  );
}
if (fixture.runner_did_not_recognize_build_134_fresh_decision_status !== true) {
  fail('fixture runner_did_not_recognize_build_134_fresh_decision_status must be true');
}
if (fixture.runner_did_not_recognize_build_135_approval_capture_status !== true) {
  fail('fixture runner_did_not_recognize_build_135_approval_capture_status must be true');
}
if (fixture.runner_did_not_recognize_build_136_pre_run_guard_status !== true) {
  fail('fixture runner_did_not_recognize_build_136_pre_run_guard_status must be true');
}
if (fixture.runner_execution_path_after_build_136_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_build_136_fresh_chain_wiring_gap_status must be detected');
}
...
mustHave(wrapper, 'exact_command_attempted_after_build_136_status is attempted_blocked_nonzero', 'wrapper mode');
mustHave(wrapper, 'exact_command_exit_status is nonzero_blocked', 'wrapper mode');
mustHave(
  wrapper,
  'command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_136_guard',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_output_source_of_truth_commit_observed_after_build_136 is 0dc6d88',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_output_state_after_build_136_status is stale_pre_build_133_134_135_136_state_detected',
  'wrapper mode',
);
mustHave(wrapper, 'runner_recognized_build_128_129_130_131_chain_status is true', 'wrapper mode');
mustHave(
  wrapper,
  'runner_did_not_recognize_build_133_after_after_all_after_guard_fresh_chain_wiring_correction_status is true',
  'wrapper mode',
);
mustHave(wrapper, 'runner_did_not_recognize_build_134_fresh_decision_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_did_not_recognize_build_135_approval_capture_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_did_not_recognize_build_136_pre_run_guard_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_execution_path_after_build_136_fresh_chain_wiring_gap_status is detected', 'wrapper mode');
mustHave(wrapper, 'actual 30-scenario external validation remains 0 captured / 0 passed / 30 missing', 'wrapper mode');
mustHave(
  wrapper,
  'runner execution path after Build 136 fresh-chain wiring correction/design and fresh decision path',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`capture post-build-136 runner command blocked evidence dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('capture_post_build_136_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Post-Build-136 Runner Command Blocked Evidence verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
