...
const captureAfterAfterAfterAfterGuardFreshChainWiringCorrectionPacketDocPath =
...
const freshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionDocPath =
...
const postBuild126BlockedEvidencePacketDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_126_RUNNER_COMMAND_BLOCKED_EVIDENCE.md';
const freshPreRunGuardAfterAfterAllGuardWiringCorrectionPacketDocPath =
...
const captureAfterAfterAllGuardWiringCorrectionPacketDocPath =
...
const freshDecisionAfterAfterAllGuardFreshChainWiringCorrectionDocPath =
...
const upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath =
...
const upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath =
...
const upstreamCaptureAfterAfterAllGuardWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '7953121';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '7953121';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'e3a576a';
...
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '4597948';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '68c220d';
...
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 2:17pm MST';
const SIGNED_APPROVAL_CAPTURE_SOURCE = 'chat';
const APPROVAL_SCOPE =
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: 'e3a576a',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction',
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_7953121',
  'build_130_approval_capture_is_closed',
  'fresh_signed_approval_after_after_after_after_guard_fresh_chain_wiring_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'prior_build_124_125_126_approvals_guard_chain_not_reusable',
  'build_127_consumed_prior_post_build_126_attempt',
  'build_128_after_after_after_guard_fresh_chain_wiring_correction_referenced',
  'build_129_fresh_decision_template_referenced',
  ...
  'future_command_status_review_only_ready_after_guard_not_automatic_execution',
];

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_7953121_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_commit_7953121_referenced',
  'prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_status_closed',
  'prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit_e3a576a_referenced',
  'prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_status_closed',
  ...
  'build_130_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  'build_129_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  ...
  'build_126_fresh_execution_pre_run_guard_after_after_all_guard_wiring_correction_referenced',
  'build_125_capture_fresh_runner_execution_approval_after_after_all_guard_wiring_correction_referenced',
  ...
  'approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'prior_fresh_runner_execution_approval_reusable_after_after_after_after_guard_fresh_chain_wiring_correction_false',
  'prior_fresh_execution_pre_run_guard_reusable_after_after_after_after_guard_fresh_chain_wiring_correction_false',
  'prior_build_124_125_126_decision_approval_guard_chain_reusable_after_build_127_128_false',
  'runner_scaffolding_build_status_built_review_only',
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_after_after_guard_fresh_chain_wiring_correction_guard',
  'runner_fail_closed_sanity_check_status_blocked_exit_code_1',
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  ...
  'packet_does_not_treat_prior_build_124_125_126_approvals_guard_chain_as_reusable',
  'next_step_exact_approved_runner_execution_command_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  ...
  'upstream_capture_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  'upstream_fresh_decision_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  'upstream_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  'upstream_post_build_126_blocked_evidence_fixture_present',
  'upstream_fresh_pre_run_guard_after_after_all_guard_wiring_correction_fixture_present',
  'upstream_capture_after_after_all_guard_wiring_correction_fixture_present',
  ...
  'fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-after-after-guard-fresh-chain-wiring-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-after-after-after-guard-fresh-chain-wiring-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-after-after-after-guard-fresh-chain-wiring-correction-approval-capture.json',
  ...
  'fresh execution pre run guard after after after guard fresh chain wiring correction approval capture',
];
...
read(captureAfterAfterAfterAfterGuardFreshChainWiringCorrectionPacketDocPath);
read(freshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionDocPath);
read(approvalTemplateDocPath);
read(afterAfterAfterGuardFreshChainWiringCorrectionPacketDocPath);
read(postBuild126BlockedEvidencePacketDocPath);
read(freshPreRunGuardAfterAfterAllGuardWiringCorrectionPacketDocPath);
read(captureAfterAfterAllGuardWiringCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_7953121_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_commit_7953121_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, captureAfterAfterAfterAfterGuardFreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, 'Build 130', 'packet doc');
passAssertion('build_130_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit_e3a576a_referenced');

mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
...
mustHave(packetDoc, freshDecisionAfterAfterAfterAfterGuardFreshChainWiringCorrectionDocPath, 'packet doc');
...
passAssertion('build_129_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_packet_referenced');
...
mustHave(packetDoc, postBuild126BlockedEvidencePacketDocPath, 'packet doc');
...
mustHave(packetDoc, freshPreRunGuardAfterAfterAllGuardWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 126', 'packet doc');
passAssertion('build_126_fresh_execution_pre_run_guard_after_after_all_guard_wiring_correction_referenced');

mustHave(packetDoc, captureAfterAfterAllGuardWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterAfterAllGuardWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 125', 'packet doc');
passAssertion('build_125_capture_fresh_runner_execution_approval_after_after_all_guard_wiring_correction_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_after_after_after_guard_fresh_chain_wiring_correction');
...
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_after_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_after_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
passAssertion('fresh_runner_execution_approval_required_after_after_after_after_guard_fresh_chain_wiring_correction_true');
passAssertion('fresh_execution_pre_run_guard_required_after_after_after_after_guard_fresh_chain_wiring_correction_true');
...
passAssertion('prior_fresh_runner_execution_approval_reusable_after_after_after_after_guard_fresh_chain_wiring_correction_false');
passAssertion('prior_fresh_execution_pre_run_guard_reusable_after_after_after_after_guard_fresh_chain_wiring_correction_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_after_after_after_guard_fresh_chain_wiring_correction_guard');
...
passAssertion('future_command_status_ready_for_exact_approved_runner_execution_command_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only');
...
mustHave(
  packetDoc,
  'This is the **fresh execution pre-run guard only** after after-after-after-guard fresh-chain wiring correction approval capture.',
  'packet doc',
);
...
mustHave(packetDoc, 'exact approved runner execution command after after-after-after-guard fresh-chain wiring correction guard review', 'packet doc');
passAssertion('next_step_exact_approved_runner_execution_command_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only');
mustHave(packetDoc, 'Fresh execution pre-run guard pass does **not** equal runner execution.', 'packet doc');
mustHave(packetDoc, 'This packet does **not** treat prior Build 124/125/126 approvals/guard chain as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_124_125_126_approvals_guard_chain_as_reusable');
...
for (const upstreamFixturePath of [
  upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamFreshDecisionAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
  upstreamPostBuild126BlockedEvidenceFixturePath,
  upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath,
  upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
...
passAssertion('upstream_capture_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_fresh_decision_after_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_post_build_126_blocked_evidence_fixture_present');
passAssertion('upstream_fresh_pre_run_guard_after_after_all_guard_wiring_correction_fixture_present');
passAssertion('upstream_capture_after_after_all_guard_wiring_correction_fixture_present');
...
const upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixture = readJson(
  upstreamFreshDecisionAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath,
);
const upstreamAfterAfterAfterGuardFreshChainWiringCorrectionFixture = readJson(upstreamAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath);
const upstreamPostBuild126BlockedEvidenceFixture = readJson(upstreamPostBuild126BlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixture = readJson(upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixturePath);
const upstreamCaptureAfterAfterAllGuardWiringCorrectionFixture = readJson(upstreamCaptureAfterAfterAllGuardWiringCorrectionFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be 7953121');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_commit must be 7953121');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_after_after_after_guard_fresh_chain_wiring_correction_status must be closed');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_commit must be e3a576a');
}
if (fixture.prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_fresh_runner_execution_decision_after_after_after_after_guard_fresh_chain_wiring_correction_status must be closed');
}
if (fixture.prior_runner_execution_path_after_after_all_guard_fresh_chain_wiring_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
...
if (
  fixture.prior_post_build_126_command_attempt_consumption_status !==
  'consumed_by_blocked_fail_closed_result_after_build_126_guard'
) {
  fail('fixture prior_post_build_126_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result_after_build_126_guard');
}
...
if (fixture.prior_build_124_125_126_decision_approval_guard_chain_reusable_after_build_127_128 !== false) {
  fail('fixture prior_build_124_125_126_decision_approval_guard_chain_reusable_after_build_127_128 must be false');
}
if (fixture.prior_build_127_consumed_attempt_status !== 'consumed') {
  fail('fixture prior_build_127_consumed_attempt_status must be consumed');
}
...
for (const field of EXACT_VALUE_FIELDS) {
  const pendingGuardFields = ['external_sandbox_calls_approval_status', 'credentials_access_approval_status', 'test_account_use_approval_status'];
  const expected = pendingGuardFields.includes(field)
    ? upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field]
    : APPROVED_EXACT_VALUES[field];
  if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field] !== expected) {
    fail(`upstream capture after after-after-after-guard fresh-chain wiring correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.approved_exact_values[field] !== expected) {
    fail(`upstream capture after after-after-after-guard fresh-chain wiring correction fixture approved_exact_values.${field} mismatch`);
  }
  if (!pendingGuardFields.includes(field) && APPROVED_EXACT_VALUES[field] !== upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.accepted_exact_values[field]) {
...
if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after path correction fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
  fail('upstream capture after path correction fixture fresh_execution_pre_run_guard_status must be not_passed_by_this_packet');
}
if (
  upstreamCaptureAfterAfterAfterAfterGuardFreshChainWiringCorrectionFixture.future_command_status !==
  'blocked_until_fresh_execution_pre_run_guard_passes_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture'
) {
  fail('upstream capture after path correction fixture future_command_status mismatch');
}

if (
  upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
    'upstream fresh decision after path correction fixture fresh_runner_execution_decision_template_status must be created_review_only',
  );
}

if (!upstreamAfterAfterAfterGuardFreshChainWiringCorrectionFixture.packet_name) {
  fail('upstream path correction fixture must exist with packet_name');
}

if (!upstreamPostBuild126BlockedEvidenceFixture.packet_name) {
  fail('upstream blocked evidence fixture must exist with packet_name');
}

if (!upstreamFreshPreRunGuardAfterAfterAllGuardWiringCorrectionFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamCaptureAfterAfterAllGuardWiringCorrectionFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after after-after-after-guard fresh-chain wiring correction approval capture only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_ALL_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'wrapper Build 128');
mustHave(wrapper, PRIOR_POST_BUILD_126_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 127');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after after-after-after-guard fresh-chain wiring correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after after-after-after-guard fresh-chain wiring correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_execution_pre_run_guard_after_after_after_after_guard_fresh_chain_wiring_correction_approval_capture_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After After-After-After-Guard Fresh-Chain Wiring Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
