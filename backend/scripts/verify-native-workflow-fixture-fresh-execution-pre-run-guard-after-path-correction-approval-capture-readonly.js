...
const freshPreRunGuardPacketDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD.md';
const priorCapturePacketDocPath =
...
const SOURCE_OF_TRUTH_COMMIT = 'ddd193f';
...
const FRESH_EXECUTION_PRE_RUN_GUARD_COMMIT = '135b367';
...
const SIGNED_APPROVAL_TIMESTAMP = '06/20/2026 11:26am MST';
const SIGNED_APPROVAL_CAPTURE_SOURCE = 'chat';
const APPROVAL_SCOPE =
  'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_path_correction';
const RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_ready_for_exact_approved_execution_after_path_correction_guard';
...
const APPROVED_EXACT_VALUES = {
  source_of_truth_commit: '2ea4c2e',
  approval_scope:
    'fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_path_correction',
  ...
  fresh_runner_execution_approval_status:
    'granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_path_correction',
...
const FRESH_PRE_RUN_GUARD_CHECKS = [
  'source_of_truth_commit_is_ddd193f',
  'build_115_approval_capture_is_closed',
  'fresh_signed_approval_after_path_correction_is_captured',
  'all_24_exact_approval_values_are_accepted_and_approved',
  'exact_working_directory_is_root_roofleadhq',
  'exact_command_matches_signed_approval_after_path_correction',
  ...
  'prior_build_110_111_approvals_not_reusable',
  'build_112_consumed_earlier_fresh_command_attempt',
  'build_113_path_correction_referenced',
  'build_114_fresh_decision_template_referenced',
...
const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'source_of_truth_commit_ddd193f_referenced',
  'prior_fresh_runner_execution_decision_after_path_correction_commit_2ea4c2e_referenced',
  'prior_fresh_runner_execution_decision_after_path_correction_status_closed',
  ...
  'build_114_fresh_runner_execution_decision_after_path_correction_packet_referenced',
  'build_113_runner_execution_path_correction_referenced',
  'build_112_capture_fresh_runner_command_blocked_evidence_referenced',
  'build_111_fresh_execution_pre_run_guard_referenced',
  'build_110_capture_fresh_signed_runner_execution_approval_referenced',
  ...
  'approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_path_correction',
  ...
  'prior_fresh_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result',
  'immediate_rerun_allowed_false',
  'fresh_runner_execution_approval_required_after_path_correction_true',
  'fresh_execution_pre_run_guard_required_after_path_correction_true',
  'prior_fresh_runner_execution_approval_reusable_after_path_correction_false',
  'prior_fresh_execution_pre_run_guard_reusable_after_path_correction_false',
  'runner_scaffolding_build_status_built_review_only',
  'prior_capture_fresh_runner_execution_approval_after_path_correction_commit_ddd193f_referenced',
  'prior_capture_fresh_runner_execution_approval_after_path_correction_status_closed',
  'build_115_capture_fresh_runner_execution_approval_after_path_correction_packet_referenced',
  'runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_path_correction_guard',
  'runner_fail_closed_sanity_check_status_blocked_exit_code_1',
  'fresh_runner_execution_approval_status_granted_scoped_one_time_pending_fresh_execution_pre_run_guard_after_path_correction',
  ...
  'future_command_status_ready_for_exact_approved_runner_execution_command_after_path_correction_guard_review_only',
  ...
  'packet_does_not_treat_prior_build_110_111_approvals_as_reusable',
  'next_step_exact_approved_runner_execution_command_after_path_correction_guard_review_only',
  ...
  'upstream_fresh_pre_run_guard_fixture_present',
  'upstream_prior_capture_fixture_present',
  ...
  'fresh_execution_pre_run_guard_after_path_correction_approval_capture_dry_run_wrapper_present_and_safe',
  'wrapper_does_not_invoke_runner',
  'verifier_file_present',
];

const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_PATH_CORRECTION_APPROVAL_CAPTURE.md',
  'run-native-workflow-fixture-fresh-execution-pre-run-guard-after-path-correction-approval-capture-dry-run.sh',
  'verify-native-workflow-fixture-fresh-execution-pre-run-guard-after-path-correction-approval-capture-readonly.js',
  'fresh-execution-pre-run-guard-after-path-correction-approval-capture.json',
  'Native Workflow Fixture Fresh Execution Pre-Run Guard After Path Correction Approval Capture',
  'native workflow fixture fresh execution pre run guard after path correction approval capture',
  'fresh execution pre run guard after path correction approval capture',
];
...
read(freshPreRunGuardPacketDocPath);
read(priorCapturePacketDocPath);
...
passAssertion('source_of_truth_commit_ddd193f_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_PATH_CORRECTION_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_capture_fresh_runner_execution_approval_after_path_correction_status | closed', 'packet doc');
passAssertion('prior_capture_fresh_runner_execution_approval_after_path_correction_commit_ddd193f_referenced');
passAssertion('prior_capture_fresh_runner_execution_approval_after_path_correction_status_closed');

mustHave(packetDoc, captureAfterPathCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, 'Build 115', 'packet doc');
passAssertion('build_115_capture_fresh_runner_execution_approval_after_path_correction_packet_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_PATH_CORRECTION_COMMIT, 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_path_correction_commit_2ea4c2e_referenced');

mustHave(packetDoc, 'prior_fresh_runner_execution_decision_after_path_correction_status | closed', 'packet doc');
passAssertion('prior_fresh_runner_execution_decision_after_path_correction_status_closed');
...
passAssertion('build_114_fresh_runner_execution_decision_after_path_correction_packet_referenced');
...
passAssertion('build_113_runner_execution_path_correction_referenced');
...
passAssertion('build_112_capture_fresh_runner_command_blocked_evidence_referenced');

mustHave(packetDoc, freshPreRunGuardPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 111', 'packet doc');
passAssertion('build_111_fresh_execution_pre_run_guard_referenced');

mustHave(packetDoc, priorCapturePacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamPriorCaptureFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 110', 'packet doc');
passAssertion('build_110_capture_fresh_signed_runner_execution_approval_referenced');
...
passAssertion('approval_scope_fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_path_correction');
...
passAssertion('prior_fresh_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result');

mustHave(packetDoc, 'immediate_rerun_allowed | false', 'packet doc');
passAssertion('immediate_rerun_allowed_false');

mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_path_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_path_correction | true', 'packet doc');
passAssertion('fresh_runner_execution_approval_required_after_path_correction_true');
passAssertion('fresh_execution_pre_run_guard_required_after_path_correction_true');

mustHave(packetDoc, 'prior_fresh_runner_execution_approval_reusable_after_path_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_fresh_execution_pre_run_guard_reusable_after_path_correction | false', 'packet doc');
passAssertion('prior_fresh_runner_execution_approval_reusable_after_path_correction_false');
passAssertion('prior_fresh_execution_pre_run_guard_reusable_after_path_correction_false');
...
passAssertion('runner_command_path_status_corrected_fail_closed_ready_for_exact_approved_execution_after_path_correction_guard');
...
passAssertion('future_command_status_ready_for_exact_approved_runner_execution_command_after_path_correction_guard_review_only');
...
mustHave(packetDoc, 'exact approved runner execution command after path correction guard review', 'packet doc');
passAssertion('next_step_exact_approved_runner_execution_command_after_path_correction_guard_review_only');
mustHave(packetDoc, 'Fresh execution pre-run guard pass does **not** equal runner execution.', 'packet doc');
mustHave(packetDoc, 'This packet does **not** treat prior Build 110/111 approvals as reusable.', 'packet doc');
passAssertion('packet_does_not_treat_prior_build_110_111_approvals_as_reusable');
...
for (const upstreamFixturePath of [
  upstreamCaptureAfterPathCorrectionFixturePath,
  upstreamFreshDecisionAfterPathCorrectionFixturePath,
  upstreamPathCorrectionFixturePath,
  upstreamBlockedEvidenceFixturePath,
  upstreamFreshPreRunGuardFixturePath,
  upstreamPriorCaptureFixturePath,
...
passAssertion('upstream_fresh_pre_run_guard_fixture_present');
passAssertion('upstream_prior_capture_fixture_present');
...
const upstreamCaptureAfterPathCorrectionFixture = readJson(
  upstreamCaptureAfterPathCorrectionFixturePath,
);
const upstreamFreshDecisionAfterPathCorrectionFixture = readJson(
  upstreamFreshDecisionAfterPathCorrectionFixturePath,
);
const upstreamPathCorrectionFixture = readJson(upstreamPathCorrectionFixturePath);
const upstreamBlockedEvidenceFixture = readJson(upstreamBlockedEvidenceFixturePath);
const upstreamFreshPreRunGuardFixture = readJson(upstreamFreshPreRunGuardFixturePath);
const upstreamPriorCaptureFixture = readJson(upstreamPriorCaptureFixturePath);
...
if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) {
  fail('fixture source_of_truth_commit must be ddd193f');
}
if (
  fixture.prior_capture_fresh_runner_execution_approval_after_path_correction_commit !==
  PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_PATH_CORRECTION_COMMIT
) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_path_correction_commit must be ddd193f');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_path_correction_status !== 'closed') {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_path_correction_status must be closed');
}
if (
  fixture.prior_fresh_runner_execution_decision_after_path_correction_commit !==
  PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_PATH_CORRECTION_COMMIT
) {
  fail('fixture prior_fresh_runner_execution_decision_after_path_correction_commit must be 2ea4c2e');
}
if (fixture.prior_fresh_runner_execution_decision_after_path_correction_status !== 'closed') {
  fail('fixture prior_fresh_runner_execution_decision_after_path_correction_status must be closed');
}
if (fixture.prior_runner_execution_path_correction_commit !== PRIOR_RUNNER_EXECUTION_PATH_CORRECTION_COMMIT) {
  fail('fixture prior_runner_execution_path_correction_commit must be 750d5a5');
}
...
if (fixture.prior_fresh_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result') {
  fail('fixture prior_fresh_command_attempt_consumption_status must be consumed_by_blocked_fail_closed_result');
}
if (fixture.immediate_rerun_allowed !== false) {
  fail('fixture immediate_rerun_allowed must be false');
}
if (fixture.fresh_runner_execution_approval_required_after_path_correction !== true) {
  fail('fixture fresh_runner_execution_approval_required_after_path_correction must be true');
}
if (fixture.fresh_execution_pre_run_guard_required_after_path_correction !== true) {
  fail('fixture fresh_execution_pre_run_guard_required_after_path_correction must be true');
}
if (fixture.prior_fresh_runner_execution_approval_reusable_after_path_correction !== false) {
  fail('fixture prior_fresh_runner_execution_approval_reusable_after_path_correction must be false');
}
if (fixture.prior_fresh_execution_pre_run_guard_reusable_after_path_correction !== false) {
  fail('fixture prior_fresh_execution_pre_run_guard_reusable_after_path_correction must be false');
}
...
for (const field of EXACT_VALUE_FIELDS) {
  if (upstreamCaptureAfterPathCorrectionFixture.accepted_exact_values[field] !== APPROVED_EXACT_VALUES[field]) {
    fail(`upstream capture after path correction fixture accepted_exact_values.${field} mismatch`);
  }
  if (upstreamCaptureAfterPathCorrectionFixture.approved_exact_values[field] !== APPROVED_EXACT_VALUES[field]) {
    fail(`upstream capture after path correction fixture approved_exact_values.${field} mismatch`);
  }
}
...
if (upstreamCaptureAfterPathCorrectionFixture.fresh_runner_execution_approval_capture_status !== 'captured') {
  fail('upstream capture after path correction fixture fresh_runner_execution_approval_capture_status must be captured');
}
if (upstreamCaptureAfterPathCorrectionFixture.fresh_execution_pre_run_guard_status !== 'not_passed_by_this_packet') {
...
if (
  upstreamCaptureAfterPathCorrectionFixture.future_command_status !==
  'blocked_until_fresh_execution_pre_run_guard_passes_after_path_correction_approval_capture'
) {
  fail('upstream capture after path correction fixture future_command_status mismatch');
}

if (
  upstreamFreshDecisionAfterPathCorrectionFixture.fresh_runner_execution_decision_template_status !==
  'created_review_only'
) {
  fail(
...
if (!upstreamPathCorrectionFixture.packet_name) {
...
if (!upstreamFreshPreRunGuardFixture.packet_name) {
  fail('upstream fresh pre-run guard fixture must exist with packet_name');
}

if (!upstreamPriorCaptureFixture.packet_name) {
...
mustHave(wrapper, 'local fresh execution pre-run guard after path correction approval capture only', 'wrapper mode');
...
mustHave(wrapper, PRIOR_RUNNER_EXECUTION_PATH_CORRECTION_COMMIT, 'wrapper Build 113');
mustHave(wrapper, CAPTURE_FRESH_RUNNER_COMMAND_BLOCKED_EVIDENCE_COMMIT, 'wrapper Build 112');
mustHave(
  wrapper,
  'future_command_status is ready_for_exact_approved_runner_execution_command_after_path_correction_guard_review_only',
  'wrapper mode',
);
mustHave(wrapper, 'fresh_execution_pre_run_guard_status is passed', 'wrapper mode');
mustHave(
  wrapper,
  'exact approved runner execution command after path correction guard review only after this packet is committed',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `fresh execution pre-run guard after path correction approval capture dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('fresh_execution_pre_run_guard_after_path_correction_approval_capture_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Execution Pre-Run Guard After Path Correction Approval Capture verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
