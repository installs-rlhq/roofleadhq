...
const freshPreRunGuardAfterBuild139Build136ApprovalCaptureDocPath =
...
const captureAfterBuild139Build136PacketDocPath =
...
const upstreamFreshPreRunGuardAfterBuild139Build136ApprovalCaptureFixturePath =
...
const upstreamCaptureAfterBuild139Build136FixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = 'db9b293';
...
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT =
  'debb60e';
...
const RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_141 = '5bd7509';
...
const STALE_STATE_LINE =
  'NO-GO: Fresh runner-execution decision and fresh execution pre-run guard pass are required after runner execution path after Build 136 fresh-chain wiring correction';

const REQUIRED_ASSERTIONS = [
  'packet_doc_present',
  'structured_fixture_present',
  'structured_fixture_valid_json',
  'upstream_fresh_pre_run_guard_after_build_139_build_136_approval_capture_fixture_present',
  'upstream_capture_after_build_139_build_136_fixture_present',
  ...
  'source_of_truth_commit_db9b293_referenced',
  ...
  'prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status_closed',
  ...
  'prior_fresh_decision_after_build_136_commit_debb60e_referenced',
  ...
  'build_141_fresh_pre_run_guard_after_build_139_build_136_approval_capture_packet_referenced',
  'build_140_capture_after_build_139_build_136_packet_referenced',
  'build_139_fresh_decision_after_build_136_packet_referenced',
  'build_138_runner_execution_path_after_build_136_packet_referenced',
  'build_137_post_build_136_blocked_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'approval_scope_fresh_run_after_build_136_fresh_chain_wiring_correction',
  'exact_command_attempted_from_root_roofleadhq_documented',
  'exact_command_attempted_documented',
  'exact_command_attempted_after_build_141_status_attempted_blocked_nonzero',
  'exact_command_exit_status_nonzero_blocked',
  'command_attempt_consumption_status_consumed_by_blocked_after_build_141_guard',
  'runner_output_source_of_truth_commit_observed_after_build_141_5bd7509',
  'runner_output_state_after_build_141_stale_detected',
  'runner_recognized_build_133_134_135_136_chain',
  'runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction',
  'runner_did_not_recognize_build_139_fresh_decision',
  'runner_did_not_recognize_build_140_approval_capture',
  'runner_did_not_recognize_build_141_pre_run_guard',
  'runner_execution_path_after_build_141_fresh_chain_wiring_gap_detected',
  ...
  'future_command_status_blocked_until_runner_execution_path_after_build_141_fresh_chain_wiring_correction_and_fresh_decision',
  ...
  'next_step_after_build_141_fresh_chain_wiring_correction_not_immediate_rerun',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'capture_post_build_141_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_CAPTURE_POST_BUILD_141_RUNNER_COMMAND_BLOCKED_EVIDENCE.md',
  'run-native-workflow-fixture-capture-post-build-141-runner-command-blocked-evidence-dry-run.sh',
  'verify-native-workflow-fixture-capture-post-build-141-runner-command-blocked-evidence-readonly.js',
  'capture-post-build-141-runner-command-blocked-evidence.json',
  'Native Workflow Fixture Capture Post-Build-141 Runner Command Blocked Evidence',
  'native workflow fixture capture post build 141 runner command blocked evidence',
  'capture post build 141 runner command blocked evidence',
];
...
read(freshPreRunGuardAfterBuild139Build136ApprovalCaptureDocPath);
read(captureAfterBuild139Build136PacketDocPath);
...
passAssertion('source_of_truth_commit_db9b293_referenced');
...
passAssertion('prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit_db9b293_referenced');
passAssertion('prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status_closed');
...
passAssertion('prior_fresh_decision_after_build_136_commit_debb60e_referenced');
...
mustHave(packetDoc, freshPreRunGuardAfterBuild139Build136ApprovalCaptureDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterBuild139Build136ApprovalCaptureFixturePath, 'packet doc');
mustHave(packetDoc, 'fresh-execution-pre-run-guard-after-build-139-build-136-fresh-chain-wiring-correction-approval-capture', 'packet doc');
mustHave(packetDoc, 'Build 141', 'packet doc');
passAssertion('build_141_fresh_pre_run_guard_after_build_139_build_136_approval_capture_packet_referenced');

mustHave(packetDoc, captureAfterBuild139Build136PacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterBuild139Build136FixturePath, 'packet doc');
mustHave(packetDoc, 'Build 140', 'packet doc');
passAssertion('build_140_capture_after_build_139_build_136_packet_referenced');
...
passAssertion('build_139_fresh_decision_after_build_136_packet_referenced');
...
passAssertion('build_138_runner_execution_path_after_build_136_packet_referenced');
...
passAssertion('approval_scope_fresh_run_after_build_136_fresh_chain_wiring_correction');
...
mustHave(packetDoc, 'exact_command_attempted_after_build_141_status | attempted_blocked_nonzero', 'packet doc');
passAssertion('exact_command_attempted_after_build_141_status_attempted_blocked_nonzero');
...
passAssertion('command_attempt_consumption_status_consumed_by_blocked_after_build_141_guard');

mustHave(
  packetDoc,
  `runner_output_source_of_truth_commit_observed_after_build_141 | ${RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_141}`,
  'packet doc',
);
passAssertion('runner_output_source_of_truth_commit_observed_after_build_141_5bd7509');
...
passAssertion('runner_output_state_after_build_141_stale_detected');

mustHave(packetDoc, 'runner_recognized_build_133_134_135_136_chain_status | true', 'packet doc');
passAssertion('runner_recognized_build_133_134_135_136_chain');

mustHave(
  packetDoc,
  'runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction_status | true',
  'packet doc',
);
passAssertion(
  'runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction',
...
mustHave(packetDoc, 'runner_did_not_recognize_build_139_fresh_decision_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_139_fresh_decision');

mustHave(packetDoc, 'runner_did_not_recognize_build_140_approval_capture_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_140_approval_capture');

mustHave(packetDoc, 'runner_did_not_recognize_build_141_pre_run_guard_status | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_141_pre_run_guard');
...
passAssertion('runner_execution_path_after_build_141_fresh_chain_wiring_gap_detected');
...
mustHave(packetDoc, 'after Build 141 fresh-chain wiring correction', 'packet doc');
mustHave(packetDoc, 'fresh decision path', 'packet doc');
mustHave(packetDoc, 'not immediate rerun', 'packet doc');
passAssertion('next_step_after_build_141_fresh_chain_wiring_correction_not_immediate_rerun');
...
readJson(upstreamFreshPreRunGuardAfterBuild139Build136ApprovalCaptureFixturePath);
readJson(upstreamCaptureAfterBuild139Build136FixturePath);
...
passAssertion('upstream_fresh_pre_run_guard_after_build_139_build_136_approval_capture_fixture_present');
passAssertion('upstream_capture_after_build_139_build_136_fixture_present');
...
if (
  fixture.prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit !==
  PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT
) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit mismatch');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status !== 'closed') {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status must be closed');
}
...
if (fixture.exact_command_attempted_after_build_141_status !== 'attempted_blocked_nonzero') {
...
if (fixture.command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_141_guard') {
  fail('fixture command_attempt_consumption_status mismatch');
}
if (
  fixture.runner_output_source_of_truth_commit_observed_after_build_141 !==
  RUNNER_OUTPUT_SOURCE_OF_TRUTH_COMMIT_OBSERVED_AFTER_BUILD_141
) {
  fail('fixture runner_output_source_of_truth_commit_observed_after_build_141 mismatch');
}
if (fixture.runner_output_state_after_build_141_status !== 'stale_pre_build_138_139_140_141_state_detected') {
  fail('fixture runner_output_state_after_build_141_status mismatch');
}
if (fixture.runner_recognized_build_133_134_135_136_chain_status !== true) {
  fail('fixture runner_recognized_build_133_134_135_136_chain_status must be true');
}
if (
  fixture.runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction_status !== true
) {
  fail(
    'fixture runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction_status must be true',
  );
}
if (fixture.runner_did_not_recognize_build_139_fresh_decision_status !== true) {
  fail('fixture runner_did_not_recognize_build_139_fresh_decision_status must be true');
}
if (fixture.runner_did_not_recognize_build_140_approval_capture_status !== true) {
  fail('fixture runner_did_not_recognize_build_140_approval_capture_status must be true');
}
if (fixture.runner_did_not_recognize_build_141_pre_run_guard_status !== true) {
  fail('fixture runner_did_not_recognize_build_141_pre_run_guard_status must be true');
}
...
mustHave(wrapper, 'exact_command_attempted_after_build_141_status is attempted_blocked_nonzero', 'wrapper mode');
mustHave(wrapper, 'exact_command_exit_status is nonzero_blocked', 'wrapper mode');
mustHave(
  wrapper,
  'command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_141_guard',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_output_source_of_truth_commit_observed_after_build_141 is 5bd7509',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_output_state_after_build_141_status is stale_pre_build_138_139_140_141_state_detected',
  'wrapper mode',
);
mustHave(wrapper, 'runner_recognized_build_133_134_135_136_chain_status is true', 'wrapper mode');
mustHave(
  wrapper,
  'runner_did_not_recognize_build_138_after_build_136_fresh_chain_wiring_correction_status is true',
  'wrapper mode',
);
mustHave(wrapper, 'runner_did_not_recognize_build_139_fresh_decision_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_did_not_recognize_build_140_approval_capture_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_did_not_recognize_build_141_pre_run_guard_status is true', 'wrapper mode');
mustHave(wrapper, 'runner_execution_path_after_build_141_fresh_chain_wiring_gap_status is detected', 'wrapper mode');
mustHave(wrapper, 'actual 30-scenario external validation remains 0 captured / 0 passed / 30 missing', 'wrapper mode');
mustHave(
  wrapper,
  'runner execution path after Build 141 fresh-chain wiring correction/design and fresh decision path',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`capture post-build-141 runner command blocked evidence dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('capture_post_build_141_runner_command_blocked_evidence_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Capture Post-Build-141 Runner Command Blocked Evidence verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
