...
const afterBuild141FreshChainWiringCorrectionPacketDocPath =
...
const freshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureDocPath =
...
const captureAfterBuild139Build136FreshChainWiringCorrectionPacketDocPath =
...
const freshDecisionAfterBuild136FreshChainWiringCorrectionDocPath =
  'docs/NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION.md';
const runnerExecutionPathAfterBuild136FreshChainWiringCorrectionPacketDocPath =
...
const upstreamAfterBuild141FreshChainWiringCorrectionFixturePath =
...
const upstreamFreshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureFixturePath =
...
const upstreamCaptureAfterBuild139Build136FreshChainWiringCorrectionFixturePath =
...
const upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath =
...
const upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = 'c5a2c41';
...
const PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT = 'db9b293';
const PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = '47fbba3';
const PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT = 'debb60e';
...
const FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_runner_execution_approval_captured_after_build_141_fresh_chain_wiring_correction';
...
const FRESH_RUNNER_EXECUTION_TEMPLATE_CHECKS = [
  'Build 103-143 upstream packets referenced and runner execution path after Build 141 fresh-chain wiring correction closed at c5a2c41',
  'runner command path exists executable and corrected fail-closed pending fresh decision after Build 141 fresh-chain wiring correction',
  ...
  'future_command_status blocked until fresh runner execution approval captured after Build 141 fresh-chain wiring correction',
];

const REQUIRED_APPROVAL_LANGUAGE = [
  'I, Jason Lohse, explicitly approve one-time fresh runner execution for the exact scoped actual external/sandbox 30-scenario validation described below after Build 143 runner execution path after Build 141 fresh-chain wiring correction.',
  'This fresh runner-execution approval is for fresh_run_actual_external_sandbox_30_scenario_validation_once_only_after_build_141_fresh_chain_wiring_correction only.',
  ...
  'Even if signed later, runner execution remains blocked until a separate fresh execution pre-run guard passes after Build 141 fresh-chain wiring correction.',
  'Prior Build 138/139/140/141 decision/approval/guard chain is not reusable after Build 142 blocked evidence.',
  'Signature:',
  'Timestamp:',
  'Expiration:',
];
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_fixture_present',
  'upstream_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_fixture_present',
  'upstream_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_fixture_present',
  ...
  'source_of_truth_commit_c5a2c41_referenced',
  ...
  'build_141_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_referenced',
  'build_140_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_referenced',
  'build_139_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_referenced',
  ...
  'prior_post_build_141_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_141_guard',
  'prior_build_142_consumed_attempt_status_consumed',
  ...
  'runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_141_fresh_chain_wiring_correction',
  'runner_command_after_build_141_fresh_chain_references_present',
  'runner_command_build_142_consumed_post_build_141_attempt_documented',
  ...
  'future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_build_141_fresh_chain_wiring_correction',
  ...
  'packet_does_not_treat_prior_build_138_139_140_141_chain_as_reusable',
  ...
  'fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_TEMPLATE.md',
  'run-native-workflow-fixture-fresh-runner-execution-decision-after-build-141-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-fresh-runner-execution-decision-after-build-141-fresh-chain-wiring-correction-readonly.js',
  'fresh-runner-execution-decision-after-build-141-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Fresh Runner-Execution Decision After Build 141 Fresh-Chain Wiring Correction',
  'native workflow fixture fresh runner execution decision after build 141 fresh chain wiring correction',
  'fresh runner execution decision after build 141 fresh chain wiring correction',
];
...
read(afterBuild141FreshChainWiringCorrectionPacketDocPath);
read(postBuild141BlockedEvidenceDocPath);
read(freshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureDocPath);
read(captureAfterBuild139Build136FreshChainWiringCorrectionPacketDocPath);
read(freshDecisionAfterBuild136FreshChainWiringCorrectionDocPath);
read(runnerExecutionPathAfterBuild136FreshChainWiringCorrectionPacketDocPath);
...
passAssertion('source_of_truth_commit_c5a2c41_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(approvalTemplateDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'approval template doc');
passAssertion('prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_commit_c5a2c41_referenced');

mustHave(packetDoc, afterBuild141FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamAfterBuild141FreshChainWiringCorrectionFixturePath, 'packet doc');
...
mustHave(packetDoc, freshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureFixturePath, 'packet doc');
mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT, 'packet doc');
mustHave(packetDoc, 'Build 141', 'packet doc');
passAssertion('build_141_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_referenced');

mustHave(packetDoc, captureAfterBuild139Build136FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterBuild139Build136FreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(packetDoc, 'Build 140', 'packet doc');
passAssertion('build_140_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_referenced');

mustHave(packetDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(packetDoc, freshDecisionAfterBuild136FreshChainWiringCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 139', 'packet doc');
passAssertion('build_139_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_referenced');

mustHave(packetDoc, runnerExecutionPathAfterBuild136FreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath, 'packet doc');
...
mustHave(packetDoc, 'prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status | closed', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status | closed', 'approval template doc');
passAssertion('prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status_closed');

mustHave(packetDoc, 'prior_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_141_guard', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_command_attempt_consumption_status | consumed_by_blocked_fail_closed_result_after_build_141_guard', 'approval template doc');
passAssertion('prior_post_build_141_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result_after_build_141_guard');

mustHave(packetDoc, 'prior_build_142_consumed_attempt_status | consumed', 'packet doc');
mustHave(approvalTemplateDoc, 'prior_build_142_consumed_attempt_status | consumed', 'approval template doc');
passAssertion('prior_build_142_consumed_attempt_status_consumed');
...
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_build_141_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_runner_execution_approval_required_after_build_141_fresh_chain_wiring_correction is `true`', 'packet doc');
passAssertion('fresh_runner_execution_approval_required_after_build_141_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(packetDoc, 'fresh_execution_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction is `true`', 'packet doc');
passAssertion('fresh_execution_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'prior_fresh_runner_execution_approval_reusable_after_build_141_fresh_chain_wiring_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_fresh_execution_pre_run_guard_reusable_after_build_141_fresh_chain_wiring_correction | false', 'packet doc');
mustHave(packetDoc, 'prior_build_138_139_140_141_decision_approval_guard_chain_reusable_after_build_142_blocked_evidence | false', 'packet doc');
mustHave(packetDoc, 'This packet **does not** treat prior Build 138/139/140/141 decision/approval/guard chain as reusable.', 'packet doc');
mustHave(approvalTemplateDoc, '**Explicit note:** This template does **not** treat prior Build 138/139/140/141 decision/approval/guard chain as reusable.', 'approval template doc');
passAssertion('packet_does_not_treat_prior_build_138_139_140_141_chain_as_reusable');
...
passAssertion('future_command_status_blocked_until_fresh_runner_execution_approval_captured_after_build_141_fresh_chain_wiring_correction');
...
passAssertion('runner_command_path_status_corrected_fail_closed_direct_invocation_always_blocked_pending_fresh_decision_after_build_141_fresh_chain_wiring_correction');
...
if (!fs.existsSync(path.join(root, upstreamAfterBuild141FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream after Build 141 fresh-chain wiring correction fixture: ${upstreamAfterBuild141FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_runner_execution_path_after_build_141_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamPostBuild141BlockedEvidenceFixturePath))) {
  fail(`missing upstream post-Build-141 blocked evidence fixture: ${upstreamPostBuild141BlockedEvidenceFixturePath}`);
}
passAssertion('upstream_post_build_141_blocked_evidence_fixture_present');

if (!fs.existsSync(path.join(root, upstreamFreshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureFixturePath))) {
  fail(`missing upstream fresh pre-run guard after Build 139 Build 136 fresh-chain wiring correction approval capture fixture: ${upstreamFreshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureFixturePath}`);
}
passAssertion('upstream_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_fixture_present');

if (!fs.existsSync(path.join(root, upstreamCaptureAfterBuild139Build136FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream capture after Build 139 Build 136 fresh-chain wiring correction fixture: ${upstreamCaptureAfterBuild139Build136FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream fresh decision after Build 136 fresh-chain wiring correction fixture: ${upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath}`);
}
passAssertion('upstream_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_fixture_present');

if (!fs.existsSync(path.join(root, upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath))) {
  fail(`missing upstream runner execution path after Build 136 fresh-chain wiring correction fixture: ${upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath}`);
}
...
readJson(upstreamAfterBuild141FreshChainWiringCorrectionFixturePath);
readJson(upstreamPostBuild141BlockedEvidenceFixturePath);
readJson(upstreamFreshPreRunGuardAfterBuild139Build136FreshChainWiringCorrectionApprovalCaptureFixturePath);
readJson(upstreamCaptureAfterBuild139Build136FreshChainWiringCorrectionFixturePath);
readJson(upstreamFreshDecisionAfterBuild136FreshChainWiringCorrectionFixturePath);
readJson(upstreamRunnerExecutionPathAfterBuild136FreshChainWiringCorrectionFixturePath);
readJson(upstreamScaffoldingBuildFixturePath);
const manifest = readJson(manifestPath);

if (fixture.source_of_truth_commit !== SOURCE_OF_TRUTH_COMMIT) fail('fixture source_of_truth_commit must be c5a2c41');
...
if (fixture.prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status must be closed');
}
if (fixture.prior_post_build_141_blocked_evidence_commit !== PRIOR_POST_BUILD_141_BLOCKED_EVIDENCE_COMMIT) fail('fixture prior_post_build_141_blocked_evidence_commit must be 6d66f4f');
if (fixture.prior_command_attempt_consumption_status !== 'consumed_by_blocked_fail_closed_result_after_build_141_guard') {
  fail('fixture prior_command_attempt_consumption_status mismatch');
}
if (fixture.prior_build_142_consumed_attempt_status !== 'consumed') fail('fixture prior_build_142_consumed_attempt_status must be consumed');
...
if (fixture.prior_build_138_139_140_141_decision_approval_guard_chain_reusable_after_build_142_blocked_evidence !== false) {
  fail('fixture prior_build_138_139_140_141_decision_approval_guard_chain_reusable_after_build_142_blocked_evidence must be false');
}
if (fixture.prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit !== PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT) {
  fail('fixture prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit must be db9b293');
}
if (fixture.prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_commit !== PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_capture_fresh_runner_execution_approval_after_build_139_build_136_fresh_chain_wiring_correction_commit must be 47fbba3');
}
if (fixture.prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit !== PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT) {
  fail('fixture prior_fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_commit must be debb60e');
}
...
mustHave(runnerScript, 'after_build_141', 'runner script');
mustHave(runnerScript, 'after Build 141 fresh-chain wiring correction', 'runner script');
mustHave(runnerScript, 'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_141_guard', 'runner script');
mustHave(runnerScript, 'Build 142 consumed the post-Build-141 exact approved command attempt', 'runner script');
mustHave(runnerScript, 'fresh_decision_required_after_build_141_fresh_chain_wiring_correction: true', 'runner script');
mustHave(runnerScript, '(Build 138)', 'runner script');
mustHave(runnerScript, '(Build 139)', 'runner script');
mustHave(runnerScript, '(Build 140)', 'runner script');
mustHave(runnerScript, '(Build 141)', 'runner script');
...
passAssertion('runner_command_after_build_141_fresh_chain_references_present');
passAssertion('runner_command_build_142_consumed_post_build_141_attempt_documented');
...
mustHave(aggregate, 'Native Workflow Fixture Fresh Runner-Execution Decision After Build 141 Fresh-Chain Wiring Correction', 'aggregate readiness');
...
mustHave(wrapper, 'local fresh runner-execution decision/template after Build 141 fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'prior_runner_execution_path_after_build_141_fresh_chain_wiring_correction_status is closed', 'wrapper mode');
mustHave(wrapper, 'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_141_guard', 'wrapper mode');
mustHave(wrapper, 'prior_build_142_consumed_attempt_status is consumed', 'wrapper mode');
mustHave(wrapper, 'immediate_rerun_allowed is false', 'wrapper mode');
mustHave(wrapper, 'prior Build 138/139/140/141 decision/approval/guard chain is not reusable after Build 142 blocked evidence', 'wrapper mode');
...
mustHave(wrapper, 'Jason review/sign fresh runner-execution approval template after Build 141 fresh-chain wiring correction', 'wrapper mode');
mustHave(wrapper, 'Build 142 consumed the post-Build-141 attempt', 'wrapper mode');
...
if (!isExecutable(wrapperPath)) {
  fail(`fresh runner execution decision after Build 141 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('fresh_runner_execution_decision_after_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Fresh Runner-Execution Decision After Build 141 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
