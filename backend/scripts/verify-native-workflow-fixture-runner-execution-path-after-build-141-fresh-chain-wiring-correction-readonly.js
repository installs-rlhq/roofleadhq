...
const SOURCE_OF_TRUTH_COMMIT = '6d66f4f';
...
const INCOMING_FUTURE_COMMAND_STATUS =
  'blocked_until_runner_execution_path_after_build_141_fresh_chain_wiring_correction_and_fresh_decision';
const CORRECTED_FUTURE_COMMAND_STATUS =
  'blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_141_fresh_chain_wiring_correction';
...
const STALE_BUILD_137_NO_GO_MESSAGE =
  'Build 137 consumed the post-Build-136 exact approved command attempt';
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_capture_after_build_139_build_136_fresh_chain_wiring_correction_fixture_present',
  'upstream_fresh_decision_after_build_136_fresh_chain_wiring_correction_fixture_present',
  ...
  'source_of_truth_commit_6d66f4f_referenced',
  'prior_post_build_141_blocked_evidence_commit_6d66f4f_referenced',
  'prior_post_build_141_blocked_evidence_status_closed',
  'prior_fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_commit_db9b293_referenced',
  ...
  'build_141_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_packet_referenced',
  'build_140_capture_after_build_139_build_136_fresh_chain_wiring_correction_packet_referenced',
  'build_139_fresh_decision_after_build_136_fresh_chain_wiring_correction_packet_referenced',
  'build_138_runner_execution_path_after_build_136_fresh_chain_wiring_correction_packet_referenced',
  'build_137_post_build_136_blocked_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'runner_execution_path_after_build_141_fresh_chain_wiring_gap_status_detected',
  'runner_execution_path_after_build_141_fresh_chain_wiring_correction_status_design_or_corrected_review_only',
  'prior_exact_command_attempt_after_build_141_status_attempted_blocked_nonzero',
  'prior_exact_command_exit_status_nonzero_blocked',
  'prior_command_attempt_consumption_status_consumed_by_blocked_after_build_141_guard',
  'runner_output_state_after_build_141_stale_removed',
  'runner_did_not_recognize_build_138_before_correction_documented',
  'runner_did_not_recognize_build_139_before_correction_documented',
  'runner_did_not_recognize_build_140_before_correction_documented',
  'runner_did_not_recognize_build_141_before_correction_documented',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_build_141_fresh_chain_wiring_correction_true',
  'fresh_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction_true',
  'fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_closed',
  'fresh_runner_execution_approval_capture_after_build_139_build_136_fresh_chain_wiring_correction_captured_signed',
  'fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_passed',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_runner_execution_path_after_build_141_fresh_chain_wiring_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_fresh_decision_and_fresh_pre_run_guard_pass_after_build_141_fresh_chain_wiring_correction',
  'runner_command_path_exists',
  'runner_command_path_executable',
  'runner_command_corrected_blocked_state_language',
  'runner_command_recognizes_build_138_runner_execution_path_after_build_136_fresh_chain_wiring_correction',
  'runner_command_recognizes_build_139_fresh_decision',
  'runner_command_recognizes_build_140_approval_capture',
  'runner_command_recognizes_build_141_pre_run_guard',
  'runner_command_build_142_consumed_post_build_141_attempt',
  'runner_command_no_stale_future_command_status',
  'runner_command_no_stale_ready_future_command_status',
  'runner_command_no_stale_build_137_era_primary_no_go',
  ...
  'build_142_consumed_post_build_141_attempt_documented',
  'prior_build_138_139_140_141_chain_not_reusable_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_after_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_BUILD_141_FRESH_CHAIN_WIRING_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-after-build-141-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-after-build-141-fresh-chain-wiring-correction-readonly.js',
  'runner-execution-path-after-build-141-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Runner Execution Path After Build 141 Fresh-Chain Wiring Correction',
  'native workflow fixture runner execution path after build 141 fresh chain wiring correction',
  'runner execution path after build 141 fresh chain wiring correction',
];
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-after-build-141-fresh-chain-wiring-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_6d66f4f_referenced');
...
mustHave(
  packetDoc,
  PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_BUILD_139_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_APPROVAL_CAPTURE_COMMIT,
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
mustHave(
  packetDoc,
  PRIOR_RUNNER_EXECUTION_PATH_AFTER_BUILD_136_FRESH_CHAIN_WIRING_CORRECTION_COMMIT,
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('build_141_fresh_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_packet_referenced');
...
passAssertion('build_140_capture_after_build_139_build_136_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_139_fresh_decision_after_build_136_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_138_runner_execution_path_after_build_136_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('runner_execution_path_after_build_141_fresh_chain_wiring_gap_status_detected');
...
mustHave(packetDoc, 'prior_exact_command_attempt_after_build_141_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_exact_command_attempt_after_build_141_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_exact_command_attempt_after_build_141_status_attempted_blocked_nonzero');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_after_build_141_guard');
...
passAssertion('runner_output_state_after_build_141_stale_removed');
...
mustHave(packetDoc, 'runner_did_not_recognize_build_139_fresh_decision_status_before_correction | true', 'packet doc');
mustHave(
  packetDoc,
...
passAssertion('runner_did_not_recognize_build_138_before_correction_documented');
passAssertion('runner_did_not_recognize_build_139_before_correction_documented');
passAssertion('runner_did_not_recognize_build_140_before_correction_documented');
passAssertion('runner_did_not_recognize_build_141_before_correction_documented');
...
passAssertion('fresh_decision_required_after_build_141_fresh_chain_wiring_correction_true');
...
passAssertion('fresh_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction_true');
...
passAssertion('fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_closed');
...
passAssertion('fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_passed');
...
mustHave(packetDoc, 'Build 142 consumed the post-Build-141 exact approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_142_consumed_post_build_141_attempt_documented');
...
passAssertion('prior_build_138_139_140_141_chain_not_reusable_documented');
...
passAssertion('upstream_capture_after_build_139_build_136_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_fresh_decision_after_build_136_fresh_chain_wiring_correction_fixture_present');
...
if (fixture.prior_post_build_141_blocked_evidence_status !== 'closed') {
  fail('fixture prior_post_build_141_blocked_evidence_status mismatch');
}
if (fixture.runner_execution_path_after_build_141_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_build_141_fresh_chain_wiring_gap_status mismatch');
}
if (
  fixture.runner_execution_path_after_build_141_fresh_chain_wiring_correction_status !==
  'design_or_corrected_review_only'
) {
  fail('fixture runner_execution_path_after_build_141_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.prior_exact_command_attempt_after_build_141_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_exact_command_attempt_after_build_141_status mismatch');
}
...
if (fixture.fresh_decision_required_after_build_141_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_decision_required_after_build_141_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_build_141_fresh_chain_wiring_correction must be true');
}
if (
  fixture.fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status !== 'closed'
) {
  fail('fixture fresh_runner_execution_decision_after_build_136_fresh_chain_wiring_correction_status mismatch');
}
if (
  fixture.fresh_runner_execution_approval_capture_after_build_139_build_136_fresh_chain_wiring_correction_status !==
  'captured_signed'
) {
  fail(
    'fixture fresh_runner_execution_approval_capture_after_build_139_build_136_fresh_chain_wiring_correction_status mismatch',
  );
}
if (
  fixture.fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status !== 'passed'
) {
  fail('fixture fresh_execution_pre_run_guard_after_build_139_build_136_fresh_chain_wiring_correction_approval_capture_status mismatch');
}
...
mustHave(
  runnerScript,
  'runner_execution_path_after_build_136_fresh_chain_wiring_correction_status: design_or_corrected_review_only (Build 138)',
  'runner script',
);
mustHave(
  runnerScript,
...
mustHave(
  runnerScript,
  'prior_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result_after_build_141_guard (Build 142)',
  'runner script',
);
mustHave(
  runnerScript,
...
passAssertion('runner_command_recognizes_build_138_runner_execution_path_after_build_136_fresh_chain_wiring_correction');
passAssertion('runner_command_recognizes_build_139_fresh_decision');
passAssertion('runner_command_recognizes_build_140_approval_capture');
passAssertion('runner_command_recognizes_build_141_pre_run_guard');
passAssertion('runner_command_build_142_consumed_post_build_141_attempt');
...
mustNotHave(runnerScript, STALE_BUILD_137_NO_GO_MESSAGE, 'runner script');
...
passAssertion('runner_command_no_stale_build_137_era_primary_no_go');
...
mustHave(
  wrapper,
  'local runner execution path after Build 141 fresh-chain wiring correction only',
  'wrapper mode',
);
...
mustHave(wrapper, 'Build 141', 'wrapper Build 141');
mustHave(wrapper, 'Build 140', 'wrapper Build 140');
mustHave(wrapper, 'Build 139', 'wrapper Build 139');
mustHave(wrapper, 'Build 138', 'wrapper Build 138');
mustHave(wrapper, 'Build 137', 'wrapper Build 137');
mustHave(
  wrapper,
  'runner_execution_path_after_build_141_fresh_chain_wiring_gap_status is detected',
  'wrapper mode',
);
mustHave(
  wrapper,
  'runner_execution_path_after_build_141_fresh_chain_wiring_correction_status is design_or_corrected_review_only',
  'wrapper mode',
);
mustHave(
  wrapper,
  'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_141_guard',
  'wrapper mode',
);
...
mustHave(
  wrapper,
  'fresh runner-execution decision and fresh execution pre-run guard after Build 141 fresh-chain wiring correction',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `runner execution path after Build 141 fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion(
  'runner_execution_path_after_build_141_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
console.log(
  `PASS: Native Workflow Fixture Runner Execution Path After Build 141 Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
