...
const freshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionDocPath =
...
const captureAfterAfterAllGuardFreshChainWiringCorrectionPacketDocPath =
...
const upstreamFreshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath =
...
const upstreamCaptureAfterAfterAllGuardFreshChainWiringCorrectionFixturePath =
...
const upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '0e7db2d';
...
const INCOMING_FUTURE_COMMAND_STATUS =
  'blocked_until_runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision';
...
const STALE_FUTURE_COMMAND_STATUS =
  'blocked_until_after_after_guard_fresh_chain_wiring_correction_fresh_decision_and_fresh_guard';
const STALE_READY_FUTURE_COMMAND_STATUS =
  'ready_for_exact_approved_runner_execution_command_after_after_after_guard_fresh_chain_wiring_correction_guard_review_only';
const STALE_BUILD_122_NO_GO_MESSAGE =
  'Build 122 consumed the post-Build-121 exact approved command attempt';
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_fresh_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  'upstream_capture_after_after_after_guard_fresh_chain_wiring_correction_fixture_present',
  ...
  'source_of_truth_commit_0e7db2d_referenced',
  'prior_post_build_126_blocked_evidence_commit_0e7db2d_referenced',
  'prior_post_build_126_blocked_evidence_status_closed',
  'prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_commit_4597948_referenced',
  'prior_capture_after_after_after_guard_fresh_chain_wiring_correction_commit_68c220d_referenced',
  'prior_fresh_decision_after_after_after_guard_fresh_chain_wiring_correction_commit_e96c82c_referenced',
  ...
  'build_126_fresh_pre_run_guard_after_after_after_guard_wiring_correction_packet_referenced',
  'build_125_capture_after_after_all_guard_wiring_correction_packet_referenced',
  'build_124_fresh_decision_after_after_all_guard_wiring_correction_packet_referenced',
  'build_123_after_after_guard_fresh_chain_wiring_correction_packet_referenced',
  'build_122_post_build_121_blocked_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status_detected',
  'runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_status_design_or_corrected_review_only',
  'prior_exact_command_attempt_after_build_126_status_attempted_blocked_nonzero',
  'prior_exact_command_exit_status_nonzero_blocked',
  'prior_command_attempt_consumption_status_consumed_by_blocked_after_build_126_guard',
  'runner_output_state_after_build_126_stale_removed',
  'runner_did_not_recognize_build_123_before_correction_documented',
  'runner_did_not_recognize_build_124_before_correction_documented',
  'runner_did_not_recognize_build_125_before_correction_documented',
  'runner_did_not_recognize_build_126_before_correction_documented',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction_true',
  'fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction_true',
  'fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_closed',
  'fresh_runner_execution_approval_capture_after_after_after_guard_fresh_chain_wiring_correction_captured_signed',
  'fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_passed',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_after_after_after_guard_fresh_chain_wiring_correction_fresh_decision_and_fresh_guard',
  'runner_command_path_exists',
  'runner_command_path_executable',
  'runner_command_corrected_blocked_state_language',
  'runner_command_recognizes_build_123_after_after_guard_fresh_chain_wiring_correction',
  'runner_command_recognizes_build_124_fresh_decision',
  'runner_command_recognizes_build_125_approval_capture',
  'runner_command_recognizes_build_126_pre_run_guard',
  'runner_command_build_127_consumed_post_build_126_attempt',
  'runner_command_no_stale_future_command_status',
  'runner_command_no_stale_ready_future_command_status',
  'runner_command_no_stale_build_122_era_primary_no_go',
  ...
  'build_127_consumed_post_build_126_attempt_documented',
  'prior_build_123_124_125_126_chain_not_reusable_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-after-after-after-guard-fresh-chain-wiring-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-after-after-after-guard-fresh-chain-wiring-correction-readonly.js',
  'runner-execution-path-after-after-after-guard-fresh-chain-wiring-correction.json',
  'Native Workflow Fixture Runner Execution Path After-After-After-Guard Fresh-Chain Wiring Correction',
  'native workflow fixture runner execution path after after after guard fresh chain wiring correction',
  'runner execution path after after after guard fresh chain wiring correction',
];
...
read(freshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionDocPath);
read(captureAfterAfterAllGuardFreshChainWiringCorrectionPacketDocPath);
read(freshDecisionAfterAfterAllGuardFreshChainWiringCorrectionDocPath);
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-after-after-after-guard-fresh-chain-wiring-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_0e7db2d_referenced');

mustHave(packetDoc, PRIOR_POST_BUILD_126_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(packetDoc, 'prior_post_build_126_blocked_evidence_status | closed', 'packet doc');
passAssertion('prior_post_build_126_blocked_evidence_commit_0e7db2d_referenced');
passAssertion('prior_post_build_126_blocked_evidence_status_closed');

mustHave(packetDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_FRESH_EXECUTION_PRE_RUN_GUARD_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_commit_4597948_referenced');

mustHave(packetDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_CAPTURE_FRESH_RUNNER_EXECUTION_APPROVAL_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_capture_after_after_after_guard_fresh_chain_wiring_correction_commit_68c220d_referenced');
...
mustHave(noGoReviewDoc, PRIOR_FRESH_RUNNER_EXECUTION_DECISION_AFTER_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'no-go review');
passAssertion('prior_fresh_decision_after_after_after_guard_fresh_chain_wiring_correction_commit_e96c82c_referenced');

mustHave(packetDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, PRIOR_RUNNER_EXECUTION_PATH_AFTER_AFTER_GUARD_FRESH_CHAIN_WIRING_CORRECTION_COMMIT, 'no-go review');
...
mustHave(packetDoc, freshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 126', 'packet doc');
passAssertion('build_126_fresh_pre_run_guard_after_after_after_guard_wiring_correction_packet_referenced');

mustHave(packetDoc, captureAfterAfterAllGuardFreshChainWiringCorrectionPacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamCaptureAfterAfterAllGuardFreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 125', 'packet doc');
passAssertion('build_125_capture_after_after_all_guard_wiring_correction_packet_referenced');

mustHave(packetDoc, freshDecisionAfterAfterAllGuardFreshChainWiringCorrectionDocPath, 'packet doc');
mustHave(packetDoc, upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 124', 'packet doc');
passAssertion('build_124_fresh_decision_after_after_all_guard_wiring_correction_packet_referenced');
...
passAssertion('build_123_after_after_guard_fresh_chain_wiring_correction_packet_referenced');
...
passAssertion('build_122_post_build_121_blocked_evidence_packet_referenced');
...
mustHave(packetDoc, 'runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status | detected', 'packet doc');
mustHave(noGoReviewDoc, 'runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status | detected', 'no-go review');
passAssertion('runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status_detected');
...
passAssertion('runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_status_design_or_corrected_review_only');

mustHave(packetDoc, 'prior_exact_command_attempt_after_build_126_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_exact_command_attempt_after_build_126_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_exact_command_attempt_after_build_126_status_attempted_blocked_nonzero');
...
passAssertion('prior_command_attempt_consumption_status_consumed_by_blocked_after_build_126_guard');

mustHave(packetDoc, 'runner_output_state_after_build_126_status | stale_pre_build_123_124_125_126_state_detected', 'packet doc');
passAssertion('runner_output_state_after_build_126_stale_removed');

mustHave(packetDoc, 'runner_did_not_recognize_build_123_after_after_guard_fresh_chain_wiring_correction_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_124_fresh_decision_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_125_approval_capture_status_before_correction | true', 'packet doc');
mustHave(packetDoc, 'runner_did_not_recognize_build_126_pre_run_guard_status_before_correction | true', 'packet doc');
passAssertion('runner_did_not_recognize_build_123_before_correction_documented');
passAssertion('runner_did_not_recognize_build_124_before_correction_documented');
passAssertion('runner_did_not_recognize_build_125_before_correction_documented');
passAssertion('runner_did_not_recognize_build_126_before_correction_documented');
...
mustHave(packetDoc, 'fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction | true', 'no-go review');
passAssertion('fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction | true', 'no-go review');
passAssertion('fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction_true');

mustHave(packetDoc, 'fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_status | closed', 'packet doc');
passAssertion('fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_closed');

mustHave(packetDoc, 'fresh_runner_execution_approval_capture_after_after_after_guard_fresh_chain_wiring_correction_status | captured_signed', 'packet doc');
passAssertion('fresh_runner_execution_approval_capture_after_after_after_guard_fresh_chain_wiring_correction_captured_signed');

mustHave(packetDoc, 'fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status | passed', 'packet doc');
passAssertion('fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_passed');
...
passAssertion('incoming_future_command_status_blocked_until_runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_and_fresh_decision');
...
passAssertion('corrected_future_command_status_blocked_until_after_after_after_guard_fresh_chain_wiring_correction_fresh_decision_and_fresh_guard');
...
mustHave(
  packetDoc,
  'This packet corrects runner execution path after-after-after-guard fresh-chain wiring messaging/design **only**.',
  'packet doc',
);
...
mustHave(packetDoc, 'Build 127 consumed the post-Build-126 exact approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_127_consumed_post_build_126_attempt_documented');
...
passAssertion('prior_build_123_124_125_126_chain_not_reusable_documented');
...
readJson(upstreamFreshPreRunGuardAfterAfterAfterGuardFreshChainWiringCorrectionFixturePath);
readJson(upstreamCaptureAfterAfterAllGuardFreshChainWiringCorrectionFixturePath);
readJson(upstreamFreshDecisionAfterAfterAllGuardFreshChainWiringCorrectionFixturePath);
...
passAssertion('upstream_fresh_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
passAssertion('upstream_capture_after_after_after_guard_fresh_chain_wiring_correction_fixture_present');
...
if (fixture.prior_post_build_126_blocked_evidence_status !== 'closed') {
  fail('fixture prior_post_build_126_blocked_evidence_status mismatch');
}
if (fixture.runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status !== 'detected') {
  fail('fixture runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status mismatch');
}
if (
  fixture.runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_status !==
  'design_or_corrected_review_only'
) {
  fail('fixture runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.prior_exact_command_attempt_after_build_126_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_exact_command_attempt_after_build_126_status mismatch');
}
...
if (fixture.fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction must be true');
}
if (fixture.fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_status !== 'closed') {
  fail('fixture fresh_runner_execution_decision_after_after_after_guard_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.fresh_runner_execution_approval_capture_after_after_after_guard_fresh_chain_wiring_correction_status !== 'captured_signed') {
  fail('fixture fresh_runner_execution_approval_capture_after_after_after_guard_fresh_chain_wiring_correction_status mismatch');
}
if (fixture.fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status !== 'passed') {
  fail('fixture fresh_execution_pre_run_guard_after_after_after_guard_fresh_chain_wiring_correction_status mismatch');
}
...
mustHave(runnerScript, 'fresh_decision_required_after_after_after_guard_fresh_chain_wiring_correction: true', 'runner script');
mustHave(runnerScript, 'fresh_pre_run_guard_required_after_after_after_guard_fresh_chain_wiring_correction: true', 'runner script');
...
passAssertion('runner_command_recognizes_build_123_after_after_guard_fresh_chain_wiring_correction');
passAssertion('runner_command_recognizes_build_124_fresh_decision');
passAssertion('runner_command_recognizes_build_125_approval_capture');
passAssertion('runner_command_recognizes_build_126_pre_run_guard');
passAssertion('runner_command_build_127_consumed_post_build_126_attempt');
...
mustNotHave(runnerScript, STALE_BUILD_122_NO_GO_MESSAGE, 'runner script');
...
passAssertion('runner_command_no_stale_build_122_era_primary_no_go');
...
mustHave(wrapper, 'local runner execution path after-after-after-guard fresh-chain wiring correction only', 'wrapper mode');
...
mustHave(wrapper, 'Build 127', 'wrapper Build 127');
mustHave(wrapper, 'Build 126', 'wrapper Build 126');
mustHave(wrapper, 'Build 125', 'wrapper Build 125');
mustHave(wrapper, 'Build 124', 'wrapper Build 124');
mustHave(wrapper, 'Build 123', 'wrapper Build 123');
mustHave(wrapper, 'runner_execution_path_after_after_after_guard_fresh_chain_wiring_gap_status is detected', 'wrapper mode');
mustHave(
  wrapper,
  'runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_status is design_or_corrected_review_only',
  'wrapper mode',
);
mustHave(
  wrapper,
  'prior_command_attempt_consumption_status is consumed_by_blocked_fail_closed_result_after_build_126_guard',
  'wrapper mode',
);
...
mustHave(
  wrapper,
  'fresh runner-execution decision and fresh execution pre-run guard after after-after-after-guard fresh-chain wiring correction',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(
    `runner execution path after-after-after-guard fresh-chain wiring correction dry-run wrapper is not executable: ${wrapperPath}`,
  );
}
passAssertion('runner_execution_path_after_after_after_guard_fresh_chain_wiring_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Runner Execution Path After-After-After-Guard Fresh-Chain Wiring Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
