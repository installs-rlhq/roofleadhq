...
const packetDocPath = 'docs/NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_CORRECTION.md';
...
const priorBlockedEvidencePacketDocPath =
...
const upstreamPriorBlockedEvidenceFixturePath =
...
const SOURCE_OF_TRUTH_COMMIT = '847592a';
...
const CAPTURE_PRIOR_BLOCKED_EVIDENCE_COMMIT = '4a618fa';
...
const STALE_FUTURE_COMMAND_STATUS = 'ready_for_exact_approved_runner_execution_command_review_only';
const STALE_RUNNER_COMMAND_PATH_STATUS =
  'corrected_fail_closed_ready_for_exact_approved_execution_after_guard';
const STALE_NO_GO_MESSAGE =
  'Exact approved runner execution command review in Terminal 1 from /root/roofleadhq is the next step';
...
const REQUIRED_ASSERTIONS = [
  ...
  'upstream_prior_blocked_evidence_fixture_present',
  'upstream_scaffolding_build_fixture_present',
  'manifest_fixture_present',
  'source_of_truth_commit_847592a_referenced',
  'capture_fresh_runner_command_blocked_evidence_commit_847592a_referenced',
  'fresh_execution_pre_run_guard_commit_135b367_referenced',
  ...
  'capture_prior_blocked_evidence_commit_4a618fa_referenced',
  'runner_scaffolding_build_commit_145bf15_referenced',
  'build_112_capture_fresh_runner_command_blocked_evidence_packet_referenced',
  'build_111_fresh_execution_pre_run_guard_packet_referenced',
  ...
  'build_107_prior_blocked_command_evidence_packet_referenced',
  'build_103_runner_scaffolding_build_packet_referenced',
  'runner_execution_path_gap_status_detected',
  'runner_execution_path_correction_status_design_or_corrected_review_only',
  'prior_fresh_command_attempt_status_attempted_blocked_nonzero',
  'prior_fresh_command_exit_status_nonzero_blocked',
  'prior_fresh_command_attempt_consumption_status_consumed_by_blocked_fail_closed_result',
  'immediate_rerun_allowed_false',
  'fresh_decision_required_after_correction_true',
  'fresh_pre_run_guard_required_after_correction_true',
  'fresh_runner_execution_approval_captured_signed_24_24_24',
  'fresh_execution_pre_run_guard_passed_30_30_0',
  'incoming_future_command_status_blocked_until_runner_execution_path_correction_and_fresh_decision',
  'corrected_future_command_status_blocked_until_fresh_decision_after_correction',
  ...
  'runner_command_no_stale_runner_command_path_status',
  'runner_command_no_stale_no_go_message',
  'runner_command_build_112_consumed_fresh_attempt',
  ...
  'build_112_consumed_fresh_attempt_documented',
  'demo_ready_with_live_automation_disabled_preserved',
  'full_safe_readiness_lane_preserved',
  'docs_and_context_wiring_present',
  'runner_execution_path_correction_dry_run_wrapper_present_and_safe',
...
const PACKET_REFS = [
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_CORRECTION.md',
  'NATIVE_WORKFLOW_FIXTURE_RUNNER_EXECUTION_PATH_CORRECTION_NO_GO_REVIEW.md',
  'run-native-workflow-fixture-runner-execution-path-correction-dry-run.sh',
  'verify-native-workflow-fixture-runner-execution-path-correction-readonly.js',
  'runner-execution-path-correction.json',
  'Native Workflow Fixture Runner Execution Path Correction',
  'native workflow fixture runner execution path correction',
  'runner execution path correction',
];
...
read(priorBlockedEvidencePacketDocPath);
...
mustHave(
  packetDoc,
  'fake-data/local-only/read-only/dry-run-only/review-only/runner-execution-path-correction-only/non-executing',
  'packet doc',
);
mustHave(
  noGoReviewDoc,
...
passAssertion('source_of_truth_commit_847592a_referenced');
...
mustHave(noGoReviewDoc, FRESH_EXECUTION_PRE_RUN_GUARD_COMMIT, 'no-go review');
passAssertion('fresh_execution_pre_run_guard_commit_135b367_referenced');
...
mustHave(packetDoc, CAPTURE_PRIOR_BLOCKED_EVIDENCE_COMMIT, 'packet doc');
mustHave(noGoReviewDoc, CAPTURE_PRIOR_BLOCKED_EVIDENCE_COMMIT, 'no-go review');
passAssertion('capture_prior_blocked_evidence_commit_4a618fa_referenced');
...
mustHave(packetDoc, 'capture-fresh-runner-command-blocked-evidence', 'packet doc');
mustHave(packetDoc, 'Build 112', 'packet doc');
passAssertion('build_112_capture_fresh_runner_command_blocked_evidence_packet_referenced');
...
passAssertion('build_111_fresh_execution_pre_run_guard_packet_referenced');
...
mustHave(packetDoc, priorBlockedEvidencePacketDocPath, 'packet doc');
mustHave(packetDoc, upstreamPriorBlockedEvidenceFixturePath, 'packet doc');
mustHave(packetDoc, 'Build 107', 'packet doc');
passAssertion('build_107_prior_blocked_command_evidence_packet_referenced');
...
mustHave(packetDoc, 'runner_execution_path_gap_status | detected', 'packet doc');
mustHave(noGoReviewDoc, 'runner_execution_path_gap_status | detected', 'no-go review');
passAssertion('runner_execution_path_gap_status_detected');
...
passAssertion('runner_execution_path_correction_status_design_or_corrected_review_only');

mustHave(packetDoc, 'prior_fresh_command_attempt_status | attempted_blocked_nonzero', 'packet doc');
mustHave(noGoReviewDoc, 'prior_fresh_command_attempt_status | attempted_blocked_nonzero', 'no-go review');
passAssertion('prior_fresh_command_attempt_status_attempted_blocked_nonzero');

mustHave(packetDoc, 'prior_fresh_command_exit_status | nonzero_blocked', 'packet doc');
mustHave(noGoReviewDoc, 'prior_fresh_command_exit_status | nonzero_blocked', 'no-go review');
passAssertion('prior_fresh_command_exit_status_nonzero_blocked');
...
mustHave(packetDoc, 'fresh_decision_required_after_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_decision_required_after_correction | true', 'no-go review');
passAssertion('fresh_decision_required_after_correction_true');

mustHave(packetDoc, 'fresh_pre_run_guard_required_after_correction | true', 'packet doc');
mustHave(noGoReviewDoc, 'fresh_pre_run_guard_required_after_correction | true', 'no-go review');
passAssertion('fresh_pre_run_guard_required_after_correction_true');
...
passAssertion('incoming_future_command_status_blocked_until_runner_execution_path_correction_and_fresh_decision');
...
passAssertion('corrected_future_command_status_blocked_until_fresh_decision_after_correction');
...
mustHave(packetDoc, 'This packet corrects runner execution path messaging/design **only**.', 'packet doc');
...
mustHave(packetDoc, 'Build 112 consumed the fresh one-time approved command attempt', 'packet doc');
passAssertion('next_step_fresh_decision_not_immediate_rerun');
passAssertion('build_112_consumed_fresh_attempt_documented');
...
readJson(upstreamRunnerStateWiringCorrectionFixturePath);
readJson(upstreamPriorBlockedEvidenceFixturePath);
...
passAssertion('upstream_prior_blocked_evidence_fixture_present');
...
if (fixture.runner_execution_path_gap_status !== 'detected') {
  fail('fixture runner_execution_path_gap_status mismatch');
}
if (fixture.runner_execution_path_correction_status !== 'design_or_corrected_review_only') {
  fail('fixture runner_execution_path_correction_status mismatch');
}
if (fixture.prior_fresh_command_attempt_status !== 'attempted_blocked_nonzero') {
  fail('fixture prior_fresh_command_attempt_status mismatch');
}
if (fixture.prior_fresh_command_exit_status !== 'nonzero_blocked') {
  fail('fixture prior_fresh_command_exit_status mismatch');
}
...
if (fixture.fresh_decision_required_after_correction !== true) {
  fail('fixture fresh_decision_required_after_correction must be true');
}
if (fixture.fresh_pre_run_guard_required_after_correction !== true) {
  fail('fixture fresh_pre_run_guard_required_after_correction must be true');
}
...
mustHave(runnerScript, 'prior_fresh_command_attempt_status: attempted_blocked_nonzero (Build 112)', 'runner script');
mustHave(
  runnerScript,
  'prior_fresh_command_attempt_consumption_status: consumed_by_blocked_fail_closed_result (Build 112)',
  'runner script',
);
mustHave(runnerScript, 'runner_execution_path_correction_status: design_or_corrected_review_only', 'runner script');
...
mustHave(runnerScript, 'fresh_decision_required_after_correction: true', 'runner script');
mustHave(runnerScript, 'fresh_pre_run_guard_required_after_correction: true', 'runner script');
...
passAssertion('runner_command_build_112_consumed_fresh_attempt');

mustNotHave(runnerScript, `future_command_status: ${STALE_FUTURE_COMMAND_STATUS}`, 'runner script');
mustNotHave(runnerScript, `runner_command_path_status: ${STALE_RUNNER_COMMAND_PATH_STATUS}`, 'runner script');
mustNotHave(runnerScript, STALE_NO_GO_MESSAGE, 'runner script');
passAssertion('runner_command_no_stale_future_command_status');
passAssertion('runner_command_no_stale_runner_command_path_status');
passAssertion('runner_command_no_stale_no_go_message');
...
mustHave(wrapper, 'local runner execution path correction only', 'wrapper mode');
...
mustHave(wrapper, 'Build 112', 'wrapper Build 112');
mustHave(wrapper, 'Build 111', 'wrapper Build 111');
mustHave(wrapper, 'Build 110', 'wrapper Build 110');
mustHave(wrapper, 'runner_execution_path_gap_status is detected', 'wrapper mode');
mustHave(wrapper, 'runner_execution_path_correction_status is design_or_corrected_review_only', 'wrapper mode');
mustHave(wrapper, 'prior_fresh_command_attempt_status is attempted_blocked_nonzero', 'wrapper mode');
...
mustHave(
  wrapper,
  'fresh runner-execution decision/template and fresh execution pre-run guard',
  'wrapper mode',
);
...
if (!isExecutable(wrapperPath)) {
  fail(`runner execution path correction dry-run wrapper is not executable: ${wrapperPath}`);
}
passAssertion('runner_execution_path_correction_dry_run_wrapper_present_and_safe');
...
console.log(
  `PASS: Native Workflow Fixture Runner Execution Path Correction verified (${REQUIRED_ASSERTIONS.length} assertions).`,
);
console.log(
